...
static const struct
{
    ...
    u8 level;
    u8 location;
} sPokeOutbreakSpeciesList[] = { { .species = SPECIES_SEEDOT,
...
static const u16 sGoldSymbolFlags[] = { FLAG_SYS_TOWER_GOLD,
    FLAG_SYS_DOME_GOLD,
...
static const u16 sSilverSymbolFlags[] = { FLAG_SYS_TOWER_SILVER,
...
static const u16 sNumberOneVarsAndThresholds[][2] = { { VAR_DAILY_SLOTS, 100 },
...
static const u8 *const sPokeNewsTextGroup_Upcoming[] = { NULL,
...
static const u8 *const sPokeNewsTextGroup_Ongoing[] = { NULL,
...
static const u8 *const sPokeNewsTextGroup_Ending[] = { NULL,
    gPokeNewsTextSlateport_Ending,
    gPokeNewsTextGameCorner_Ending,
    gPokeNewsTextLilycove_Ending,
    gPokeNewsTextBlendMaster_Ending };

u8 *const gTVStringVarPtrs[] = { gStringVar1, gStringVar2, gStringVar3 };

static const u8 *const sTVFanClubTextGroup[] = { gTVFanClubText00,
    gTVFanClubText01,
    gTVFanClubText02,
    gTVFanClubText03,
    gTVFanClubText04,
...
static const u8 *const sTVRecentHappeninssTextGroup[] = { gTVRecentHappeningsText00,
...
static const u8 *const sTVFanClubOpinionsTextGroup[] = { gTVFanClubOpinionsText00,
...
static const u8 *const sTVPokemonTodaySuccessfulTextGroup[] = { gTVPokemonTodaySuccessfulText00,
...
static const u8 *const sTVBravoTrainerTextGroup[] = { gTVBravoTrainerText00,
...
static const u8 *const sTV3CheersForPokeblocksTextGroup[] = { gTV3CheersForPokeblocksText00,
...
static const u8 *const sTVBravoTrainerBattleTowerTextGroup[] = { gTVBravoTrainerBattleTowerText00,
...
static const u8 *const sTVContestLiveUpdatesTextGroup[] = { [CONTESTLIVE_STATE_INTRO] =
...
static const u8 *const sTVPokemonBattleUpdateTextGroup[] = { gTVPokemonBattleUpdateText00,
...
static const u8 *const sTVTrainerFanClubSpecialTextGroup[] = { gTVTrainerFanClubSpecialText00,
...
static const u8 *const sTVNameRaterTextGroup[] = { gTVNameRaterText00,
    gTVNameRaterText01,
    gTVNameRaterText02,
    gTVNameRaterText03,
    gTVNameRaterText04,
...
static const u8 *const sTVPokemonTodayFailedTextGroup[] = { gTVPokemonTodayFailedText00,
...
static const u8 *const sTVPokemonAnslerTextGroup[] = { gTVPokemonAnglerText00,
    gTVPokemonAnglerText01 };

static const u8 *const sTVWorldOfMastersTextGroup[] = {
    gTVWorldOfMastersText00, gTVWorldOfMastersText01, gTVWorldOfMastersText02
};

static const u8 *const sTVTodaysRivalTrainerTextGroup[] = { gTVTodaysRivalTrainerText00,
...
static const u8 *const sTVFindThatGamerTextGroup[] = {
    gTVFindThatGamerText00, gTVFindThatGamerText01, gTVFindThatGamerText02, gTVFindThatGamerText03
};

static const u8 *const sTVBreakinsNewsTextGroup[] = { gTVBreakingNewsText00,
...
static const u8 *const sTVSecretBaseVisitTextGroup[] = { gTVSecretBaseVisitText00,
...
static const u8 *const sTVThePokemonBattleSeminarTextGroup[] = { gTVThePokemonBattleSeminarText00,
...
static const u8 *const sTVTrainerFanClubTextGroup[] = { gTVTrainerFanClubText00,
...
static const u8 *const sTVCutiesTextGroup[] = { gTVCutiesText00,
    gTVCutiesText01,
    gTVCutiesText02,
    gTVCutiesText03,
    gTVCutiesText04,
...
static const u8 *const sTVWhatsNo1InHoennTodayTextGroup[] = { gTVWhatsNo1InHoennTodayText00,
...
static const u8 *const sTVSafariFanClubTextGroup[] = { gTVSafariFanClubText00,
...
static const u8 *const sTVInSearchOfTrainersTextGroup[] = { gTVInSearchOfTrainersText00,
...
const u8 sTVSecretBaseSecretsActions[NUM_SECRET_BASE_FLAGS] = {
    ...
    SBSECRETS_NUM_STATES // SECRET_BASE_UNUSED_FLAG. Odd that this is included, if it were used it
                         // would overflow sTVSecretBaseSecretsTextGroup
};
...
u8 FindAnyTVShowOnTheAir(void)
{
    ...
    if (gSaveBlock1Ptr->outbreakPokemonSpecies != SPECIES_NONE
        && gSaveBlock1Ptr->tvShows[show].common.kind == TVSHOW_MASS_OUTBREAK)
    {
...
void UpdateTVScreensOnMap(int width, int height)
{
    ...
    switch (CheckForBigMovieOrEmergencyNewsOnTV())
    {
        ...
        default:
            ...
            else if (FlagGet(FLAG_SYS_TV_START)
                     && (FindAnyTVShowOnTheAir() != 0xFF || FindAnyTVNewsOnTheAir() != 0xFF
...
{
    gSaveBlock1Ptr->gabbyAndTyData.battleTookMoreThanOneTurn2 =
    ...
    gSaveBlock1Ptr->gabbyAndTyData.playerUsedHealingItem2 =
        gSaveBlock1Ptr->gabbyAndTyData.playerUsedHealingItem;
    gSaveBlock1Ptr->gabbyAndTyData.playerThrewABall2 =
        gSaveBlock1Ptr->gabbyAndTyData.playerThrewABall;
...
void PutPokemonTodayCaughtOnAir(void)
{
    ...
    else
    {
        ...
        if (!rbernoulli(1, 1)
            && StringCompare(
                gSpeciesNames[gBattleResults.caughtMonSpecies], gBattleResults.caughtMonNick))
        {
            sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
            if (sCurTVShowSlot != -1
                && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_POKEMON_TODAY_CAUGHT, FALSE)
                       != TRUE)
            {
                for (i = 0; i < 11; i++)
                {
...
void PutPokemonTodayFailedOnTheAir(void)
{
    ...
    if (!rbernoulli(1, 1))
    {
        ...
        if (ct > 2 && (gBattleOutcome == B_OUTCOME_MON_FLED || gBattleOutcome == B_OUTCOME_WON))
        {
            sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
            if (sCurTVShowSlot != -1
                && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_POKEMON_TODAY_FAILED, FALSE)
                       != TRUE)
            {
                show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
static void InterviewAfter_ContestLiveUpdates(void)
{
    ...
    if (show->contestLiveUpdates.kind == TVSHOW_CONTEST_LIVE_UPDATES)
    {
        ...
        StringCopy(show2->contestLiveUpdates.winningTrainerName,
            gSaveBlock2Ptr->playerName); // Show only begins running if player won, so always load
                                         // players name
        show2->contestLiveUpdates.category = gSpecialVar_ContestCategory;
        show2->contestLiveUpdates.winningSpecies =
            GetMonData(&gPlayerParty[gContestMonPartyIndex], MON_DATA_SPECIES, NULL);
        ...
        StringCopy(show2->contestLiveUpdates.losingTrainerName,
            show->contestLiveUpdates.losingTrainerName);
    ...
    if (sCurTVShowSlot != -1)
    {
        ...
        if (gSpecialVar_Result != 1)
        {
            ...
            if (show->battleUpdate.language == LANGUAGE_JAPANESE
                || gLinkPlayers[opponentLinkPlayerId].language == LANGUAGE_JAPANESE)
            {
            ...
            else
            {
                show->battleUpdate.linkOpponentLanguage =
                    gLinkPlayers[opponentLinkPlayerId].language;
            }
        }
    }
}
    ...
    if (sCurTVShowSlot != -1)
    {
        ...
        if (loser + 1 > gNumLinkContestPlayers)
        {
            show->contestLiveUpdates.losingTrainerLanguage = gLinkPlayers[0].language;
                 ...
                 || gLinkPlayers[loser].language == LANGUAGE_JAPANESE)
        {
...
void BravoTrainerPokemonProfile_BeforeInterview2(u8 contestStandingPlace)
{
    ...
    if (sCurTVShowSlot != -1)
    {
        ...
        show->bravoTrainer.species =
            GetMonData(&gPlayerParty[gContestMonPartyIndex], MON_DATA_SPECIES, NULL);
        GetMonData(&gPlayerParty[gContestMonPartyIndex],
            MON_DATA_NICKNAME,
...
static void InterviewAfter_BravoTrainerBattleTowerProfile(void)
{
    ...
    StringCopy(
        show->bravoTrainerTower.pokemonName, gSaveBlock2Ptr->frontier.towerInterview.opponentName);
    ...
    if (show->bravoTrainerTower.language == LANGUAGE_JAPANESE
    ...
    {
        show->bravoTrainerTower.pokemonNameLanguage =
...
void SaveRecordedItemPurchasesForTVShow(void)
{
    ...
    if (!(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(TRAINER_HILL_ENTRANCE)
            && gSaveBlock1Ptr->location.mapNum == MAP_NUM(TRAINER_HILL_ENTRANCE))
        && !(gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(BATTLE_FRONTIER_MART)
             && gSaveBlock1Ptr->location.mapNum == MAP_NUM(BATTLE_FRONTIER_MART))
        && !rbernoulli(1, 3))
    {
        sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
        if (sCurTVShowSlot != -1
            && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_SMART_SHOPPER, FALSE) != TRUE)
        {
    ...
    if (gSpecialVar_Result != 1)
    {
        ...
        if (StringLength(gSaveBlock2Ptr->playerName) > 1 && StringLength(gStringVar1) > 1)
        {
            ...
            show->nameRaterShow.randomSpecies =
                TV_GetSomeOtherSpeciesAlreadySeenByPlayer(show->nameRaterShow.species);
            StringCopy(show->nameRaterShow.trainerName, gSaveBlock2Ptr->playerName);
            GetMonData(&gPlayerParty[gSpecialVar_0x8004],
                MON_DATA_NICKNAME,
            ...
            show->nameRaterShow.pokemonNameLanguage =
                GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_LANGUAGE);
        }
    }
}
...
void PutLilycoveContestLadyShowOnTheAir(void)
{
    ...
    if (gSpecialVar_Result != TRUE)
    {
        ...
        BufferContestLadyMonName(
            &show->contestLiveUpdates2.contestCategory, show->contestLiveUpdates2.nickname);
...
static void InterviewAfter_FanClubLetter(void)
{
    ...
    show->fanclubLetter.species =
        GetMonData(&gPlayerParty[GetLeadMonIndex()], MON_DATA_SPECIES, NULL);
    tv_store_id_2x(show);
...
static void InterviewAfter_PkmnFanClubOpinions(void)
{
    ...
    show->fanclubOpinions.friendshipHighNybble =
        GetMonData(&gPlayerParty[GetLeadMonIndex()], MON_DATA_FRIENDSHIP, NULL) >> 4;
    ...
    if (gGameLanguage == LANGUAGE_JAPANESE
        || GetMonData(&gPlayerParty[GetLeadMonIndex()], MON_DATA_LANGUAGE) == LANGUAGE_JAPANESE)
    {
    ...
    else
    {
        show->fanclubOpinions.pokemonNameLanguage =
            GetMonData(&gPlayerParty[GetLeadMonIndex()], MON_DATA_LANGUAGE);
    }
}
...
void PutFishingAdviceShowOnTheAir(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_FISHING_ADVICE, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EDA80(void)
{
    ...
    if (!rbernoulli(1, 1))
    {
        sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
        if (sCurTVShowSlot != -1
            && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_WORLD_OF_MASTERS, FALSE) != TRUE)
        {
            show2 = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EDC60(const u16 *words)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_TREND_WATCHER, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void TryPutTreasureInvestigatorsOnAir(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_TREASURE_INVESTIGATORS, FALSE)
               != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void AlertTVOfNewCoinTotal(u16 nCoinsPaidOut)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_FIND_THAT_GAMER, FALSE) != TRUE)
    {
        flag = FALSE;
        switch (sFindThatGamerWhichGame)
        {
            case SLOT_MACHINE:
                ...
                if (sFindThatGamerCoinsSpent >= 100
                    && nCoinsPaidOut <= sFindThatGamerCoinsSpent - 100)
                {
            ...
            case ROULETTE:
                ...
                if (sFindThatGamerCoinsSpent >= 50
                    && nCoinsPaidOut <= sFindThatGamerCoinsSpent - 50)
                {
                    nCoinsWon = sFindThatGamerCoinsSpent - nCoinsPaidOut;
                    break;
                }
...
static void sub_80EDFB4(TVShow *show)
{
    ...
    for (i = 0, nPokemon = 0; i < PARTY_SIZE; i++)
    {
        ...
        {
            sTV_SecretBaseVisitMonsTemp[nPokemon].level =
                GetMonData(&gPlayerParty[i], MON_DATA_LEVEL);
            sTV_SecretBaseVisitMonsTemp[nPokemon].species =
            ...
            sTV_SecretBaseVisitMonsTemp[nPokemon].move =
                sTV_SecretBaseVisitMovesTemp[Random() % nMoves];
            nPokemon++;
        }
    }
...
void sub_80EE184(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_BREAKING_NEWS, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void TryPutLotteryWinnerReportOnAir(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_LOTTO_WINNER, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE35C(u16 foeSpecies, u16 species, u8 moveIdx, const u16 *movePtr, u16 betterMove)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_BATTLE_SEMINAR, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void sub_80EE44C(u8 nMonsCaught, u8 nPkblkUsed)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_SAFARI_FAN_CLUB, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void TryPutSpotTheCutiesOnAir(struct Pokemon *pokemon, u8 ribbonMonDataIdx)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_CUTIES, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
        ...
        if (show->cuties.language == LANGUAGE_JAPANESE
            || GetMonData(pokemon, MON_DATA_LANGUAGE) == LANGUAGE_JAPANESE)
        {
...
u8 TV_MonDataIdxToRibbon(u8 monDataIdx)
{
    ...
    if (monDataIdx == MON_DATA_EFFORT_RIBBON)
        return 24;
    if (monDataIdx == MON_DATA_GIFT_RIBBON_1)
        return 25;
    if (monDataIdx == MON_DATA_GIFT_RIBBON_2)
        return 26;
    if (monDataIdx == MON_DATA_GIFT_RIBBON_3)
        return 27;
    if (monDataIdx == MON_DATA_GIFT_RIBBON_4)
        return 28;
    if (monDataIdx == MON_DATA_GIFT_RIBBON_5)
        return 29;
    if (monDataIdx == MON_DATA_GIFT_RIBBON_6)
        return 30;
    if (monDataIdx == MON_DATA_GIFT_RIBBON_7)
        return 31;
    return 0;
}
...
void TrySetUpTrainerFanClubSpecial(void)
{
    ...
    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
    if (sCurTVShowSlot != -1
        && HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_TRAINER_FAN_CLUB, FALSE) != TRUE)
    {
        show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
bool8 ShouldAirFrontierTVShow(void)
{
    ...
    if (HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_FRONTIER, FALSE) == TRUE)
    {
        ...
        {
            if (shows[showIdx].common.kind == TVSHOW_FRONTIER
                && (playerId & 0xFF) == shows[showIdx].common.trainerIdLo
                && ((playerId >> 8) & 0xFF) == shows[showIdx].common.trainerIdHi)
            {
    ...
    if (sCurTVShowSlot != -1)
    {
        ...
        switch (facilityAndMode)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                show->frontier.species1 = GetMonData(
                    &gSaveBlock1Ptr->playerParty[gSaveBlock2Ptr->frontier.selectedPartyMons[0] - 1],
                    MON_DATA_SPECIES,
                    NULL);
                show->frontier.species2 = GetMonData(
                    &gSaveBlock1Ptr->playerParty[gSaveBlock2Ptr->frontier.selectedPartyMons[1] - 1],
                    MON_DATA_SPECIES,
                    NULL);
                break;
        }
...
void TryPutSecretBaseSecretsOnAir(void)
{
    ...
    if (HasMixableShowAlreadyBeenSpawnedWithPlayerID(TVSHOW_SECRET_BASE_SECRETS, FALSE) != TRUE)
    {
        ...
        if (sCurTVShowSlot != -1)
        {
            ...
            show->secretBaseSecrets.flags = VarGet(VAR_SECRET_BASE_LOW_TV_FLAGS)
                                            + (VarGet(VAR_SECRET_BASE_HIGH_TV_FLAGS) << 16);
            tv_store_id_3x(show);
...
u8 FindAnyTVNewsOnTheAir(void)
{
    ...
    {
        if (gSaveBlock1Ptr->pokeNews[i].kind != POKENEWS_NONE
            && gSaveBlock1Ptr->pokeNews[i].state == TRUE && gSaveBlock1Ptr->pokeNews[i].days < 3)
        {
            return i;
        }
    }
    ...
    switch (newsKind)
    {
        case POKENEWS_SLATEPORT:
            if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(SLATEPORT_CITY)
                ...
                && gSpecialVar_LastTalked == 25)
            {
                return TRUE;
            }
            return FALSE;
        case POKENEWS_LILYCOVE:
            if (gSaveBlock1Ptr->location.mapGroup
                    == MAP_GROUP(LILYCOVE_CITY_DEPARTMENT_STORE_ROOFTOP)
                && gSaveBlock1Ptr->location.mapNum
                       == MAP_NUM(LILYCOVE_CITY_DEPARTMENT_STORE_ROOFTOP))
            {
                return TRUE;
            }
            return FALSE;
...
static void sub_80EF40C(u8 varIdx, TVShow *show)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        {
            price += ItemId_GetPrice(show->smartshopperShow.itemIds[i])
                     * show->smartshopperShow.itemAmounts[i];
        }
    }
...
bool8 HasMixableShowAlreadyBeenSpawnedWithPlayerID(u8 kind, bool8 flag)
{
    ...
    {
        if (shows[i].common.kind == kind && (playerId & 0xFF) == shows[i].common.trainerIdLo
...
static void InterviewBefore_FanClubLetter(void)
{
    ...
    if (!gSpecialVar_Result)
    {
        StringCopy(gStringVar1,
            gSpeciesNames[GetMonData(&gPlayerParty[GetLeadMonIndex()], MON_DATA_SPECIES, NULL)]);
...
static void InterviewBefore_RecentHappenings(void)
{
    ...
    if (!gSpecialVar_Result)
    {
        InitializeEasyChatWordArray(
            gSaveBlock1Ptr->tvShows[sCurTVShowSlot].recentHappenings.words, 6);
    }
}
...
static void InterviewBefore_PkmnFanClubOpinions(void)
{
    ...
    if (!gSpecialVar_Result)
    {
        ...
        InitializeEasyChatWordArray(
            gSaveBlock1Ptr->tvShows[sCurTVShowSlot].fanclubOpinions.words, 2);
    }
}
...
static void InterviewBefore_BravoTrainerBTProfile(void)
{
    ...
    {
        InitializeEasyChatWordArray(
            gSaveBlock1Ptr->tvShows[sCurTVShowSlot].bravoTrainerTower.words, 1);
    }
}
...
static void InterviewBefore_FanClubSpecial(void)
{
    ...
    {
        InitializeEasyChatWordArray(
            gSaveBlock1Ptr->tvShows[sCurTVShowSlot].fanClubSpecial.words, 1);
    }
}
...
static bool8 IsPartyMonNicknamedOrNotEnglish(u8 monIdx)
{
    ...
    if (language == LANGUAGE_ENGLISH
        && !StringCompare(gSpeciesNames[GetMonData(pokemon, MON_DATA_SPECIES, NULL)], gStringVar1))
    {
        return FALSE;
    }
    return TRUE;
...
void TV_GetNicknameSubstring(
    u8 varIdx, u8 whichPosition, u8 charParam, u16 whichString, u16 species, TVShow *show)
{
    u8 buff[16];
    u8 i;
    u16 strlen;
...
{
    return (gSaveBlock2Ptr->playerTrainerId[3] << 24) | (gSaveBlock2Ptr->playerTrainerId[2] << 16)
...
void HideBattleTowerReporter(void)
{
    ...
    RemoveObjectEventByLocalIdAndMap(
        5, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup);
...
void ReceiveTvShowsData(void *src, u32 size, u8 masterIdx)
{
    ...
    if (rmBuffer2 != NULL)
    {
        ...
        switch (masterIdx)
        {
            case 0:
                sub_80F0358(
                    gSaveBlock1Ptr->tvShows, (*rmBuffer)[1], (*rmBuffer)[2], (*rmBuffer)[3]);
                break;
            case 1:
                sub_80F0358(
                    (*rmBuffer)[0], gSaveBlock1Ptr->tvShows, (*rmBuffer)[2], (*rmBuffer)[3]);
                break;
            case 2:
                sub_80F0358(
                    (*rmBuffer)[0], (*rmBuffer)[1], gSaveBlock1Ptr->tvShows, (*rmBuffer)[3]);
                break;
            case 3:
                sub_80F0358(
                    (*rmBuffer)[0], (*rmBuffer)[1], (*rmBuffer)[2], gSaveBlock1Ptr->tvShows);
                break;
        }
        sub_80EF93C(gSaveBlock1Ptr->tvShows);
        sub_80F0C04();
...
static void sub_80F0358(
    TVShow player1[25], TVShow player2[25], TVShow player3[25], TVShow player4[25])
{
    u8 i;
    u8 j;
    TVShow **argslist[4];
    ...
    while (1)
    {
        for (i = 0; i < sTVShowMixingNumPlayers; i++)
        {
            ...
            else
            {
                ...
                {
                    sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(
                        argslist[(i + j + 1) % sTVShowMixingNumPlayers][0]);
                    if (sCurTVShowSlot != -1
                        && sub_80F049C(&argslist[(i + j + 1) % sTVShowMixingNumPlayers][0],
                               &argslist[i][0],
                               (i + j + 1) % sTVShowMixingNumPlayers)
                               == 1)
                    {
                        break;
                    }
...
static bool8 sub_80F0580(TVShow *tv1, TVShow *tv2, u8 idx)
{
    ...
    if ((linkTrainerId & 0xFF) == tv2->common.trainerIdLo
        && ((linkTrainerId >> 8) & 0xFF) == tv2->common.trainerIdHi)
    {
        return FALSE;
    }
...
{
    u32 linkTrainerId = GetLinkPlayerTrainerId(idx);
    if ((linkTrainerId & 0xFF) == tv2->common.srcTrainerIdLo
        && ((linkTrainerId >> 8) & 0xFF) == tv2->common.srcTrainerIdHi)
    {
        return FALSE;
    }
    if ((linkTrainerId & 0xFF) == tv2->common.trainerIdLo
...
void ReceivePokeNewsData(void *src, u32 size, u8 masterIdx)
{
    ...
    if (rmBuffer2 != NULL)
    {
        ...
        switch (masterIdx)
        {
            case 0:
                sub_80F0D60(
                    gSaveBlock1Ptr->pokeNews, (*rmBuffer)[1], (*rmBuffer)[2], (*rmBuffer)[3]);
                break;
            case 1:
                sub_80F0D60(
                    (*rmBuffer)[0], gSaveBlock1Ptr->pokeNews, (*rmBuffer)[2], (*rmBuffer)[3]);
                break;
            case 2:
                sub_80F0D60(
                    (*rmBuffer)[0], (*rmBuffer)[1], gSaveBlock1Ptr->pokeNews, (*rmBuffer)[3]);
                break;
            case 3:
                sub_80F0D60(
                    (*rmBuffer)[0], (*rmBuffer)[1], (*rmBuffer)[2], gSaveBlock1Ptr->pokeNews);
                break;
        }
        sub_80F0EEC();
        sub_80F0F24();
...
static void sub_80F0D60(
    PokeNews player1[16], PokeNews player2[16], PokeNews player3[16], PokeNews player4[16])
{
    u8 i;
    u8 j;
    u8 k;
    ...
    for (i = 0; i < POKE_NEWS_COUNT; i++)
    {
        for (j = 0; j < sTVShowNewsMixingNumPlayers; j++)
        {
            ...
            if (sTVShowMixingCurSlot != -1)
            {
                ...
                {
                    sCurTVShowSlot =
                        sub_80EEE30(*argslist[(j + k + 1) % sTVShowNewsMixingNumPlayers]);
                    if (sCurTVShowSlot != -1)
                    {
                        sub_80F0E58(
                            argslist[(j + k + 1) % sTVShowNewsMixingNumPlayers], argslist[j]);
                    }
                }
            }
        }
    ...
    for (i = 0; i < LAST_TVSHOW_IDX; i++)
    {
        switch (show[i].common.kind)
        {
            ...
            case TVSHOW_PKMN_FAN_CLUB_OPINIONS:
                r4[1] = &show[i];
                tvlangfix(
                    r4[1]->fanclubOpinions.playerName, r4[1]->fanclubOpinions.language, language);
                tvlangfix(r4[1]->fanclubOpinions.nickname,
                    r4[1]->fanclubOpinions.pokemonNameLanguage,
                    language);
                break;
            case TVSHOW_POKEMON_TODAY_CAUGHT:
                r4[6] = &show[i];
            ...
            case TVSHOW_SMART_SHOPPER:
                r4[7] = &show[i];
                tvlangfix(
                    r4[7]->smartshopperShow.playerName, r4[7]->smartshopperShow.language, language);
                break;
            case TVSHOW_BRAVO_TRAINER_BATTLE_TOWER_PROFILE:
                r4[5] = &show[i];
                tvlangfix(r4[5]->bravoTrainerTower.trainerName,
                    r4[5]->bravoTrainerTower.language,
                    language);
                tvlangfix(r4[5]->bravoTrainerTower.pokemonName,
                    r4[5]->bravoTrainerTower.pokemonNameLanguage,
                    language);
                break;
            case TVSHOW_BRAVO_TRAINER_POKEMON_PROFILE:
                r4[4] = &show[i];
                tvlangfix(r4[4]->bravoTrainer.playerName, r4[4]->bravoTrainer.language, language);
                tvlangfix(r4[4]->bravoTrainer.pokemonNickname,
                    r4[4]->bravoTrainer.pokemonNameLanguage,
                    language);
                break;
            case TVSHOW_NAME_RATER_SHOW:
                r4[3] = &show[i];
                tvlangfix(
                    r4[3]->nameRaterShow.trainerName, r4[3]->nameRaterShow.language, language);
                tvlangfix(r4[3]->nameRaterShow.pokemonName,
                    r4[3]->nameRaterShow.pokemonNameLanguage,
                    language);
                break;
            case TVSHOW_POKEMON_TODAY_FAILED:
                r4[2] = &show[i];
                tvlangfix(r4[2]->pokemonTodayFailed.playerName,
                    r4[2]->pokemonTodayFailed.language,
                    language);
                break;
            case TVSHOW_FISHING_ADVICE:
                r4[8] = &show[i];
            ...
            case TVSHOW_WORLD_OF_MASTERS:
                r4[9] = &show[i];
                tvlangfix(
                    r4[9]->worldOfMasters.playerName, r4[9]->worldOfMasters.language, language);
                break;
            case TVSHOW_MASS_OUTBREAK:
                r4[10] = &show[i];
...
void sub_80F1208(TVShow *shows)
{
    ...
    for (curShow = shows; curShow < shows + LAST_TVSHOW_IDX; curShow++)
    {
        ...
        {
            if ((curShow->bravoTrainerTower.language == LANGUAGE_JAPANESE
                    && curShow->bravoTrainerTower.pokemonNameLanguage != LANGUAGE_JAPANESE)
                || (curShow->bravoTrainerTower.language != LANGUAGE_JAPANESE
                    && curShow->bravoTrainerTower.pokemonNameLanguage == LANGUAGE_JAPANESE))
            {
        ...
        switch (curShow->common.kind)
        {
            case TVSHOW_FAN_CLUB_LETTER:
                curShow->fanclubLetter.language =
                    TV_GetStringLanguage(curShow->fanclubLetter.playerName);
                break;
            case TVSHOW_RECENT_HAPPENINGS:
                curShow->recentHappenings.language =
                    TV_GetStringLanguage(curShow->recentHappenings.playerName);
                break;
            case TVSHOW_PKMN_FAN_CLUB_OPINIONS:
                curShow->fanclubOpinions.language =
                    TV_GetStringLanguage(curShow->fanclubOpinions.playerName);
                curShow->fanclubOpinions.pokemonNameLanguage =
                    TV_GetStringLanguage(curShow->fanclubOpinions.nickname);
                break;
            case TVSHOW_UNKN_SHOWTYPE_04:
            ...
            case TVSHOW_NAME_RATER_SHOW:
                curShow->nameRaterShow.language =
                    TV_GetStringLanguage(curShow->nameRaterShow.trainerName);
                curShow->nameRaterShow.pokemonNameLanguage =
                    TV_GetStringLanguage(curShow->nameRaterShow.pokemonName);
                break;
            case TVSHOW_BRAVO_TRAINER_POKEMON_PROFILE:
                curShow->bravoTrainer.language =
                    TV_GetStringLanguage(curShow->bravoTrainer.playerName);
                curShow->bravoTrainer.pokemonNameLanguage =
                    TV_GetStringLanguage(curShow->bravoTrainer.pokemonNickname);
                break;
            case TVSHOW_BRAVO_TRAINER_BATTLE_TOWER_PROFILE:
                curShow->bravoTrainerTower.language =
                    TV_GetStringLanguage(curShow->bravoTrainerTower.trainerName);
                curShow->bravoTrainerTower.pokemonNameLanguage =
                    TV_GetStringLanguage(curShow->bravoTrainerTower.pokemonName);
                break;
            case TVSHOW_CONTEST_LIVE_UPDATES:
                curShow->contestLiveUpdates.winningTrainerLanguage =
                    TV_GetStringLanguage(curShow->contestLiveUpdates.winningTrainerName);
                curShow->contestLiveUpdates.losingTrainerLanguage =
                    TV_GetStringLanguage(curShow->contestLiveUpdates.losingTrainerName);
                break;
            case TVSHOW_3_CHEERS_FOR_POKEBLOCKS:
                curShow->threeCheers.language =
                    TV_GetStringLanguage(curShow->threeCheers.playerName);
                curShow->threeCheers.worstBlenderLanguage =
                    TV_GetStringLanguage(curShow->threeCheers.worstBlenderName);
                break;
            case TVSHOW_BATTLE_UPDATE:
                curShow->battleUpdate.language =
                    TV_GetStringLanguage(curShow->battleUpdate.playerName);
                curShow->battleUpdate.linkOpponentLanguage =
                    TV_GetStringLanguage(curShow->battleUpdate.linkOpponentName);
                break;
            case TVSHOW_FAN_CLUB_SPECIAL:
                curShow->fanClubSpecial.language =
                    TV_GetStringLanguage(curShow->fanClubSpecial.playerName);
                curShow->fanClubSpecial.idolNameLanguage =
                    TV_GetStringLanguage(curShow->fanClubSpecial.idolName);
                break;
            case TVSHOW_CONTEST_LIVE_UPDATES_2:
                curShow->contestLiveUpdates2.language =
                    TV_GetStringLanguage(curShow->contestLiveUpdates2.playerName);
                curShow->contestLiveUpdates2.pokemonNameLanguage =
                    TV_GetStringLanguage(curShow->contestLiveUpdates2.nickname);
                break;

            case TVSHOW_POKEMON_TODAY_CAUGHT:
                curShow->pokemonToday.language =
                    TV_GetStringLanguage(curShow->pokemonToday.playerName);
                curShow->pokemonToday.language2 =
                    TV_GetStringLanguage(curShow->pokemonToday.nickname);
                break;
            case TVSHOW_SMART_SHOPPER:
                curShow->smartshopperShow.language =
                    TV_GetStringLanguage(curShow->smartshopperShow.playerName);
                break;
            case TVSHOW_POKEMON_TODAY_FAILED:
                curShow->pokemonTodayFailed.language =
                    TV_GetStringLanguage(curShow->pokemonTodayFailed.playerName);
                break;
            case TVSHOW_FISHING_ADVICE:
                curShow->pokemonAngler.language =
                    TV_GetStringLanguage(curShow->pokemonAngler.playerName);
                break;
            case TVSHOW_WORLD_OF_MASTERS:
                curShow->worldOfMasters.language =
                    TV_GetStringLanguage(curShow->worldOfMasters.playerName);
                break;
            case TVSHOW_TREND_WATCHER:
                curShow->trendWatcher.language =
                    TV_GetStringLanguage(curShow->trendWatcher.playerName);
                break;
            case TVSHOW_BREAKING_NEWS:
                curShow->breakingNews.language =
                    TV_GetStringLanguage(curShow->breakingNews.playerName);
                break;
            case TVSHOW_BATTLE_SEMINAR:
                curShow->battleSeminar.language =
                    TV_GetStringLanguage(curShow->battleSeminar.playerName);
                break;
            case TVSHOW_FIND_THAT_GAMER:
            case TVSHOW_TRAINER_FAN_CLUB:
                curShow->trainerFanClub.language =
                    TV_GetStringLanguage(curShow->trainerFanClub.playerName);
                break;
            case TVSHOW_CUTIES:
                curShow->cuties.language = TV_GetStringLanguage(curShow->cuties.playerName);
                curShow->cuties.pokemonNameLanguage =
                    TV_GetStringLanguage(curShow->cuties.nickname);
                break;
            case TVSHOW_TODAYS_RIVAL_TRAINER:
            case TVSHOW_SECRET_BASE_VISIT:
            case TVSHOW_FRONTIER:
                curShow->rivalTrainer.language =
                    TV_GetStringLanguage(curShow->rivalTrainer.playerName);
                break;
            case TVSHOW_TREASURE_INVESTIGATORS:
            case TVSHOW_LOTTO_WINNER:
            case TVSHOW_NUMBER_ONE:
                curShow->treasureInvestigators.language =
                    TV_GetStringLanguage(curShow->treasureInvestigators.playerName);
                break;
            case TVSHOW_SECRET_BASE_SECRETS:
                curShow->secretBaseSecrets.language =
                    TV_GetStringLanguage(curShow->secretBaseSecrets.playerName);
                curShow->secretBaseSecrets.baseOwnersNameLanguage =
                    TV_GetStringLanguage(curShow->secretBaseSecrets.baseOwnersName);
                break;
            case TVSHOW_SAFARI_FAN_CLUB:
                curShow->safariFanClub.language =
                    TV_GetStringLanguage(curShow->safariFanClub.playerName);
                break;
            case TVSHOW_MASS_OUTBREAK:
                break;
        }
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->bravoTrainer.playerName, show->bravoTrainer.language);
            CopyContestCategoryToStringVar(1, show->bravoTrainer.contestCategory);
            CopyContestRankToStringVar(2, show->bravoTrainer.contestRank);
            if (!StringCompare(
                    gSpeciesNames[show->bravoTrainer.species], show->bravoTrainer.pokemonNickname))
                sTVShowState = 8;
            else
                sTVShowState = 1;
            break;
        case 1:
            ...
            TVShowConvertInternationalString(gStringVar2,
                show->bravoTrainer.pokemonNickname,
                show->bravoTrainer.pokemonNameLanguage);
...
static void DoTVShowBravoTrainerBattleTower(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->bravoTrainerTower.trainerName, show->bravoTrainerTower.language);
        ...
        case 1:
            ...
            break;
        case 2:
            TVShowConvertInternationalString(gStringVar1,
                show->bravoTrainerTower.pokemonName,
                show->bravoTrainerTower.pokemonNameLanguage);
        ...
        case 13:
            CopyEasyChatWord(gStringVar1, show->bravoTrainerTower.words[0]);
            TVShowConvertInternationalString(
                gStringVar2, show->bravoTrainerTower.trainerName, show->bravoTrainerTower.language);
            TVShowConvertInternationalString(gStringVar3,
                show->bravoTrainerTower.pokemonName,
                show->bravoTrainerTower.pokemonNameLanguage);
            sTVShowState = 14;
            break;
...
static void DoTVShowTodaysSmartShopper(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->smartshopperShow.playerName, show->smartshopperShow.language);
...
static void DoTVShowTheNameRaterShow(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->nameRaterShow.trainerName, show->nameRaterShow.language);
...
static void DoTVShowPokemonTodaySuccessfulCapture(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->pokemonToday.playerName, show->pokemonToday.language);
            StringCopy(gStringVar2, gSpeciesNames[show->pokemonToday.species]);
            TVShowConvertInternationalString(
                gStringVar3, show->pokemonToday.nickname, show->pokemonToday.language2);
        ...
        case 8:
            ...
            TVShowConvertInternationalString(
                gStringVar2, show->pokemonToday.nickname, show->pokemonToday.language2);
...
static void DoTVShowPokemonTodayFailedCapture(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(gStringVar1,
                show->pokemonTodayFailed.playerName,
                show->pokemonTodayFailed.language);
...
static void DoTVShowPokemonFanClubLetter(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->fanclubLetter.playerName, show->fanclubLetter.language);
...
static void DoTVShowRecentHappenings(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->recentHappenings.playerName, show->recentHappenings.language);
            TV_FanClubLetter_RandomWordToStringVar3(show);
            sTVShowState = 50;
            break;
        case 1:
...
static void DoTVShowPokemonFanClubOpinions(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->fanclubOpinions.playerName, show->fanclubOpinions.language);
...
// First talks about the winner and something they did, then about a losing player and something
// they did The show is only generated when the player wins, but can be record mixed to other games
// Each state buffers any needed data for a message to print from sTVContestLiveUpdatesTextGroup
// Many cases in this function are identical, and its size can be reduced a good deal by collapsing
// them Can't get this to match while collapsing them though
static void DoTVShowPokemonContestLiveUpdates(void)
{
    TVShow *show;
    u8 state;
    ...
    switch (state)
    {
        case CONTESTLIVE_STATE_INTRO:
            ...
            TVShowConvertInternationalString(gStringVar3,
                ...
                show->contestLiveUpdates.winningTrainerLanguage);
...
static void DoTVShowPokemonBattleUpdate(void)
{
    ...
    switch (state)
    {
        ...
        case 1:
            TVShowConvertInternationalString(
                gStringVar1, show->battleUpdate.playerName, show->battleUpdate.language);
            TVShowConvertInternationalString(gStringVar2,
                show->battleUpdate.linkOpponentName,
                show->battleUpdate.linkOpponentLanguage);
...
static void DoTVShow3CheersForPokeblocks(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->threeCheers.playerName, show->threeCheers.language);
        ...
        case 1:
            ...
            TVShowConvertInternationalString(
                gStringVar3, show->threeCheers.playerName, show->threeCheers.language);
            sTVShowState = 2;
            break;
        case 2:
            TVShowConvertInternationalString(gStringVar1,
                show->threeCheers.worstBlenderName,
                show->threeCheers.worstBlenderLanguage);
            sTVShowState = 5;
            break;
        case 3:
            switch (show->threeCheers.flavor)
        ...
        case 4:
            TVShowConvertInternationalString(gStringVar1,
                ...
                show->threeCheers.worstBlenderLanguage);
            TVShowConvertInternationalString(
                gStringVar2, show->threeCheers.playerName, show->threeCheers.language);
            sTVShowState = 5;
            break;
        case 5:
            TVShowDone();
...
static void DoTVShowPokemonAngler(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->pokemonAngler.playerName, show->pokemonAngler.language);
...
static void DoTVShowTheWorldOfMasters(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->worldOfMasters.playerName, show->worldOfMasters.language);
...
static void DoTVShowTodaysRivalTrainer(void)
{
    ...
    switch (state)
    {
        ...
        case 7:
            TVShowConvertInternationalString(
                gStringVar1, show->rivalTrainer.playerName, show->rivalTrainer.language);
...
static void DoTVShowDewfordTrendWatcherNetwork(void)
{
    ...
    switch (state)
    {
        ...
        case 2:
            ...
            CopyEasyChatWord(gStringVar2, show->trendWatcher.words[1]);
            TVShowConvertInternationalString(
                gStringVar3, show->trendWatcher.playerName, show->trendWatcher.language);
            sTVShowState = 3;
            break;
        case 3:
            CopyEasyChatWord(gStringVar1, show->trendWatcher.words[0]);
...
static void DoTVShowHoennTreasureInvestigators(void)
{
    ...
    switch (state)
    {
        ...
        case 1:
            StringCopy(gStringVar1, ItemId_GetName(show->treasureInvestigators.item));
            TVShowConvertInternationalString(gStringVar2,
                show->treasureInvestigators.playerName,
                show->treasureInvestigators.language);
...
static void DoTVShowFindThatGamer(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->findThatGamer.playerName, show->findThatGamer.language);
...
static void DoTVShowBreakingNewsTV(void)
{
    ...
    switch (state)
    {
        ...
        case 1:
            TVShowConvertInternationalString(
                gStringVar1, show->breakingNews.playerName, show->breakingNews.language);
...
static void DoTVShowSecretBaseVisit(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->secretBaseVisit.playerName, show->secretBaseVisit.language);
...
static void DoTVShowPokemonLotteryWinnerFlashReport(void)
{
    ...
    state = sTVShowState;
    TVShowConvertInternationalString(
        gStringVar1, show->lottoWinner.playerName, show->lottoWinner.language);
...
static void DoTVShowTrainerFanClubSpecial(void)
{
    ...
    switch (state)
    {
        case 0:
            ...
            TVShowConvertInternationalString(
                gStringVar2, show->fanClubSpecial.playerName, show->fanClubSpecial.language);
...
static void DoTVShowTrainerFanClub(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->trainerFanClub.playerName, show->trainerFanClub.language);
...
static void DoTVShowSpotTheCuties(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->cuties.playerName, show->cuties.language);
            TVShowConvertInternationalString(
                gStringVar2, show->cuties.nickname, show->cuties.pokemonNameLanguage);
...
static void DoTVShowPokemonNewsBattleFrontier(void)
{
    ...
    switch (state)
    {
        ...
        case 1:
            TVShowConvertInternationalString(
                gStringVar1, show->frontier.playerName, show->frontier.language);
...
static void DoTVShowWhatsNo1InHoennToday(void)
{
    ...
    switch (state)
    {
        case 0:
            TVShowConvertInternationalString(
                gStringVar1, show->numberOne.playerName, show->numberOne.language);
...
static void DoTVShowSecretBaseSecrets(void)
{
    ...
    switch (state)
    {
        case SBSECRETS_STATE_INTRO:
            TVShowConvertInternationalString(gStringVar1,
                show->secretBaseSecrets.baseOwnersName,
                show->secretBaseSecrets.baseOwnersNameLanguage);
            TVShowConvertInternationalString(
                gStringVar2, show->secretBaseSecrets.playerName, show->secretBaseSecrets.language);
            ...
            else
            {
                ...
                sTVShowState = SecretBaseSecrets_GetStateByFlagNumber(
                    show, sTVSecretBaseSecretsRandomValues[0]);
            }
            break;
        case SBSECRETS_STATE_DO_NEXT1:
            ...
            switch (numActions)
            {
                ...
                default:
                    ...
                    show->secretBaseSecrets.savedState = SBSECRETS_STATE_DO_NEXT2;
                    sTVShowState = SecretBaseSecrets_GetStateByFlagNumber(
                        show, sTVSecretBaseSecretsRandomValues[1]);
                    break;
            }
            break;
        case SBSECRETS_STATE_DO_NEXT2:
            ...
            else
            {
                ...
                sTVShowState = SecretBaseSecrets_GetStateByFlagNumber(
                    show, sTVSecretBaseSecretsRandomValues[2]);
            }
            break;
        ...
        case SBSECRETS_STATE_OUTRO:
            ...
            TVShowDone();
            break;
        // All below states are descriptions of what the player interacted with while in the secret
        // base
...
static void DoTVShowSafariFanClub(void)
{
    ...
    switch (state)
    {
        ...
        case 1:
            TVShowConvertInternationalString(
                gStringVar1, show->safariFanClub.playerName, show->safariFanClub.language);
...
static void DoTVShowPokemonContestLiveUpdates2(void)
{
    ...
    switch (state)
    {
        ...
        case 2:
            TVShowConvertInternationalString(gStringVar3,
                show->contestLiveUpdates2.playerName,
                show->contestLiveUpdates2.language);
        case 3:
            TVShowConvertInternationalString(gStringVar2,
                show->contestLiveUpdates2.nickname,
                show->contestLiveUpdates2.pokemonNameLanguage);
            TVShowDone();
            break;
    }
