...
void PutPokemonTodayCaughtOnAir(void)
{
    ...
    else
    {
        ...
        if (!rbernoulli(1, 1) && StringCompare(gSpeciesNames[gBattleResults.caughtMonSpecies],
                                     gBattleResults.caughtMonNick))
        {
            sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
            if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(
                                            TVSHOW_POKEMON_TODAY_CAUGHT, FALSE) != TRUE)
            {
                for (i = 0; i < 11; i++)
                {
...
void PutPokemonTodayFailedOnTheAir(void)
{
    ...
    if (!rbernoulli(1, 1))
    {
        ...
        if (ct > 2 && (gBattleOutcome == B_OUTCOME_MON_FLED || gBattleOutcome == B_OUTCOME_WON))
        {
            sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
            if (sCurTVShowSlot != -1 && HasMixableShowAlreadyBeenSpawnedWithPlayerID(
                                            TVSHOW_POKEMON_TODAY_FAILED, FALSE) != TRUE)
            {
                show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
static void sub_80F0F64(TVShow *show, u32 language)
{
    ...
    for (i = 0; i < LAST_TVSHOW_IDX; i++)
    {
        ...
        case TVSHOW_BRAVO_TRAINER_BATTLE_TOWER_PROFILE:
            r4[5] = &show[i];
            tvlangfix(
                r4[5]->bravoTrainerTower.trainerName, r4[5]->bravoTrainerTower.language, language);
        ...
        case TVSHOW_POKEMON_TODAY_FAILED:
            r4[2] = &show[i];
            tvlangfix(
                r4[2]->pokemonTodayFailed.playerName, r4[2]->pokemonTodayFailed.language, language);
            break;
        case TVSHOW_FISHING_ADVICE:
            r4[8] = &show[i];
...
static void DoTVShowTheNameRaterShow(void)
{
    ...
    case 0:
        ...
        TVShowConvertInternationalString(
            gStringVar3, show->nameRaterShow.pokemonName, show->nameRaterShow.pokemonNameLanguage);
    ...
    case 11:
        TVShowConvertInternationalString(
            gStringVar1, show->nameRaterShow.pokemonName, show->nameRaterShow.pokemonNameLanguage);
...
static void DoTVShowPokemonTodayFailedCapture(void)
{
    ...
    case 0:
        TVShowConvertInternationalString(
            gStringVar1, show->pokemonTodayFailed.playerName, show->pokemonTodayFailed.language);
...
static void DoTVShowPokemonFanClubOpinions(void)
{
    ...
    case 0:
        ...
        TVShowConvertInternationalString(
            gStringVar3, show->fanclubOpinions.nickname, show->fanclubOpinions.pokemonNameLanguage);
...
static void DoTVShowSecretBaseSecrets(void)
{
    ...
    case SBSECRETS_STATE_INTRO:
        ...
        else
        {
            ...
            sTVShowState =
                SecretBaseSecrets_GetStateByFlagNumber(show, sTVSecretBaseSecretsRandomValues[0]);
        }
        break;
    case SBSECRETS_STATE_DO_NEXT1:
        ...
        default:
            ...
            show->secretBaseSecrets.savedState = SBSECRETS_STATE_DO_NEXT2;
            sTVShowState =
                SecretBaseSecrets_GetStateByFlagNumber(show, sTVSecretBaseSecretsRandomValues[1]);
            break;
        }
        break;
    case SBSECRETS_STATE_DO_NEXT2:
        ...
        else
        {
            ...
            sTVShowState =
                SecretBaseSecrets_GetStateByFlagNumber(show, sTVSecretBaseSecretsRandomValues[2]);
        }
        break;
...
static void DoTVShowPokemonContestLiveUpdates2(void)
{
    ...
    case 2:
        TVShowConvertInternationalString(
            gStringVar3, show->contestLiveUpdates2.playerName, show->contestLiveUpdates2.language);
    case 3:
        TVShowConvertInternationalString(gStringVar2,
