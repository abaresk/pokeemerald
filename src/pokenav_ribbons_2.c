...
struct {
    ...
    u8 unk2;
    u8 unk3;
} static const gUnknown_086237F8[] = { { 1, 1, 0, 0 },  { 3, 4, 1, 0 },  { 3, 4, 5, 0 },  { 3, 4, 9, 0 },
                                       { 3, 4, 13, 0 }, { 3, 4, 17, 0 }, { 1, 1, 21, 0 }, { 1, 1, 22, 0 },
                                       { 1, 1, 23, 0 }, { 1, 1, 24, 0 }, { 1, 1, 25, 1 }, { 1, 1, 26, 1 },
                                       { 1, 1, 27, 1 }, { 1, 1, 28, 1 }, { 1, 1, 29, 1 }, { 1, 1, 30, 1 },
                                       { 1, 1, 31, 1 } };
...
static const LoopedTask gUnknown_08624BA0[] = { NULL, sub_81D0C84, sub_81D0D2C, sub_81D0D8C, sub_81D0E00, sub_81D0C54 };
...
void sub_81D0EFC(struct PokenavSub14* structPtr) {
    ...
    if (ribbonId < 25) {
        for (i = 0; i < 2; i++)
            AddTextPrinterParameterized3(structPtr->field_A, 1, 0, (i * 16) + 1, color, -1,
...
static const u8 sMaleIconString[] =
    _("{COLOR_HIGHLIGHT_SHADOW}{LIGHT_RED}{WHITE}{GREEN}♂{COLOR_HIGHLIGHT_SHADOW}{DARK_GREY}{WHITE}{LIGHT_GREY}");
static const u8 sFemaleIconString[] =
    _("{COLOR_HIGHLIGHT_SHADOW}{LIGHT_GREEN}{WHITE}{BLUE}♀{COLOR_HIGHLIGHT_SHADOW}{DARK_GREY}{WHITE}{LIGHT_GREY}");
...
struct {
    ...
    { 0, 0 }, { 1, 0 }, { 2, 0 }, { 3, 0 }, { 4, 0 }, { 1, 1 }, { 2, 1 },  { 3, 1 },  { 4, 1 },  { 1, 2 },  { 2, 2 },
    { 3, 2 }, { 4, 2 }, { 1, 3 }, { 2, 3 }, { 3, 3 }, { 4, 3 }, { 1, 4 },  { 2, 4 },  { 3, 4 },  { 4, 4 },  { 5, 0 },
    { 6, 0 }, { 7, 1 }, { 8, 2 }, { 9, 1 }, { 9, 3 }, { 9, 4 }, { 10, 3 }, { 10, 4 }, { 11, 0 }, { 11, 1 },
};
...
static const struct SpritePalette gUnknown_08624C80[] = {
    { gUnknown_08623FF8, 15 }, { gUnknown_08624018, 16 }, { gUnknown_08624038, 17 },
    { gUnknown_08624058, 18 }, { gUnknown_08624078, 19 }, {},
};
...
static const union AffineAnimCmd sSpriteAffineAnim_8624CB8[] = { AFFINEANIMCMD_FRAME(128, 128, 0, 0),
                                                                 AFFINEANIMCMD_END };

static const union AffineAnimCmd sSpriteAffineAnim_8624CC8[] = { AFFINEANIMCMD_FRAME(128, 128, 0, 0),
                                                                 AFFINEANIMCMD_FRAME(32, 32, 0, 4), AFFINEANIMCMD_END };

static const union AffineAnimCmd sSpriteAffineAnim_8624CE0[] = { AFFINEANIMCMD_FRAME(256, 256, 0, 0),
                                                                 AFFINEANIMCMD_FRAME(-32, -32, 0, 4),
                                                                 AFFINEANIMCMD_END };

static const union AffineAnimCmd* const sSpriteAffineAnimTable_8624CF8[] = { sSpriteAffineAnim_8624CB8,
