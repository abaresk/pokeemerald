...
// The below data for smokescreen starts and ends with some data that belongs to
...
static const union AnimCmd sAnim_SmokescreenImpact_0[] = {
    ANIMCMD_FRAME(0, 4), ANIMCMD_FRAME(4, 4), ANIMCMD_FRAME(8, 4), ANIMCMD_END
};
...
static const union AnimCmd sAnim_SmokescreenImpact_3[] = { ANIMCMD_FRAME(
                                                               0, 4, .hFlip = TRUE, .vFlip = TRUE),
