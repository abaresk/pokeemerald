            ...
            switch (r4->unk12)
            {
                ...
                case 12:
                    sub_80219C8(r6->unk82,
                        20,
                        4,
                        gUnknown_082F43B4[r4->unk68.as_five_players.unk1C[0].unk4.as_2d_bytes[0][7]
                                          + 3]);
    ...
    switch (r7->unkC)
    {
        ...
        case 3:
            ...
            for (r6 = 0, r8 = 0; r8 < r7->unk9; ++r8)
            {
                ...
                r7->unk68.as_four_players.unk00.unk0A +=
                    r7->unk68.as_four_players.unk00.unk0C[0][r8];
                switch (r7->unk68.as_five_players.unk1C[0].unk4.as_2d_bytes[0][7])
                {
                    ...
                    case 2:
                        ...
                        else if (r7->unk68.as_four_players.others[r8].unk4.as_hwords[5]
                                 >= r7->unk28)
                        {
                            r4 = 0x6400;
                        }
