...
static const s8 gUnknown_082F326C[][7] = {
    { 4, 1, 0, -1, 0, 0, 0 },   { 4, 2, 0, -1, 0, 0, 0 },   { 4, 2, 0, -2, 0, 0, 0 },
    { 6, 3, 1, -1, -3, -1, 0 }, { 6, 4, 1, -2, -4, -2, 0 },
};

static const u8 sUnusedZero = 0;

static const u8 gUnknown_082F3290[][4] = {
    { 3, 2, 1, 0 }, { 3, 3, 1, 0 }, { 3, 3, 2, 0 }, { 3, 4, 2, 0 }, { 3, 5, 3, 0 },
};

static const u8* const gUnknown_082F32A4[] = {
    gText_ReadyToBerryCrush,    gText_WaitForAllChooseBerry, gText_EndedWithXUnitsPowder,
    gText_RecordingGameResults, gText_PlayBerryCrushAgain,   gText_YouHaveNoBerries,
    gText_MemberDroppedOut,     gText_TimesUpNoGoodPowder,   gText_CommunicationStandby2,
};
...
static const struct WindowTemplate sWindowTemplate_BerryCrushRankings = {
    .bg = 0, .tilemapLeft = 3, .tilemapTop = 4, .width = 24, .height = 13, .paletteNum = 15, .baseBlock = 1
};
...
static const u32 sPressingSpeedConversionTable[] = {
    50000000 / (1 << 0), 50000000 / (1 << 1), 50000000 / (1 << 2), 50000000 / (1 << 3),
    50000000 / (1 << 4), 50000000 / (1 << 5), 50000000 / (1 << 6), 50000000 / (1 << 7),
};
...
static const s8 gUnknown_082F41D2[][2] = {
    { 0, 0 },   { -16, -4 },  { 16, -4 },  { -8, -2 },   { 8, -2 },   { -24, -8 },
    { 24, -8 }, { -32, -12 }, { 32, -12 }, { -40, -16 }, { 40, -16 },
};
...
static const struct SpriteSheet gUnknown_082F420C[] = { { .data = gBerryCrushTimerDigitsGfx, .size = 0x2C0, .tag = 4 },
                                                        {} };
...
static const struct SpritePalette gUnknown_082F422C[] = { { .data = gBerryCrushTimerDigitsPal, .tag = 4 }, {} };

static const union AnimCmd gUnknown_082F423C[] = { ANIMCMD_FRAME(0, 0), ANIMCMD_END };

static const union AnimCmd gUnknown_082F4244[] = { ANIMCMD_FRAME(0, 4), ANIMCMD_FRAME(16, 4), ANIMCMD_FRAME(32, 4),
                                                   ANIMCMD_END };

static const union AnimCmd gUnknown_082F4254[] = { ANIMCMD_FRAME(48, 2), ANIMCMD_FRAME(64, 2), ANIMCMD_FRAME(80, 2),
                                                   ANIMCMD_FRAME(96, 2), ANIMCMD_END };

static const union AnimCmd gUnknown_082F4268[] = { ANIMCMD_FRAME(0, 2),  ANIMCMD_FRAME(4, 2),  ANIMCMD_FRAME(8, 2),
                                                   ANIMCMD_FRAME(12, 2), ANIMCMD_FRAME(16, 2), ANIMCMD_FRAME(20, 2),
                                                   ANIMCMD_JUMP(0) };

static const union AnimCmd gUnknown_082F4284[] = { ANIMCMD_FRAME(24, 4), ANIMCMD_FRAME(28, 4), ANIMCMD_FRAME(32, 4),
                                                   ANIMCMD_FRAME(36, 4), ANIMCMD_FRAME(40, 4), ANIMCMD_FRAME(44, 4),
                                                   ANIMCMD_FRAME(48, 4), ANIMCMD_FRAME(52, 4), ANIMCMD_JUMP(0) };
...
static const union AffineAnimCmd gUnknown_082F42B8[] = { AFFINEANIMCMD_FRAME(256, 256, 0, 0),
                                                         AFFINEANIMCMD_FRAME(0, 0, 2, 1), AFFINEANIMCMD_JUMP(1) };

static const union AffineAnimCmd gUnknown_082F42D0[] = { AFFINEANIMCMD_FRAME(256, 256, 0, 0),
                                                         AFFINEANIMCMD_FRAME(0, 0, -2, 1), AFFINEANIMCMD_JUMP(1) };
...
static const u8* const gUnknown_082F43B4[] = {
    gText_SpaceTimes2,      gText_XDotY,        gText_Var1Berry,
    gText_NeatnessRankings, gText_CoopRankings, gText_PressingPowerRankings,
};

static u32 (*const gUnknown_082F43CC[])(struct BerryCrushGame*, u8*) = {
    NULL,        BerryCrushCommand_BeginNormalPaletteFade,
    sub_8022CB0, sub_8022D14,
    sub_8022E1C, sub_8022E3C,
    sub_8022E5C, sub_8022EAC,
    sub_8022F04, sub_8022F1C,
    sub_8023070, sub_80231B8,
    sub_80232EC, sub_80238F0,
    sub_8023998, sub_8023A30,
    sub_8023BC0, sub_8023CAC,
    sub_8024048, sub_8024134,
    sub_8024228, sub_80242E0,
    sub_80243BC, sub_8024444,
    sub_8024508, sub_8024568,
};
...
#define PLAYER_UNK14(game, i)                                                                             \
    ((u8*)(game) + offsetof(struct BerryCrushGame, unk68) + offsetof(struct BerryCrushGame_68_x, unk30) + \
...
void sub_80214A8(struct BerryCrushGame* arg0, struct BerryCrushGame_138* arg1) {
    ...
    for (i = 0; i < arg0->unk9; i++) {
        spriteId = AddCustomItemIconSprite(&gUnknown_082F436C, gUnknown_082F41E8[i], gUnknown_082F41E8[i],
    ...
    for (r8 = 0; r8 < sp0C->unk9; r6 += 14, ++r8) {
        ...
        switch (sp10) {
            case 0:
                ...
                if (r8 != 0 &&
                    sp24->as_four_players.unk00.unk0C[sp10][r8] != sp24->as_four_players.unk00.unk0C[sp10][r8 - 1])
                    sp20 = r8;
                ConvertIntToDecimalStringN(gStringVar4, sp24->as_four_players.unk00.unk0C[sp10][r8],
                                           STR_CONV_MODE_RIGHT_ALIGN, 4);
            ...
            case 1:
                ...
                if (r8 != 0 &&
                    sp24->as_four_players.unk00.unk0C[sp10][r8] != sp24->as_four_players.unk00.unk0C[sp10][r8 - 1])
                    sp20 = r8;
                ConvertIntToDecimalStringN(gStringVar1, sp24->as_four_players.unk00.unk0C[sp10][r8] >> 4,
...
static void Task_ShowBerryCrushRankings(u8 taskId) {
    ...
    switch (data[0]) {
        ...
        case 1:
            ...
            AddTextPrinterParameterized3(data[1], 1, xPos, 1, sBerryCrushTextColorTable[3], 0, gText_BerryCrush2);
            xPos = 96 - GetStringWidth(1, gText_PressingSpeedRankings, -1) / 2u;
            AddTextPrinterParameterized3(data[1], 1, xPos, 17, sBerryCrushTextColorTable[3], 0,
            ...
            for (i = 0; i < 4; ++i) {
                ...
                AddTextPrinterParameterized3(data[1], 1, 0, yPos, sBerryCrushTextColorTable[0], 0, gStringVar4);
                xPos = 192 - (u8)GetStringWidth(1, gText_TimesPerSec, -1);
                AddTextPrinterParameterized3(data[1], 1, xPos, yPos, sBerryCrushTextColorTable[0], 0,
                                             gText_TimesPerSec);
                for (j = 0; j < 8; ++j) {
                ...
                AddTextPrinterParameterized3(data[1], 1, xPos, yPos, sBerryCrushTextColorTable[0], 0, gStringVar4);
                yPos += 16;
                score = 0;
            }
...
void sub_8022600(struct BerryCrushGame* r6) {
    ...
    for (r7 = 0; r7 < r6->unk9; ++r7) {
        ...
        if (r7 == r6->unk8) {
            AddTextPrinterParameterized4(r6->unk138.unk83[r7], 2, 36 - GetStringWidth(2, PLAYER_UNK14(r6, r7), 0) / 2u,
                                         1, 0, 0, sBerryCrushTextColorTable[1], 0, PLAYER_UNK14(r6, r7));
        } else {
            AddTextPrinterParameterized4(r6->unk138.unk83[r7], 2, 36 - GetStringWidth(2, PLAYER_UNK14(r6, r7), 0) / 2u,
                                         1, 0, 0, sBerryCrushTextColorTable[2], 0, PLAYER_UNK14(r6, r7));
        }
...
void sub_80226D0(struct BerryCrushGame* r6) {
    ...
    for (; r5 < r6->unk9; ++r5) {
        ...
        CopyToBgTilemapBufferRect(3, &r4[r0_ * 40], r6->unk138.unkC[r5]->unk1, r6->unk138.unkC[r5]->unk2, 10, 2);
    }
    CopyBgTilemapBufferToVram(3);
}
...
void sub_8022730(struct BerryCrushGame* r6) {
    ...
    for (r5 = 0; r5 < r6->unk9; ++r5) {
        r2 = CreateSprite(&gUnknown_082F4324, r6->unk138.unkC[r5]->unk4 + 120, r6->unk138.unkC[r5]->unk6 + 32, 0);
    ...
    for (r5 = 0; r5 < ARRAY_COUNT(r6->unk138.unk4C); ++r5) {
        r2 = CreateSprite(&gUnknown_082F433C, gUnknown_082F41D2[r5][0] + 120, gUnknown_082F41D2[r5][1] + 136, 6);
...
void sub_802339C(struct BerryCrushGame* r4) {
    ...
    for (r7 = 0; r7 < r4->unk9; ++r7) {
        r2 = gRecvCmds[r7];
        if ((r2[0] & 0xFF00) == RFUCMD_SEND_PACKET && r2[1] == 2) {
            if ((u8)r2[2] & 4) {
...
void sub_802385C(struct BerryCrushGame* r5) {
    ...
    for (r4 = 0; r4 < r5->unk9; ++r4)
        r5->unk68.as_four_players.others[r4].unk4.as_2d_bytes[1][5] = 0;
#endif
    if ((gRecvCmds[0][0] & 0xFF00) != RFUCMD_SEND_PACKET || gRecvCmds[0][1] != 2) {
        r5->unk25_2 = 0;
    } else {
        r4_ = &r5->unk40.unkE;
...
static void BerryCrush_SetPaletteFadeParams(u8* params, bool8 communicateAfter, u32 selectedPals, s8 delay, u8 startY,
                                            u8 targetY, u16 palette) {
