...
static const struct WindowTemplate sUnknown_086253E8[] = {
    { .bg = 0, .tilemapLeft = 1, .tilemapTop = 1, .width = 8, .height = 2, .paletteNum = 0xF, .baseBlock = 0x8 },
    { .bg = 0, .tilemapLeft = 21, .tilemapTop = 1, .width = 8, .height = 18, .paletteNum = 0xF, .baseBlock = 0x18 },
    { .bg = 0, .tilemapLeft = 1, .tilemapTop = 1, .width = 11, .height = 8, .paletteNum = 0xF, .baseBlock = 0x18 }
};

static const u8 sPlayerNameTextColors[] = { TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GREY, TEXT_COLOR_LIGHT_GREY };
...
static const u8 sUnknown_08625410[] = {
    4,    5,    6,    7,    8,    9,    9,    10,   10,   0xB,  0xB,  0xC,  0xC,  0xD,  0xD,  0xD,  0xD,  0xE,  0xE,
    0xE,  0xE,  0xF,  0xF,  0xF,  0xF,  
};

static const struct WindowTemplate sMoveRelearnerWindowTemplates[] = {
    { .bg = 1, .tilemapLeft = 1, .tilemapTop = 1, .width = 16, .height = 12, .paletteNum = 0xF, .baseBlock = 0xA },
    { .bg = 1, .tilemapLeft = 1, .tilemapTop = 1, .width = 16, .height = 12, .paletteNum = 0xF, .baseBlock = 0xCA },
    { .bg = 1, .tilemapLeft = 19, .tilemapTop = 1, .width = 10, .height = 12, .paletteNum = 0xF, .baseBlock = 0x18A },
    { .bg = 1, .tilemapLeft = 4, .tilemapTop = 15, .width = 22, .height = 4, .paletteNum = 0xF, .baseBlock = 0x202 },
    { .bg = 0, .tilemapLeft = 22, .tilemapTop = 8, .width = 5, .height = 4, .paletteNum = 0xF, .baseBlock = 0x25A },
    DUMMY_WIN_TEMPLATE
};
...
void sub_81D1F84(struct ConditionGraph* graph, struct UnknownSubStruct_81D1ED4* arg1,
...
void sub_81D2108(struct ConditionGraph* graph) {
    ...
    for (i = 0; i < 66; i++) {
        ...
        gScanlineEffectRegBuffers[1][(i + 55) * 2 + 1] = gScanlineEffectRegBuffers[0][(i + 55) * 2 + 1] =
...
static void sub_81D2278(struct ConditionGraph* graph, u16* arg1, struct UnknownSubStruct_81D1ED4* arg2,
                        struct UnknownSubStruct_81D1ED4* arg3, u8 arg4, u16* arg5) {
...
void GetConditionMenuMonNameAndLocString(u8* locationDst, u8* nameDst, u16 boxId, u16 monId, u16 partyId, u16 numMons,
...
void GetConditionMenuMonConditions(struct ConditionGraph* graph, u8* sheen, u16 boxId, u16 monId, u16 partyId, u16 id,
                                   u16 numMons, bool8 excludesCancel) {
    u16 i;
...
void GetConditionMenuMonGfx(void* tilesDst, void* palDst, u16 boxId, u16 monId, u16 partyId, u16 numMons,
                            bool8 excludesCancel) {
    if (!excludesCancel)
        numMons--;
...
static const union AnimCmd sAnim_ConditionSelectionIcon_Selected[] = { ANIMCMD_FRAME(0, 5), ANIMCMD_END };

static const union AnimCmd sAnim_ConditionSelectionIcon_Unselected[] = { ANIMCMD_FRAME(4, 5), ANIMCMD_END };

static const union AnimCmd* const sAnims_ConditionSelectionIcon[] = { sAnim_ConditionSelectionIcon_Selected,
...
void LoadConditionMonPicTemplate(struct SpriteSheet* sheet, struct SpriteTemplate* template,
...
void LoadConditionSelectionIcons(struct SpriteSheet* sheets, struct SpriteTemplate* template,
                                 struct SpritePalette* pals) {
    u8 i;
...
static const union AnimCmd sAnim_ConditionSparkle[] = { ANIMCMD_FRAME(0, 5),  ANIMCMD_FRAME(4, 5),
...
static const union AnimCmd* const sAnims_ConditionSparkle[] = {
    ...
    &sAnim_ConditionSparkle[2],  &sAnim_ConditionSparkle[4],  &sAnim_ConditionSparkle[6],
    &sAnim_ConditionSparkle[8], // Here below OOB, will crash if used
    &sAnim_ConditionSparkle[10], &sAnim_ConditionSparkle[12],
};
...
static const u8* const sLvlUpStatStrings[NUM_STATS] = { gText_MaxHP, gText_Attack, gText_Defense,
