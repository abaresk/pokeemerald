...
static void NewGameBirchSpeech_ShowPokeBallPrinterCallback(
    struct TextPrinterTemplate *printer, u16 a);
...
static const u16 sBirchSpeechPlatformBlackPal[] = {
...
#define MENU_WIN_HCOORDS                                   \
    WIN_RANGE(((MENU_LEFT - 1) * 8) + MENU_SHADOW_PADDING, \
...
static const struct WindowTemplate gNewGameBirchSpeechTextWindows[] = { { .bg = 0,
                                                                            .tilemapLeft = 2,
                                                                            .tilemapTop = 15,
                                                                            .width = 27,
                                                                            .height = 4,
...
static const u8 sTextColor_Headers[] = {
    TEXT_DYNAMIC_COLOR_1, TEXT_DYNAMIC_COLOR_2, TEXT_DYNAMIC_COLOR_3
};
static const u8 sTextColor_MenuInfo[] = {
    TEXT_DYNAMIC_COLOR_1, TEXT_COLOR_WHITE, TEXT_DYNAMIC_COLOR_3
};

static const struct BgTemplate sMainMenuBgTemplates[] = { { .bg = 0,
                                                              .charBaseIndex = 2,
                                                              .mapBaseIndex = 30,
                                                              .screenSize = 0,
                                                              .paletteMode = 0,
...
static const struct BgTemplate sBirchBgTemplate = { .bg = 0,
    .charBaseIndex = 3,
    .mapBaseIndex = 30,
    .screenSize = 0,
    .paletteMode = 0,
...
static const union AffineAnimCmd sSpriteAffineAnim_PlayerShrink[] = {
    AFFINEANIMCMD_FRAME(-2, -2, 0, 0x30), AFFINEANIMCMD_END
};
...
static const struct MenuAction sMenuActions_Gender[] = { { gText_BirchBoy, NULL },
    { gText_BirchGirl, NULL } };

static const u8 *const gMalePresetNames[] = { gText_DefaultNameStu,
...
static const u8 *const gFemalePresetNames[] = { gText_DefaultNameKimmy,
...
static void Task_MainMenuCheckSaveFile(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        if (sCurrItemAndOptionMenuCheck
            & OPTION_MENU_FLAG) // are we returning from the options menu?
        {
        ...
        sCurrItemAndOptionMenuCheck &=
            CURRENT_ITEM_MASK; // turn off the "returning from options menu" flag
        ...
        switch (gTasks[taskId].tMenuType)
        {
            ...
            default:
                ...
                AddTextPrinterParameterized3(
                    0, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
                AddTextPrinterParameterized3(
                    1, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuOption);
                PutWindowTilemap(0);
                PutWindowTilemap(1);
            ...
            case HAS_SAVED_GAME:
                ...
                AddTextPrinterParameterized3(
                    2, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuContinue);
                AddTextPrinterParameterized3(
                    3, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
                AddTextPrinterParameterized3(
                    4, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuOption);
            ...
            case HAS_MYSTERY_GIFT:
                ...
                AddTextPrinterParameterized3(
                    3, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
                AddTextPrinterParameterized3(
                    4, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuMysteryGift);
                AddTextPrinterParameterized3(
                    5, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuOption);
                MainMenu_FormatSavegameText();
                PutWindowTilemap(2);
                PutWindowTilemap(3);
                PutWindowTilemap(4);
            ...
            case HAS_MYSTERY_EVENTS:
                ...
                AddTextPrinterParameterized3(
                    3, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
                AddTextPrinterParameterized3(
                    4, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuMysteryGift2);
                AddTextPrinterParameterized3(
                    5, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuMysteryEvents);
                AddTextPrinterParameterized3(
                    6, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuOption);
                MainMenu_FormatSavegameText();
                PutWindowTilemap(2);
                PutWindowTilemap(3);
                PutWindowTilemap(4);
                ...
                tScrollArrowTaskId = AddScrollIndicatorArrowPair(
                    &sScrollArrowsTemplate_MainMenu, &sCurrItemAndOptionMenuCheck);
...
static void Task_HighlightSelectedMainMenuItem(u8 taskId)
{
    HighlightSelectedMainMenuItem(
        gTasks[taskId].tMenuType, gTasks[taskId].tCurrItem, gTasks[taskId].tIsScrolled);
...
static bool8 HandleMainMenuInput(u8 taskId)
{
    ...
    {
        PlaySE(SE_SELECT);
        IsWirelessAdapterConnected(); // why bother calling this here? debug?
                                      // Task_HandleMainMenuAPressed will check too
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(
        spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_LOTAD);
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    brendanSpriteId = CreateTrainerSprite(
        FacilityClassToPicIndex(FACILITY_CLASS_BRENDAN), 120, 60, 0, &gDecompressionBuffer[0]);
    gSprites[brendanSpriteId].callback = SpriteCB_Null;
    gSprites[brendanSpriteId].invisible = TRUE;
    gSprites[brendanSpriteId].oam.priority = 0;
    gTasks[taskId].tBrendanSpriteId = brendanSpriteId;
    maySpriteId = CreateTrainerSprite(
        FacilityClassToPicIndex(FACILITY_CLASS_MAY), 120, 60, 0, &gDecompressionBuffer[0x800]);
...
static void MainMenu_FormatSavegamePlayer(void)
{
    ...
    AddTextPrinterParameterized3(2,
        1,
        GetStringRightAlignXOffset(1, gSaveBlock2Ptr->playerName, 100),
        17,
        sTextColor_MenuInfo,
        -1,
        gSaveBlock2Ptr->playerName);
...
static void MainMenu_FormatSavegameTime(void)
{
    ...
    ptr =
        ConvertIntToDecimalStringN(str, gSaveBlock2Ptr->playTimeHours, STR_CONV_MODE_LEFT_ALIGN, 3);
    *ptr = 0xF0;
    ConvertIntToDecimalStringN(
        ptr + 1, gSaveBlock2Ptr->playTimeMinutes, STR_CONV_MODE_LEADING_ZEROS, 2);
    AddTextPrinterParameterized3(
        2, 1, GetStringRightAlignXOffset(1, str, 0xD0), 17, sTextColor_MenuInfo, -1, str);
}
...
static void MainMenu_FormatSavegamePokedex(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        ...
        AddTextPrinterParameterized3(
            2, 1, GetStringRightAlignXOffset(1, str, 100), 33, sTextColor_MenuInfo, -1, str);
    }
}
...
static void MainMenu_FormatSavegameBadges(void)
{
    ...
    AddTextPrinterParameterized3(
        2, 1, GetStringRightAlignXOffset(1, str, 0xD0), 33, sTextColor_MenuInfo, -1, str);
}
...
static void DrawMainMenuWindowBorder(const struct WindowTemplate *template, u16 baseTileNum)
{
    ...
    FillBgTilemapBufferRect(
        template->bg, baseTileNum, template->tilemapLeft - 1, template->tilemapTop - 1, 1, 1, 2);
    FillBgTilemapBufferRect(
        template->bg, r9, template->tilemapLeft, template->tilemapTop - 1, template->width, 1, 2);
    FillBgTilemapBufferRect(template->bg,
        r10,
...
static void NewGameBirchSpeech_ClearWindow(u8 windowId)
{
    ...
    FillWindowPixelRect(
        windowId, bgColor, 0, 0, maxCharWidth * winWidth, maxCharHeight * winHeight);
