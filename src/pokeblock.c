...
enum { PKBL_USE_ON_FIELD, PKBL_TOSS, PKBL_CANCEL, PKBL_USE_IN_BATTLE, PKBL_USE_ON_FEEDER, PKBL_GIVE_TO_LADY };
...
const u8* const gPokeblockNames[] = { [PBLOCK_CLR_NONE] = NULL,
...
static const u8 sContestStatsMonData[] = { MON_DATA_COOL, MON_DATA_BEAUTY, MON_DATA_CUTE, MON_DATA_SMART,
                                           MON_DATA_TOUGH };
...
static const union AnimCmd sSpriteAnim_PokeblockCase[] = { ANIMCMD_FRAME(0, 0), ANIMCMD_END };

static const union AnimCmd* const sSpriteAnimTable_PokeblockCase[] = { sSpriteAnim_PokeblockCase };

static const union AffineAnimCmd sSpriteAffineAnim_85B26C8[] = { AFFINEANIMCMD_FRAME(0, 0, -2, 2),
                                                                 AFFINEANIMCMD_FRAME(0, 0, 2, 4),
                                                                 AFFINEANIMCMD_FRAME(0, 0, -2, 4),
                                                                 AFFINEANIMCMD_FRAME(0, 0, 2, 2), AFFINEANIMCMD_END };

static const union AffineAnimCmd* const sSpriteAffineAnimTable_85B26F0[] = { sSpriteAffineAnim_85B26C8 };

const struct CompressedSpriteSheet gPokeblockCase_SpriteSheet = { gMenuPokeblockDevice_Gfx, 0x800,
                                                                  GFX_TAG_POKEBLOCK_CASE };

const struct CompressedSpritePalette gPokeblockCase_SpritePal = { gMenuPokeblockDevice_Pal, GFX_TAG_POKEBLOCK_CASE };

static const struct SpriteTemplate sSpriteTemplate_PokeblockCase = {
    GFX_TAG_POKEBLOCK_CASE,      GFX_TAG_POKEBLOCK_CASE, &sOamData_PokeblockCase, sSpriteAnimTable_PokeblockCase, NULL,
    gDummySpriteAffineAnimTable, SpriteCallbackDummy
};

static const u8 sTextColorInPokeblockMenu[3] = { 0, 2, 3 };

static const struct Pokeblock sFavoritePokeblocksTable[] = { { PBLOCK_CLR_RED, 20, 0, 0, 0, 0, 20 },
...
static const struct WindowTemplate sWindowTemplatesForPokeblockMenu[] = {
    { .bg = 0, .tilemapLeft = 2, .tilemapTop = 1, .width = 9, .height = 2, .paletteNum = 15, .baseBlock = 0x1E },
    { .bg = 0, .tilemapLeft = 15, .tilemapTop = 1, .width = 14, .height = 18, .paletteNum = 15, .baseBlock = 0x30 },
    { .bg = 0, .tilemapLeft = 2, .tilemapTop = 13, .width = 5, .height = 2, .paletteNum = 15, .baseBlock = 0x12C },
    { .bg = 0, .tilemapLeft = 2, .tilemapTop = 15, .width = 5, .height = 2, .paletteNum = 15, .baseBlock = 0x136 },
    { .bg = 0, .tilemapLeft = 2, .tilemapTop = 17, .width = 5, .height = 2, .paletteNum = 15, .baseBlock = 0x140 },
    { .bg = 0, .tilemapLeft = 8, .tilemapTop = 13, .width = 5, .height = 2, .paletteNum = 15, .baseBlock = 0x14A },
    { .bg = 0, .tilemapLeft = 8, .tilemapTop = 15, .width = 5, .height = 2, .paletteNum = 15, .baseBlock = 0x154 },
    { .bg = 0, .tilemapLeft = 11, .tilemapTop = 17, .width = 2, .height = 2, .paletteNum = 15, .baseBlock = 0x15E },
    { .bg = 1, .tilemapLeft = 7, .tilemapTop = 5, .width = 6, .height = 6, .paletteNum = 15, .baseBlock = 0x162 },
    { .bg = 1, .tilemapLeft = 7, .tilemapTop = 7, .width = 6, .height = 4, .paletteNum = 15, .baseBlock = 0x186 },
    { .bg = 1, .tilemapLeft = 2, .tilemapTop = 15, .width = 27, .height = 4, .paletteNum = 15, .baseBlock = 0x19E },
    DUMMY_WIN_TEMPLATE
};

static const struct WindowTemplate sTossPkblockWindowTemplate = {
    .bg = 1, .tilemapLeft = 21, .tilemapTop = 9, .width = 5, .height = 4, .paletteNum = 15, .baseBlock = 0x20A
};

static const struct ListMenuTemplate sPokeblockListMenuTemplate = { .items = NULL,
...
static bool8 InitPokeblockMenu(void) {
    ...
    switch (gMain.state) {
        ...
        case 15:
            ...
            gTasks[taskId].data[0] = ListMenuInit(&gMultiuseListMenuTemplate, sSavedPokeblockData.lastItemPage,
...
static void sub_8136344(void) {
    if (sSavedPokeblockData.lastItemPos > 4) {
        ...
        for (i = 0; (i < sSavedPokeblockData.lastItemPos - 4) &&
                    (sSavedPokeblockData.lastItemPage + sPokeblockMenu->maxShowed != sPokeblockMenu->itemsNo);
...
static void sub_81363BC(void) {
    if (sPokeblockMenu->unkTaskId == 0xFF) {
        sPokeblockMenu->unkTaskId = AddScrollIndicatorArrowPairParameterized(
            SCROLL_ARROW_UP, 0xB0, 8, 0x98, sPokeblockMenu->itemsNo - sPokeblockMenu->maxShowed, 0x456, 0x456,
            &sSavedPokeblockData.lastItemPage);
    }
}
...
static void HandlePokeblocksSwap(u8 taskId, bool8 noSwap) {
    ...
    data[0] =
        ListMenuInit(&gMultiuseListMenuTemplate, sSavedPokeblockData.lastItemPage, sSavedPokeblockData.lastItemPos);
    ScheduleBgCopyTilemapToVram(0);
...
static void PokeblockAction_Toss(u8 taskId) {
    ...
    DisplayMessageAndContinueTask(taskId, 10, 10, 13, 1, GetPlayerTextSpeedDelay(), gStringVar4,
