...
static const union AnimCmd sAnim_LargeFlame[] = {
    ANIMCMD_FRAME(0, 3),  ANIMCMD_FRAME(16, 3), ANIMCMD_FRAME(32, 3),  ANIMCMD_FRAME(48, 3), ANIMCMD_FRAME(64, 3),
    ANIMCMD_FRAME(80, 3), ANIMCMD_FRAME(96, 3), ANIMCMD_FRAME(112, 3), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_FirePlume[] = {
    ANIMCMD_FRAME(0, 5),  ANIMCMD_FRAME(16, 5), ANIMCMD_FRAME(32, 5),
    ANIMCMD_FRAME(48, 5), ANIMCMD_FRAME(64, 5), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_BasicFire[] = {
    ...
    ANIMCMD_FRAME(48, 4), ANIMCMD_FRAME(64, 4), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_WillOWispOrb_0[] = {
    ANIMCMD_FRAME(0, 5), ANIMCMD_FRAME(4, 5), ANIMCMD_FRAME(8, 5), ANIMCMD_FRAME(12, 5), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd sAnim_WillOWispFire[] = {
    ANIMCMD_FRAME(0, 5), ANIMCMD_FRAME(16, 5), ANIMCMD_FRAME(32, 5), ANIMCMD_FRAME(48, 5), ANIMCMD_JUMP(0),
};
...
static void CreateEruptionLaunchRocks(u8 spriteId, u8 taskId, u8 a3) {
    ...
    for (i = 0, j = 0; i <= 6; i++) {
        ...
        if (spriteId != 0x40) {
            ...
            InitEruptionLaunchRockCoordData(&gSprites[spriteId], sEruptionLaunchRockCoords[i][0] * sign,
                                            sEruptionLaunchRockCoords[i][1]);
...
void AnimTask_BlendBackground(u8 taskId) {
    ...
    sub_80A6B30(&animBg);
    BlendPalette(animBg.paletteId * 16, 16, gBattleAnimArgs[0],
                 gBattleAnimArgs[1]); // u16 palOffset, u16 numEntries, u8 coeff, u16 blendColor
    DestroyAnimVisualTask(taskId);
}
...
void AnimTask_ShakeTargetInPattern(u8 taskId) {
    ...
    if (gTasks[taskId].tVertical == TRUE)
        gSprites[spriteId].pos2.y =
            gBattleAnimArgs[1] * dir < 0 ? -(gBattleAnimArgs[1] * dir) : gBattleAnimArgs[1] * dir;
    else
