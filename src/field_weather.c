...
const u16 sDroughtWeatherColors[][0x1000] = {
    INCBIN_U16("graphics/weather/drought/colors_0.bin"), INCBIN_U16("graphics/weather/drought/colors_1.bin"),
    INCBIN_U16("graphics/weather/drought/colors_2.bin"), INCBIN_U16("graphics/weather/drought/colors_3.bin"),
    INCBIN_U16("graphics/weather/drought/colors_4.bin"), INCBIN_U16("graphics/weather/drought/colors_5.bin"),
};
...
static const struct WeatherCallbacks sWeatherFuncs[] = {
    ...
    [WEATHER_RAIN_THUNDERSTORM] = { Thunderstorm_InitVars, Thunderstorm_Main, Thunderstorm_InitAll,
                                    Thunderstorm_Finish },
    [WEATHER_FOG_HORIZONTAL] = { FogHorizontal_InitVars, FogHorizontal_Main, FogHorizontal_InitAll,
...
static void ApplyGammaShift(u8 startPalIndex, u8 numPalettes, s8 gammaIndex) {
    ...
    if (gammaIndex > 0) {
        ...
        // A negative gammIndex value means that the blending will come from the special Drought weather's palette
        // tables.
            ...
            if (sPaletteGammaTypes[curPalIndex] == GAMMA_NONE) {
                ...
                for (i = 0; i < 16; i++) {
                    gPlttBufferFaded[palOffset] =
                        sDroughtWeatherColors[gammaIndex][DROUGHT_COLOR_INDEX(gPlttBufferUnfaded[palOffset])];
                    palOffset++;
                }
            }
        ...
        // No palette blending.
        CpuFastCopy(gPlttBufferUnfaded + startPalIndex * 16, gPlttBufferFaded + startPalIndex * 16,
