...
const struct SpritePalette gSpritePalette_SmallSparkle = { gFieldEffectPal_SmallSparkle,
...
static const struct SpritePalette sSpritePalette_Unused = { gObjectEventPalette2,
    FLDEFF_PAL_TAG_UNKNOWN };
