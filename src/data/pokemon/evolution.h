const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] = {
    ...
    [SPECIES_SLOWPOKE] = { { EVO_LEVEL, 37, SPECIES_SLOWBRO }, { EVO_TRADE_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING } },
    ...
    [SPECIES_WURMPLE] = { { EVO_LEVEL_SILCOON, 7, SPECIES_SILCOON }, { EVO_LEVEL_CASCOON, 7, SPECIES_CASCOON } },
    ...
    [SPECIES_NINCADA] = { { EVO_LEVEL_NINJASK, 20, SPECIES_NINJASK }, { EVO_LEVEL_SHEDINJA, 20, SPECIES_SHEDINJA } },
