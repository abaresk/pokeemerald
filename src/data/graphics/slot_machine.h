...
const u16 gSlotMachineReelTimePikachu_Pal[] =
    INCBIN_U16("graphics/slot_machine/reel_time_pikachu.gbapal");
const u16 gSlotMachineReelTimeMisc_Pal[] = INCBIN_U16("graphics/slot_machine/shadow.gbapal");
const u16 gSlotMachineReelTimeMachine_Pal[] =
    INCBIN_U16("graphics/slot_machine/reel_time_machine.gbapal");
const u16 gSlotMachineMisc_Pal[] = INCBIN_U16("graphics/slot_machine/smoke.gbapal");
const u16 gSlotMachineReelTimeExplosion_Pal[] =
    INCBIN_U16("graphics/slot_machine/reel_time_explosion/0.gbapal");
const u16 gSlotMachineDigitalDisplay_Pal[] =
    INCBIN_U16("graphics/slot_machine/digital_display.gbapal");
...
const u32 gSlotMachineDigitalDisplay_Gfx[] =
    INCBIN_U32("graphics/slot_machine/digital_display.4bpp.lz");
...
const u8 gSlotMachineReelTimeNumber0[] =
    INCBIN_U8("graphics/slot_machine/reel_time_numbers/0.4bpp");
const u8 gSlotMachineReelTimeNumber1[] =
    INCBIN_U8("graphics/slot_machine/reel_time_numbers/1.4bpp");
const u8 gSlotMachineReelTimeNumber2[] =
    INCBIN_U8("graphics/slot_machine/reel_time_numbers/2.4bpp");
const u8 gSlotMachineReelTimeNumber3[] =
    INCBIN_U8("graphics/slot_machine/reel_time_numbers/3.4bpp");
const u8 gSlotMachineReelTimeNumber4[] =
    INCBIN_U8("graphics/slot_machine/reel_time_numbers/4.4bpp");
const u8 gSlotMachineReelTimeNumber5[] =
    INCBIN_U8("graphics/slot_machine/reel_time_numbers/5.4bpp");
...
const u8 gSlotMachineReelTimeExplosion0[] =
    INCBIN_U8("graphics/slot_machine/reel_time_explosion/0.4bpp");
const u8 gSlotMachineReelTimeExplosion1[] =
    INCBIN_U8("graphics/slot_machine/reel_time_explosion/1.4bpp");
...
const u8 gSlotMachineReelBackground_Tilemap[] =
    INCBIN_U8("graphics/slot_machine/reel_background.bin");
const u8 gSlotMachineReelTimeNumberGap_Gfx[] =
    INCBIN_U8("graphics/slot_machine/reel_time_number_gap.4bpp");
