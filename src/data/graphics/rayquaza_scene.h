...
const u32 gRaySceneClouds_Pal[] =
    INCBIN_U32("graphics/rayquaza_scene/clouds.gbapal.lz"); // pal 1 clouds, pal 2 rain
...
const u32 gRaySceneRayquazaTail_Gfx[] = INCBIN_U32(
    "graphics/rayquaza_scene/rayquaza_tail_fix.4bpp.lz"); // for some reason there are an extra 0xC
                                                          // bytes at the end of the original 4bpp,
                                                          // so in order to produce the correct lz,
                                                          // we have to cat the bytes at the end
                                                          // with a make rule. not sure why those
                                                          // bytes are there, it may have been a bug
                                                          // in Game Freak's software.

const u32 gRaySceneOvercast2_Gfx[] = INCBIN_U32("graphics/rayquaza_scene/overcast2.4bpp.lz");

const u32 gRaySceneRayquazaLight_Gfx[] = INCBIN_U32(
    "graphics/rayquaza_scene/rayquaza_light.4bpp.lz"); // uses pal 2 of gRaySceneOvercast2_Pal
...
const u32 gRaySceneRayquazaLight_Tilemap[] =
    INCBIN_U32("graphics/rayquaza_scene/rayquaza_light.bin.lz");
...
const u32 gRaySceneChaseStreaks_Tilemap[] =
    INCBIN_U32("graphics/rayquaza_scene/chase_streaks.bin.lz");

const u32 gRaySceneRayquazaChase_Gfx[] =
    INCBIN_U32("graphics/rayquaza_scene/rayquaza_chase.4bpp.lz");
const u32 gRayChaseRayquazaChase_Tilemap[] =
    INCBIN_U32("graphics/rayquaza_scene/rayquaza_chase.bin.lz");
const u32 gRayChaseRayquazaChase2_Tilemap[] =
    INCBIN_U32("graphics/rayquaza_scene/rayquaza_chase2.bin.lz");
...
const u32 gRaySceneRayquazaHover_Gfx[] =
    INCBIN_U32("graphics/rayquaza_scene/rayquaza_hover.4bpp.lz");
const u32 gRaySceneRayquazaFlyIn_Gfx[] =
    INCBIN_U32("graphics/rayquaza_scene/rayquaza_flyin.4bpp.lz");
...
const u32 gRaySceneRayquazaHover_Pal[] =
    INCBIN_U32("graphics/rayquaza_scene/rayquaza_hover.gbapal.lz");
