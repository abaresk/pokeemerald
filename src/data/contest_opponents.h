...
#define CONTEST_AI_SET_D                                                                           \
    (CONTEST_AI_COMMON | CONTEST_AI_DUMMY_8 | CONTEST_AI_DUMMY_22 | CONTEST_AI_DUMMY_25)
...
#define CONTEST_AI_SET_17                                                                          \
    (CONTEST_AI_COMMON | CONTEST_AI_DUMMY_12 | CONTEST_AI_DUMMY_23 | CONTEST_AI_DUMMY_25)
...
const struct ContestWinner gDefaultContestWinners[] = { { .personality = 0,
                                                            .trainerId = 0xFFFF,
...
const struct ContestPokemon gContestOpponents[] = {
    [CONTEST_OPPONENT_JIMMY] = { .species = SPECIES_POOCHYENA,
        .nickname = _("POOCHY"),
        .trainerName = _("JIMMY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_EDITH] = { .species = SPECIES_ILLUMISE,
        .nickname = _("MUSILLE"),
        .trainerName = _("EDITH"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_REST, MOVE_FACADE, MOVE_TACKLE, MOVE_COVET },
        .cool = 10,
        .beauty = 10,
        .cute = 6,
        .smart = 1,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_EVAN] = { .species = SPECIES_DUSTOX,
        .nickname = _("DUSTER"),
        .trainerName = _("EVAN"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KELSEY] = { .species = SPECIES_SEEDOT,
        .nickname = _("DOTS"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MADISON] = { .species = SPECIES_TAILLOW,
        .nickname = _("TATAY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_RAYMOND] = { .species = SPECIES_NINCADA,
        .nickname = _("NINDA"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_GRANT] = { .species = SPECIES_SHROOMISH,
        .nickname = _("SMISH"),
        .trainerName = _("GRANT"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_PAIGE] = { .species = SPECIES_SPHEAL,
        .nickname = _("SLEAL"),
        .trainerName = _("PAIGE"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_AURORA_BEAM, MOVE_WATER_GUN, MOVE_GROWL, MOVE_ROCK_TOMB },
        .cool = 3,
        .beauty = 5,
        .cute = 1,
        .smart = 10,
    ...
    [CONTEST_OPPONENT_ALEC] = { .species = SPECIES_SLAKOTH,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_SYDNEY] = { .species = SPECIES_WHISMUR,
        .nickname = _("WHIRIS"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MORRIS] = { .species = SPECIES_MAKUHITA,
        .nickname = _("MAHITA"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MARIAH] = { .species = SPECIES_ARON,
        .nickname = _("RONAR"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_RUSSELL] = { .species = SPECIES_CROBAT,
        .nickname = _("BATRO"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MELANIE] = { .species = SPECIES_GULPIN,
        .nickname = _("GULIN"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CHANCE] = { .species = SPECIES_MANECTRIC,
        .nickname = _("RIKELEC"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_AGATHA] = { .species = SPECIES_BULBASAUR,
        .nickname = _("BULBY"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_GROWL, MOVE_LEECH_SEED, MOVE_TACKLE, MOVE_SWEET_SCENT },
        .cool = 5,
        .beauty = 3,
        .cute = 10,
        .smart = 10,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_BEAU] = { .species = SPECIES_BUTTERFREE,
        .nickname = _("FUTTERBE"),
        .trainerName = _("BEAU"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_SUPERSONIC, MOVE_WHIRLWIND, MOVE_SILVER_WIND, MOVE_SAFEGUARD },
        .cool = 3,
        .beauty = 10,
        .cute = 2,
        .smart = 10,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KAY] = { .species = SPECIES_PIDGEOTTO,
        .nickname = _("PIDEOT"),
        .trainerName = _("KAY"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_MIRROR_MOVE, MOVE_QUICK_ATTACK, MOVE_AERIAL_ACE, MOVE_FEATHER_DANCE },
        .cool = 10,
        .beauty = 8,
        .cute = 4,
        .smart = 2,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CALE] = { .species = SPECIES_DIGLETT,
        .nickname = _("DIGLE"),
        .trainerName = _("CALE"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_DIG, MOVE_EARTHQUAKE, MOVE_FISSURE, MOVE_MAGNITUDE },
        .cool = 4,
        .beauty = 2,
        .cute = 3,
        .smart = 5,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CAITLIN] = { .species = SPECIES_POLIWAG,
        .nickname = _("WAGIL"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_HYDRO_PUMP, MOVE_RAIN_DANCE, MOVE_BODY_SLAM, MOVE_ICE_BEAM },
        .cool = 2,
        .beauty = 10,
        .cute = 5,
        .smart = 3,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_COLBY] = { .species = SPECIES_TOTODILE,
        .nickname = _("TOTDIL"),
        .trainerName = _("COLBY"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_RAGE, MOVE_SCREECH, MOVE_SURF, MOVE_BLIZZARD },
        .cool = 6,
        .beauty = 10,
        .cute = 2,
        .smart = 1,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KYLIE] = { .species = SPECIES_LEDYBA,
        .nickname = _("BALEDY"),
        .trainerName = _("KYLIE"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_BATON_PASS, MOVE_AGILITY, MOVE_SWIFT, MOVE_ATTRACT },
        .cool = 8,
        .beauty = 6,
        .cute = 8,
        .smart = 6,
    ...
    [CONTEST_OPPONENT_LIAM] = { .species = SPECIES_DELIBIRD,
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_PRESENT, MOVE_FACADE, MOVE_FOCUS_PUNCH, MOVE_RETURN },
        .cool = 4,
        .beauty = 3,
        .cute = 10,
        .smart = 5,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MILO] = { .species = SPECIES_LARVITAR,
        .nickname = _("TARVITAR"),
        .trainerName = _("MILO"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_THRASH, MOVE_TORMENT, MOVE_CRUNCH, MOVE_DIG },
        .cool = 8,
        .beauty = 5,
        .cute = 5,
        .smart = 8,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KARINA] = { .species = SPECIES_ROSELIA,
        .nickname = _("RELIA"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_BOBBY] = { .species = SPECIES_DODRIO,
        .nickname = _("DUODO"),
        .trainerName = _("BOBBY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CLAIRE] = { .species = SPECIES_TRAPINCH,
        .nickname = _("PINCHIN"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_WILLIE] = { .species = SPECIES_CACNEA,
        .nickname = _("NACAC"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CASSIDY] = { .species = SPECIES_SANDSLASH,
        .nickname = _("SHRAND"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MORGAN] = { .species = SPECIES_BALTOY,
        .nickname = _("TOYBAL"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_SUMMER] = { .species = SPECIES_MEDICHAM,
        .nickname = _("CHAMCHAM"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_REVERSAL, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH },
        .cool = 40,
        .beauty = 20,
        .cute = 40,
        .smart = 40,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MILES] = { .species = SPECIES_SPINDA,
        .nickname = _("SPININ"),
        .trainerName = _("MILES"),
        .trainerGfxId = OBJ_EVENT_GFX_CAMPER,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_AUDREY] = { .species = SPECIES_SWABLU,
        .nickname = _("SWABY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_AVERY] = { .species = SPECIES_SPOINK,
        .nickname = _("POINKER"),
        .trainerName = _("AVERY"),
        .trainerGfxId = OBJ_EVENT_GFX_SCHOOL_KID_M,
        .aiFlags = CONTEST_AI_SET_A,
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_SPLASH, MOVE_CONFUSE_RAY, MOVE_SNORE, MOVE_REST },
        .cool = 40,
        .beauty = 10,
        .cute = 30,
        .smart = 40,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ARIANA] = { .species = SPECIES_KECLEON,
        .nickname = _("KECON"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ASHTON] = { .species = SPECIES_GOLDEEN,
        .nickname = _("GOLDEN"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_SANDRA] = { .species = SPECIES_BARBOACH,
        .nickname = _("BOBOACH"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CARSON] = { .species = SPECIES_SKARMORY,
        .nickname = _("CORPY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KATRINA] = { .species = SPECIES_LOTAD,
        .nickname = _("TADO"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_LUKE] = { .species = SPECIES_SLOWBRO,
        .nickname = _("BROWLO"),
        .trainerName = _("LUKE"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_YAWN, MOVE_DISABLE, MOVE_GROWL, MOVE_CONFUSION },
        .cool = 20,
        .beauty = 40,
        .cute = 40,
        .smart = 30,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_RAUL] = { .species = SPECIES_FARFETCHD,
        .nickname = _("FETCHIN"),
        .trainerName = _("RAUL"),
        .trainerGfxId = OBJ_EVENT_GFX_MAN_5,
        .aiFlags = CONTEST_AI_SET_2,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_FACADE, MOVE_FURY_CUTTER, MOVE_FLY, MOVE_RETURN },
        .cool = 40,
        .beauty = 10,
        .cute = 40,
        .smart = 20,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_JADA] = { .species = SPECIES_SEEL,
        .nickname = _("SEELEY"),
        .trainerName = _("JADA"),
        .trainerGfxId = OBJ_EVENT_GFX_WOMAN_2,
        .aiFlags = CONTEST_AI_SET_3,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_ATTRACT, MOVE_ICE_BEAM, MOVE_SAFEGUARD, MOVE_GROWL },
        .cool = 10,
        .beauty = 30,
        .cute = 40,
        .smart = 20,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ZEEK] = { .species = SPECIES_DROWZEE,
        .nickname = _("DROWZIN"),
        .trainerName = _("ZEEK"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_DISABLE, MOVE_FUTURE_SIGHT, MOVE_HIDDEN_POWER, MOVE_RETURN },
        .cool = 10,
        .beauty = 40,
        .cute = 50,
        .smart = 30,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_DIEGO] = { .species = SPECIES_HITMONCHAN,
        .nickname = _("HITEMON"),
        .trainerName = _("DIEGO"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_SKY_UPPERCUT, MOVE_DETECT, MOVE_REVENGE, MOVE_MEGA_PUNCH },
        .cool = 45,
        .beauty = 20,
        .cute = 10,
        .smart = 20,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ALIYAH] = { .species = SPECIES_BLISSEY,
        .nickname = _("BLISS"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_SING, MOVE_SOFT_BOILED, MOVE_EGG_BOMB, MOVE_DOUBLE_EDGE },
        .cool = 20,
        .beauty = 35,
        .cute = 40,
        .smart = 20,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_NATALIA] = { .species = SPECIES_ELEKID,
        .nickname = _("KIDLEK"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_SCREECH, MOVE_ATTRACT },
        .cool = 40,
        .beauty = 10,
        .cute = 40,
        .smart = 25,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_DEVIN] = { .species = SPECIES_SNUBBULL,
        .nickname = _("SNUBBINS"),
        .trainerName = _("DEVIN"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_SCARY_FACE, MOVE_TAUNT, MOVE_TAIL_WHIP, MOVE_BITE },
        .cool = 20,
        .beauty = 20,
        .cute = 20,
        .smart = 20,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_TYLOR] = { .species = SPECIES_MISDREAVUS,
        .nickname = _("DREAVIS"),
        .trainerName = _("TYLOR"),
        .trainerGfxId = OBJ_EVENT_GFX_HEX_MANIAC,
        .aiFlags = CONTEST_AI_SET_9,
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_PERISH_SONG, MOVE_MEAN_LOOK, MOVE_CONFUSE_RAY, MOVE_PAIN_SPLIT },
        .cool = 10,
        .beauty = 35,
        .cute = 10,
        .smart = 45,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_RONNIE] = { .species = SPECIES_LAIRON,
        .nickname = _("LAIRN"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CLAUDIA] = { .species = SPECIES_SHIFTRY,
        .nickname = _("SHIFTY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ELIAS] = { .species = SPECIES_NINJASK,
        .nickname = _("NINAS"),
        .trainerName = _("ELIAS"),
        .trainerGfxId = OBJ_EVENT_GFX_LITTLE_BOY,
        .aiFlags = CONTEST_AI_SET_11,
    ...
    [CONTEST_OPPONENT_JADE] = { .species = SPECIES_SWELLOW,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_FRANCIS] = { .species = SPECIES_MIGHTYENA,
        .nickname = _("YENA"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ALISHA] = { .species = SPECIES_BEAUTIFLY,
        .nickname = _("TIFLY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_SAUL] = { .species = SPECIES_SEAKING,
        .nickname = _("KINGSEA"),
        .trainerName = _("SAUL"),
        .trainerGfxId = OBJ_EVENT_GFX_CAMPER,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_FELICIA] = { .species = SPECIES_CASTFORM,
        .nickname = _("CASTER"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_SANDSTORM, MOVE_RETURN },
        .cool = 70,
        .beauty = 80,
        .cute = 80,
        .smart = 50,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_EMILIO] = { .species = SPECIES_MACHOKE,
        .nickname = _("CHOKEM"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KARLA] = { .species = SPECIES_LOMBRE,
        .nickname = _("LOMBE"),
        .trainerName = _("KARLA"),
        .trainerGfxId = OBJ_EVENT_GFX_GIRL_2,
        .aiFlags = CONTEST_AI_SET_A,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_DARRYL] = { .species = SPECIES_SEVIPER,
        .nickname = _("VIPES"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_SELENA] = { .species = SPECIES_WAILMER,
        .nickname = _("MERAIL"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_NOEL] = { .species = SPECIES_MAGIKARP,
        .nickname = _("KARPAG"),
        .trainerName = _("NOEL"),
        .trainerGfxId = OBJ_EVENT_GFX_YOUNGSTER,
        .aiFlags = CONTEST_AI_SET_1A,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_LACEY] = { .species = SPECIES_LUNATONE,
        .nickname = _("LUNONE"),
        .trainerName = _("LACEY"),
        .trainerGfxId = OBJ_EVENT_GFX_WOMAN_1,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CORBIN] = { .species = SPECIES_ABSOL,
        .nickname = _("ABSO"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_PERISH_SONG, MOVE_HAIL, MOVE_HYPER_BEAM, MOVE_SLASH },
        .cool = 95,
        .beauty = 80,
        .cute = 85,
        .smart = 35,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_GRACIE] = { .species = SPECIES_EXEGGUTOR,
        .nickname = _("EGGSOR"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_STOMP, MOVE_HYPNOSIS, MOVE_EGG_BOMB, MOVE_SKILL_SWAP },
        .cool = 40,
        .beauty = 50,
        .cute = 60,
        .smart = 100,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_COLTIN] = { .species = SPECIES_CUBONE,
        .nickname = _("CUBIN"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_BONE_CLUB, MOVE_BONEMERANG, MOVE_BONE_RUSH, MOVE_GROWL },
        .cool = 40,
        .beauty = 35,
        .cute = 85,
        .smart = 35,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ELLIE] = { .species = SPECIES_HITMONLEE,
        .nickname = _("HITMON"),
        .trainerName = _("ELLIE"),
        .trainerGfxId = OBJ_EVENT_GFX_EXPERT_F,
        .aiFlags = CONTEST_AI_SET_3,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_REVERSAL, MOVE_REVENGE, MOVE_FOCUS_ENERGY, MOVE_MEGA_KICK },
        .cool = 85,
        .beauty = 30,
        .cute = 25,
        .smart = 50,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MARCUS] = { .species = SPECIES_SQUIRTLE,
        .nickname = _("SURTLE"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_TAIL_WHIP, MOVE_BUBBLE, MOVE_FOCUS_PUNCH, MOVE_WITHDRAW },
        .cool = 30,
        .beauty = 35,
        .cute = 100,
        .smart = 40,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KIARA] = { .species = SPECIES_KANGASKHAN,
        .nickname = _("KHANKAN"),
        .trainerName = _("KIARA"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_MEGA_PUNCH, MOVE_RAGE, MOVE_FOCUS_PUNCH, MOVE_TAIL_WHIP },
        .cool = 100,
        .beauty = 50,
        .cute = 30,
        .smart = 50,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_BRYCE] = { .species = SPECIES_PINECO,
        .nickname = _("PINOC"),
        .trainerName = _("BRYCE"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_EXPLOSION, MOVE_SPIKES, MOVE_LIGHT_SCREEN, MOVE_GIGA_DRAIN },
        .cool = 80,
        .beauty = 80,
        .cute = 80,
        .smart = 80,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_JAMIE] = { .species = SPECIES_DUNSPARCE,
        .nickname = _("DILTOT"),
        .trainerName = _("JAMIE"),
        .trainerGfxId = OBJ_EVENT_GFX_WOMAN_5,
        .aiFlags = CONTEST_AI_SET_7,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_SPITE, MOVE_YAWN, MOVE_DEFENSE_CURL, MOVE_TAKE_DOWN },
        .cool = 40,
        .beauty = 35,
        .cute = 100,
        .smart = 40,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_JORGE] = { .species = SPECIES_HOUNDOOM,
        .nickname = _("DOOMOND"),
        .trainerName = _("JORGE"),
        .trainerGfxId = OBJ_EVENT_GFX_GENTLEMAN,
        .aiFlags = CONTEST_AI_SET_8,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_ROAR, MOVE_FLAMETHROWER, MOVE_FAINT_ATTACK, MOVE_SUNNY_DAY },
        .cool = 100,
        .beauty = 100,
        .cute = 30,
        .smart = 25,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_DEVON] = { .species = SPECIES_MILTANK,
        .nickname = _("MILKAN"),
        .trainerName = _("DEVON"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_MILK_DRINK, MOVE_HEAL_BELL, MOVE_DEFENSE_CURL, MOVE_BLIZZARD },
        .cool = 50,
        .beauty = 110,
        .cute = 100,
        .smart = 35,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_JUSTINA] = { .species = SPECIES_GYARADOS,
        .nickname = _("RADOS"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_RALPH] = { .species = SPECIES_LOUDRED,
        .nickname = _("LOUDERD"),
        .trainerName = _("RALPH"),
        .trainerGfxId = OBJ_EVENT_GFX_EXPERT_M,
        .aiFlags = CONTEST_AI_SET_2,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_ROSA] = { .species = SPECIES_SKITTY,
        .nickname = _("SITTY"),
        .trainerName = _("ROSA"),
        .trainerGfxId = OBJ_EVENT_GFX_GIRL_1,
        .aiFlags = CONTEST_AI_SET_11,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KEATON] = { .species = SPECIES_SLAKING,
        .nickname = _("SLING"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MAYRA] = { .species = SPECIES_ALTARIA,
        .nickname = _("TARIA"),
        .trainerName = _("MAYRA"),
        .trainerGfxId = OBJ_EVENT_GFX_POKEFAN_F,
        .aiFlags = CONTEST_AI_SET_5,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_LAMAR] = { .species = SPECIES_KIRLIA,
        .nickname = _("LIRKI"),
        .trainerName = _("LAMAR"),
        .trainerGfxId = OBJ_EVENT_GFX_RICH_BOY,
        .aiFlags = CONTEST_AI_SET_1E,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_AUBREY] = { .species = SPECIES_BELLOSSOM,
        .nickname = _("BLOSSOM"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_NIGEL] = { .species = SPECIES_SABLEYE,
        .nickname = _("EYESAB"),
        .trainerName = _("NIGEL"),
        .trainerGfxId = OBJ_EVENT_GFX_CAMPER,
        .aiFlags = CONTEST_AI_SET_16,
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_MEAN_LOOK, MOVE_FAINT_ATTACK, MOVE_KNOCK_OFF, MOVE_CONFUSE_RAY },
        .cool = 25,
        .beauty = 35,
        .cute = 230,
        .smart = 150,
    ...
    [CONTEST_OPPONENT_CAMILLE] = { .species = SPECIES_NATU,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_DEON] = { .species = SPECIES_SHARPEDO,
        .nickname = _("PEDOS"),
        .trainerName = _("DEON"),
        .trainerGfxId = OBJ_EVENT_GFX_SCHOOL_KID_M,
        .aiFlags = CONTEST_AI_SET_A,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_JANELLE] = { .species = SPECIES_LUVDISC,
        .nickname = _("LUVIS"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_HEATH] = { .species = SPECIES_HERACROSS,
        .nickname = _("HEROSS"),
        .trainerName = _("HEATH"),
        .trainerGfxId = OBJ_EVENT_GFX_MAN_3,
        .aiFlags = CONTEST_AI_SET_19,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_SASHA] = { .species = SPECIES_ELECTRODE,
        .nickname = _("RODLECT"),
        .trainerName = _("SASHA"),
        .trainerGfxId = OBJ_EVENT_GFX_TWIN,
        .aiFlags = CONTEST_AI_SET_1A,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_FRANKIE] = { .species = SPECIES_PICHU,
        .nickname = _("CHUPY"),
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_HELEN] = { .species = SPECIES_WOBBUFFET,
        .nickname = _("WOBET"),
        .trainerName = _("HELEN"),
        .trainerGfxId = OBJ_EVENT_GFX_WOMAN_1,
        .aiFlags = CONTEST_AI_SET_F,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CAMILE] = { .species = SPECIES_GENGAR,
        .nickname = _("GAREN"),
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_DESTINY_BOND, MOVE_CONFUSE_RAY, MOVE_LICK, MOVE_SLUDGE_BOMB },
        .cool = 200,
        .beauty = 100,
        .cute = 50,
        .smart = 80,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_MARTIN] = { .species = SPECIES_PORYGON,
        .nickname = _("GONPOR"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_CONVERSION_2, MOVE_CONVERSION, MOVE_RETURN, MOVE_RECYCLE },
        .cool = 130,
        .beauty = 130,
        .cute = 130,
        .smart = 130,
    ...
    [CONTEST_OPPONENT_SERGIO] = { .species = SPECIES_DRAGONITE,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_OUTRAGE, MOVE_SLAM, MOVE_TWISTER, MOVE_EARTHQUAKE },
        .cool = 150,
        .beauty = 140,
        .cute = 50,
        .smart = 120,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_KAILEY] = { .species = SPECIES_MEOWTH,
        .nickname = _("MEOWY"),
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_GROWL, MOVE_TAUNT, MOVE_PAY_DAY, MOVE_BITE },
        .cool = 125,
        .beauty = 110,
        .cute = 180,
        .smart = 170,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_PERLA] = { .species = SPECIES_JYNX,
        .nickname = _("NYX"),
        .trainerName = _("PERLA"),
        .trainerGfxId = OBJ_EVENT_GFX_BEAUTY,
        .aiFlags = CONTEST_AI_SET_5,
        ...
        .aiPool_Smart = TRUE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_PERISH_SONG, MOVE_MEAN_LOOK, MOVE_LOVELY_KISS, MOVE_FAKE_TEARS },
        .cool = 100,
        .beauty = 150,
        .cute = 100,
        .smart = 150,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_CLARA] = { .species = SPECIES_TOGEPI,
        .nickname = _("GEPITO"),
        .trainerName = _("CLARA"),
        .trainerGfxId = OBJ_EVENT_GFX_WOMAN_2,
        .aiFlags = CONTEST_AI_SET_6,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_GROWL, MOVE_YAWN, MOVE_ENCORE, MOVE_FOLLOW_ME },
        .cool = 80,
        .beauty = 120,
        .cute = 200,
        .smart = 120,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_JAKOB] = { .species = SPECIES_ESPEON,
        .nickname = _("SPEON"),
        .trainerName = _("JAKOB"),
        .trainerGfxId = OBJ_EVENT_GFX_PSYCHIC_M,
        .aiFlags = CONTEST_AI_SET_7,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = FALSE,
        .moves = { MOVE_SWIFT, MOVE_QUICK_ATTACK, MOVE_MORNING_SUN, MOVE_TAIL_WHIP },
        .cool = 180,
        .beauty = 150,
        .cute = 100,
        .smart = 80,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_TREY] = { .species = SPECIES_SLOWKING,
        .nickname = _("SLOWGO"),
        .trainerName = _("TREY"),
        .trainerGfxId = OBJ_EVENT_GFX_SAILOR,
        .aiFlags = CONTEST_AI_SET_8,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_FACADE, MOVE_CURSE, MOVE_YAWN, MOVE_FOCUS_PUNCH },
        .cool = 100,
        .beauty = 80,
        .cute = 200,
        .smart = 110,
        ...
        .personality = 0,
        .otId = 0xFFFF },
    [CONTEST_OPPONENT_LANE] = { .species = SPECIES_URSARING,
        .nickname = _("URSING"),
        .trainerName = _("LANE"),
        .trainerGfxId = OBJ_EVENT_GFX_BLACK_BELT,
        .aiFlags = CONTEST_AI_SET_9,
        ...
        .aiPool_Smart = FALSE,
        .aiPool_Tough = TRUE,
        .moves = { MOVE_THRASH, MOVE_AERIAL_ACE, MOVE_FAKE_TEARS, MOVE_LEER },
        .cool = 180,
        .beauty = 140,
        .cute = 30,
        .smart = 80,
...
const u8 gPostgameContestOpponentFilter[] = { [CONTEST_OPPONENT_JIMMY] = CONTEST_FILTER_NONE,
