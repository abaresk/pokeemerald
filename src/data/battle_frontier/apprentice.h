...
// The possible questions to ask after the initial 3 WHICH MON questions. Retrieved from here and
// shuffled WHAT_ITEM has max 3 occurrences, one for each party member WHICH_MOVE has max 5
// occurrences, defined as NUM_WHICH_MOVE_QUESTIONS WHICH_FIRST has max 1 occurrence, lead mon
// should only be chosen once WHICH_SPEECH has max 1 occurrence, as the apprentice leaves after its
// asked
static const u8 sQuestionPossibilities[MAX_APPRENTICE_QUESTIONS] = { QUESTION_ID_WHAT_ITEM,
