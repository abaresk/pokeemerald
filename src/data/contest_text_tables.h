...
const u8 *const gContestEffectDescriptionPointers[] = { [CONTEST_EFFECT_HIGHLY_APPEALING] =
...
static const u8 *const sUnusedComboMoveNameTexts[] = { gText_RainDance,
    gText_RainDance,
    gText_Rage,
    gText_FocusEnergy,
    gText_Hypnosis,
...
const u8 *const gContestMoveTypeTextPointers[] = { [CONTEST_CATEGORY_COOL] =
...
static const u8 *const sInvalidContestMoveNames[] = { [CONTEST_CATEGORY_COOL] = gText_CoolMove,
