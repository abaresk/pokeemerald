...
static const u8* const sUnusedComboMoveNameTexts[] = { gText_RainDance,   gText_RainDance,   gText_Rage,
                                                       gText_FocusEnergy, gText_Hypnosis,    gText_Softboiled,
                                                       gText_HornAttack,  gText_SwordsDance, gText_Conversion,
                                                       gText_SunnyDay,    gText_Rest2,       gText_Vicegrip,
                                                       gText_DefenseCurl, gText_LockOn };

const u8* const gContestMoveTypeTextPointers[] = { [CONTEST_CATEGORY_COOL] = gContestMoveTypeCoolText,
...
static const u8* const sUnusedAppealResultTexts[] = { gText_ButAppealWasJammed,
...
static const u8* const sRoundResultTexts[] = { gText_MonFailedToStandOutAtAll,
...
static const u8* const sContestConditions[] = { [CONTEST_CATEGORY_COOL] = gText_Contest_Coolness,
...
static const u8* const sInvalidContestMoveNames[] = {
    [CONTEST_CATEGORY_COOL] = gText_CoolMove,   [CONTEST_CATEGORY_BEAUTY] = gText_BeautyMove,
    [CONTEST_CATEGORY_CUTE] = gText_CuteMove,   [CONTEST_CATEGORY_SMART] = gText_SmartMove,
    [CONTEST_CATEGORY_TOUGH] = gText_ToughMove, [CONTEST_CATEGORIES_COUNT] = gText_3QuestionMarks
};
