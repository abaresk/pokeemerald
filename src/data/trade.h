...
static const u8 sText_UnusedTextFormat[] =
    _("{COLOR WHITE}{HIGHLIGHT TRANSPARENT}{SHADOW DARK_GREY}");
...
static const struct OamData sTradeOamData_32x16 = {
    .shape = SPRITE_SHAPE(32x16), .size = SPRITE_SIZE(32x16), .priority = 1
};

static const struct OamData sTradeOamData_64x32 = {
    .shape = SPRITE_SHAPE(64x32), .size = SPRITE_SIZE(64x32), .priority = 1
};
...
static const union AnimCmd *const gSpriteAnimTable_832DC34[] = { gSpriteAnim_832DC24,
    gSpriteAnim_832DC2C };

static const struct SpriteSheet sTradeButtonsSpriteSheet = {
    .data = gTradeButtons_Gfx, .size = 0x800, .tag = 300
};
...
static const union AnimCmd *const gSpriteAnimTable_832DC7C[] = { gSpriteAnim_832DC4C,
    gSpriteAnim_832DC54,
    gSpriteAnim_832DC5C,
    gSpriteAnim_832DC64,
    gSpriteAnim_832DC6C,
...
static const struct SpritePalette gSpritePalette_TradeScreenText = { .data = TradeScreenTextPalette,
    .tag = 4925 };
...
static const u8 sUnref_0832DE6E[] = { 0x00,
    0x0e,
    0x0f,
    0x1d,
    0x03,
...
static const struct WindowTemplate sTradeYesNoWindowTemplate = { .bg = 0,
    .tilemapLeft = 23,
    .tilemapTop = 13,
    .width = 5,
    .height = 4,
...
static const u8 sTradeMenuPartyMonBoxDimensions[3][2] = {
    [TRADE_PLAYER] = { 4, 3 }, [TRADE_PARTNER] = { 19, 3 }
};
...
static const u8 sTradeGfx_PokeBallSymbol[] =
    INCBIN_U8("graphics/trade/pokeball_symbol.8bpp"); // unused?
static const u16 sTradeTilemap_Cable[] = INCBIN_U16("graphics/trade/cable_closeup_map.bin");
static const u16 sTradeTilemap_PokeBallSymbol[] =
    INCBIN_U16("graphics/trade/pokeball_symbol_map.bin"); // unused?
...
static const u8 sTradeAffineMap_GbaWireless[] =
    INCBIN_U8("graphics/trade/gba_affine_map_wireless.bin");
...
static const u32 gUnknown_083379A0[] =
    INCBIN_U32("graphics/trade/unknown_3379A0.bin.lz"); // some wireless tilemap
static const u16 sTradePal_WirelessSignalSend[] =
    INCBIN_U16("graphics/trade/wireless_signal_send.gbapal");
static const u16 sTradePal_WirelessSignalReceive[] =
    INCBIN_U16("graphics/trade/wireless_signal_receive.gbapal");
...
static const u32 sTradeTilemap_WirelessSignal[] =
    INCBIN_U32("graphics/trade/wireless_signal.bin.lz");

static const struct OamData sTradeOamData_16x16 = {
    .affineMode = ST_OAM_AFFINE_NORMAL, .shape = SPRITE_SHAPE(16x16), .size = SPRITE_SIZE(16x16)
};

static const union AnimCmd gSpriteAnim_8338C4C[] = { ANIMCMD_FRAME(0, 3),
    ANIMCMD_FRAME(4, 3),
    ANIMCMD_FRAME(8, 3),
    ANIMCMD_FRAME(12, 3),
    ANIMCMD_FRAME(16, 3),
...
static const union AnimCmd gSpriteAnim_8338C88[] = { ANIMCMD_FRAME(0, 3),
    ANIMCMD_FRAME(4, 3),
    ANIMCMD_FRAME(8, 3),
    ANIMCMD_FRAME(12, 3),
    ANIMCMD_FRAME(16, 3),
...
static const union AnimCmd *const gSpriteAnimTable_8338C88[] = { gSpriteAnim_8338C4C,
    gSpriteAnim_8338C88 };

static const union AffineAnimCmd gSpriteAffineAnim_8338CCC[] = { AFFINEANIMCMD_FRAME(0, 0, 0, 1),
    AFFINEANIMCMD_END };

static const union AffineAnimCmd gSpriteAffineAnim_8338CDC[] = { AFFINEANIMCMD_FRAME(-8, 0, 0, 20),
    AFFINEANIMCMD_END };

static const union AffineAnimCmd gSpriteAffineAnim_8338CEC[] = { AFFINEANIMCMD_FRAME(
                                                                     0x60, 0x100, 0, 0),
...
static const union AffineAnimCmd *const gSpriteAffineAnimTable_8338D0C[] = {
    gSpriteAffineAnim_8338CCC, gSpriteAffineAnim_8338CDC, gSpriteAffineAnim_8338CEC
};

static const struct SpriteSheet sPokeBallSpriteSheet = {
    .data = sTradeGfx_PokeBall, .size = 0x600, .tag = 5557
};

static const struct SpritePalette sPokeBallSpritePalette = { .data = sTradePal_PokeBall,
    .tag = 5558 };
...
static const union AffineAnimCmd gSpriteAffineAnim_8338D54[] = {
    AFFINEANIMCMD_FRAME(-10, -10, 0, 5), AFFINEANIMCMD_FRAME(10, 10, 0, 5), AFFINEANIMCMD_JUMP(0)
};
...
static const struct SpriteSheet sGlow1SpriteSheet = {
    .data = sTradeGfx_Glow1, .size = 0x200, .tag = 5550
};
...
static const union AnimCmd gSpriteAnim_8338DB0[] = {
    ANIMCMD_FRAME(8, 5, .vFlip = TRUE, .hFlip = TRUE), ANIMCMD_END
};

static const union AnimCmd *const gSpriteAnimTable_8338DB8[] = { gSpriteAnim_8338DA8,
    gSpriteAnim_8338DB0 };

static const struct SpriteSheet sGlow2SpriteSheet = {
    .data = sTradeGfx_Glow2, .size = 0x300, .tag = 5552
};
...
static const struct SpriteSheet sCableEndSpriteSheet = {
    .data = sTradeGfx_CableEnd, .size = 0x100, .tag = 5554
};
...
static const union AnimCmd gSpriteAnim_8338E1C[] = { ANIMCMD_FRAME(
                                                         0, 2, .vFlip = TRUE, .hFlip = TRUE),
...
static const union AnimCmd gSpriteAnim_8338E40[] = { ANIMCMD_FRAME(
                                                         0, 2, .vFlip = TRUE, .hFlip = TRUE),
    ANIMCMD_FRAME(32, 2, .vFlip = TRUE, .hFlip = TRUE),
    ANIMCMD_FRAME(64, 2, .vFlip = TRUE, .hFlip = TRUE),
    ANIMCMD_FRAME(96, 2, .vFlip = TRUE, .hFlip = TRUE),
...
static const struct SpriteSheet sGbaScreenSpriteSheet = {
    .data = sTradeGfx_GbaScreen, .size = 0x1000, .tag = 5556
};
...
static const u16 sIngameTradeMail[][MAIL_WORDS_COUNT + 1] = { { EC_WORD_BE,
                                                                  EC_WORD_NICE,
                                                                  EC_WORD_TO,
                                                                  EC_POKEMON(PLUSLE),
                                                                  EC_WORD_EXCL,
...
static const struct WindowTemplate sTradeSequenceWindowTemplates[] = { { .bg = 0,
                                                                           .tilemapLeft = 2,
                                                                           .tilemapTop = 15,
                                                                           .width = 26,
                                                                           .height = 4,
...
const struct WindowTemplate gTradeEvolutionSceneYesNoWindowTemplate = { .bg = 0,
    .tilemapLeft = 21,
    .tilemapTop = 9,
    .width = 5,
    .height = 4,
...
static const s8 sTradeBallVerticalVelocityTable[] = { 0,
    0,
    1,
    0,
    1,
...
static const u8 sWirelessSignalTiming[][2] = { { 0, 1 },
    { 1, 1 },
    { 2, 1 },
    { 3, 1 },
    { 4, 1 },
