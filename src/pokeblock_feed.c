...
static const u8 sNatureToMonPokeblockAnim[NUM_NATURES][2] = {
    [NATURE_HARDY] = { 0, 0 },    [NATURE_LONELY] = { 3, 0 },   [NATURE_BRAVE] = { 4, 1 },
    [NATURE_ADAMANT] = { 5, 0 },  [NATURE_NAUGHTY] = { 10, 0 }, [NATURE_BOLD] = { 13, 0 },
    [NATURE_DOCILE] = { 15, 0 },  [NATURE_RELAXED] = { 16, 2 }, [NATURE_IMPISH] = { 18, 0 },
    [NATURE_LAX] = { 19, 0 },     [NATURE_TIMID] = { 20, 0 },   [NATURE_HASTY] = { 25, 0 },
    [NATURE_SERIOUS] = { 27, 3 }, [NATURE_JOLLY] = { 28, 0 },   [NATURE_NAIVE] = { 29, 0 },
    [NATURE_MODEST] = { 33, 4 },  [NATURE_MILD] = { 36, 0 },    [NATURE_QUIET] = { 37, 0 },
    [NATURE_BASHFUL] = { 39, 0 }, [NATURE_RASH] = { 42, 0 },    [NATURE_CALM] = { 45, 0 },
    [NATURE_GENTLE] = { 46, 5 },  [NATURE_SASSY] = { 47, 6 },   [NATURE_CAREFUL] = { 48, 0 },
    [NATURE_QUIRKY] = { 53, 0 },
};
...
static const union AffineAnimCmd sSpriteAffineAnim_8411E90[] = { AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0),
                                                                 AFFINEANIMCMD_END };

static const union AffineAnimCmd sSpriteAffineAnim_8411EA0[] = { AFFINEANIMCMD_FRAME(0, 0, 12, 1),
                                                                 AFFINEANIMCMD_FRAME(0, 0, 0, 30),
                                                                 AFFINEANIMCMD_FRAME(0, 0, -12, 1), AFFINEANIMCMD_END };

static const union AffineAnimCmd sSpriteAffineAnim_8411EC0[] = { AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0),
                                                                 AFFINEANIMCMD_FRAME(0, 0, 12, 1),
                                                                 AFFINEANIMCMD_FRAME(0, 0, 0, 28),
                                                                 AFFINEANIMCMD_FRAME(0, 0, -4, 3), AFFINEANIMCMD_END };

static const union AffineAnimCmd sSpriteAffineAnim_8411EE8[] = { AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 16),
...
static const union AffineAnimCmd sSpriteAffineAnim_8411F08[] = {
    AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0), AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 16),
    AFFINEANIMCMD_FRAME(0x0, 0x0, -1, 32), AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 16), AFFINEANIMCMD_END
};

static const union AffineAnimCmd sSpriteAffineAnim_8411F30[] = { AFFINEANIMCMD_FRAME(0x0, 0x0, -1, 8),
...
static const union AffineAnimCmd sSpriteAffineAnim_8411F50[] = {
    AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0), AFFINEANIMCMD_FRAME(0x0, 0x0, -1, 8),
    AFFINEANIMCMD_FRAME(0x0, 0x0, 0, 16), AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 8), AFFINEANIMCMD_END
};

static const union AffineAnimCmd sSpriteAffineAnim_8411F78[] = { AFFINEANIMCMD_FRAME(0x0, 0x0, -1, 8),
...
static const union AffineAnimCmd sSpriteAffineAnim_8411F98[] = {
    AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0), AFFINEANIMCMD_FRAME(0x0, 0x0, -1, 8),
    AFFINEANIMCMD_FRAME(0x0, 0x0, 0, 32), AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 8), AFFINEANIMCMD_END
};

static const union AffineAnimCmd sSpriteAffineAnim_8411FC0[] = { AFFINEANIMCMD_FRAME(0x0, 0x0, -1, 4),
...
static const union AffineAnimCmd sSpriteAffineAnim_8411FE0[] = {
    AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0), AFFINEANIMCMD_FRAME(0x0, 0x0, -1, 4),
    AFFINEANIMCMD_FRAME(0x0, 0x0, 0, 24), AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 4), AFFINEANIMCMD_END
};

static const union AffineAnimCmd sSpriteAffineAnim_8412008[] = { AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 24),
                                                                 AFFINEANIMCMD_FRAME(0x0, 0x0, 0, 16),
                                                                 AFFINEANIMCMD_FRAME(0x0, 0x0, -12, 2),
                                                                 AFFINEANIMCMD_END };

static const union AffineAnimCmd sSpriteAffineAnim_8412028[] = {
    AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0), AFFINEANIMCMD_FRAME(0x0, 0x0, 1, 24),
    AFFINEANIMCMD_FRAME(0x0, 0x0, 0, 16), AFFINEANIMCMD_FRAME(0x0, 0x0, -12, 2), AFFINEANIMCMD_END
};

static const union AffineAnimCmd* const sSpriteAffineAnimTable_85F04FC[] = {
    sSpriteAffineAnim_8411E90, sSpriteAffineAnim_8411EA0, sSpriteAffineAnim_8411EE8, sSpriteAffineAnim_8411F30,
    sSpriteAffineAnim_8411F78, sSpriteAffineAnim_8411FC0, sSpriteAffineAnim_8412008, sSpriteAffineAnim_8411E90,
    sSpriteAffineAnim_8411E90, sSpriteAffineAnim_8411E90, sSpriteAffineAnim_8411E90, sSpriteAffineAnim_8411EC0,
    sSpriteAffineAnim_8411F08, sSpriteAffineAnim_8411F50, sSpriteAffineAnim_8411F98, sSpriteAffineAnim_8411FE0,
    sSpriteAffineAnim_8412028, sSpriteAffineAnim_8411E90, sSpriteAffineAnim_8411E90, sSpriteAffineAnim_8411E90,
...
static const struct WindowTemplate sWindowTemplates[] = { { 0, 1, 0xF, 0x1C, 4, 0xF, 0xA }, DUMMY_WIN_TEMPLATE };

// - 1 excludes PBLOCK_CLR_NONE
static const u32* const sPokeblocksPals[] = { [PBLOCK_CLR_RED - 1] = gPokeblockRed_Pal,
...
static const union AffineAnimCmd sSpriteAffineAnim_84120DC[] = { AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0),
                                                                 AFFINEANIMCMD_END };

static const union AffineAnimCmd* const sSpriteAffineAnimTable_MonNoFlip[] = { sSpriteAffineAnim_84120DC };

static const union AffineAnimCmd sSpriteAffineAnim_84120F0[] = { AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0),
...
static const union AffineAnimCmd sSpriteAffineAnim_8412148[] = { AFFINEANIMCMD_FRAME(-0x100, 0x100, 0, 0),
                                                                 AFFINEANIMCMD_FRAME(0x0, 0x0, 8, 1),
                                                                 AFFINEANIMCMD_FRAME(0x0, 0x0, 8, 1),
                                                                 AFFINEANIMCMD_FRAME(0x0, 0x0, 8, 1),
                                                                 AFFINEANIMCMD_FRAME(0x0, 0x0, 8, 1),
...
static const union AffineAnimCmd* const sSpriteAffineAnimTable_85F0664[] = { sSpriteAffineAnim_84120DC };

static const union AffineAnimCmd* const sSpriteAffineAnimTable_85F0668[] = { sSpriteAffineAnim_84120F0 };

static const union AffineAnimCmd* const sSpriteAffineAnimTable_85F066C[] = { sSpriteAffineAnim_8412148 };
...
static const union AnimCmd sThrownPokeblockSpriteAnim[] = { ANIMCMD_FRAME(0, 0), ANIMCMD_END };

static const union AnimCmd* const sThrownPokeblockAnimTable[] = {
    sThrownPokeblockSpriteAnim,
};

static const union AffineAnimCmd sSpriteAffineAnim_84121C0[] = { AFFINEANIMCMD_FRAME(0x100, 0x100, 0, 0),
                                                                 AFFINEANIMCMD_FRAME(-8, -8, 0, 1),
                                                                 AFFINEANIMCMD_JUMP(1) };

static const union AffineAnimCmd* const sThrownPokeblockAffineAnimTable[] = { sSpriteAffineAnim_84121C0 };

static const struct CompressedSpriteSheet sPokeblock_SpriteSheet = { gPokeblock_Gfx, 0x20, GFX_TAG_POKEBLOCK };

static const struct SpriteTemplate sThrownPokeblockSpriteTemplate = { .tileTag = GFX_TAG_POKEBLOCK,
...
static u8 CreateMonSprite(struct Pokemon* mon) {
    ...
    if (!IsMonSpriteNotFlipped(species)) {
        ...
        CalcCenterToCornerVec(&gSprites[spriteId], gSprites[spriteId].oam.shape, gSprites[spriteId].oam.size,
        ...
        case 50:
            if (sNatureToMonPokeblockAnim[pokeblockFeed->nature][1] != 0) {
                if (!pokeblockFeed->noMonFlip) // double negation, so mon's sprite is flipped
                    StartSpriteAffineAnim(pokeblockFeed->monSpritePtr,
                                          sNatureToMonPokeblockAnim[pokeblockFeed->nature][1] + 10);
                else
                    StartSpriteAffineAnim(pokeblockFeed->monSpritePtr,
...
static void sub_817AB68(void) {
    ...
    while (1) {
        ...
        if (!var_24) {
            pokeblockFeed->field_850[r4] =
                Sin(pokeblockFeed->field_1060[0], pokeblockFeed->field_1060[2] + r5 / 0x100) + r8;
            pokeblockFeed->field_C50[r4] =
                Cos(pokeblockFeed->field_1060[0], pokeblockFeed->field_1060[3] + r5 / 0x100) + r7;
        } else {
            pokeblockFeed->field_850[r4] =
                Sin(pokeblockFeed->field_1060[0], pokeblockFeed->field_1060[2] - r5 / 0x100) + r8;
            pokeblockFeed->field_C50[r4] =
