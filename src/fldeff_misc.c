...
static const union AnimCmd sAnim_SecretPowerCave[] = {
    ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(1, 8), ANIMCMD_FRAME(2, 8),
    ANIMCMD_FRAME(3, 8), ANIMCMD_FRAME(4, 8), ANIMCMD_END,
};
...
static const union AnimCmd sAnim_VineRiseLeft[] = {
    ANIMCMD_FRAME(4, 8), ANIMCMD_FRAME(3, 8), ANIMCMD_FRAME(2, 8),
    ANIMCMD_FRAME(1, 8), ANIMCMD_FRAME(0, 8), ANIMCMD_END,
};

static const union AnimCmd sAnim_VineDropRight[] = {
    ANIMCMD_FRAME(0, 8, .hFlip = TRUE), ANIMCMD_FRAME(1, 8, .hFlip = TRUE), ANIMCMD_FRAME(2, 8, .hFlip = TRUE),
    ANIMCMD_FRAME(3, 8, .hFlip = TRUE), ANIMCMD_FRAME(4, 8, .hFlip = TRUE), ANIMCMD_END,
};

static const union AnimCmd sAnim_VineRiseRight[] = {
    ANIMCMD_FRAME(4, 8, .hFlip = TRUE), ANIMCMD_FRAME(3, 8, .hFlip = TRUE), ANIMCMD_FRAME(2, 8, .hFlip = TRUE),
    ANIMCMD_FRAME(1, 8, .hFlip = TRUE), ANIMCMD_FRAME(0, 8, .hFlip = TRUE), ANIMCMD_END,
};
...
static const struct SpriteFrameImage sPicTable_SecretPowerCave[] = {
    overworld_frame(sSecretPowerCave_Gfx, 2, 2, 0), overworld_frame(sSecretPowerCave_Gfx, 2, 2, 1),
    overworld_frame(sSecretPowerCave_Gfx, 2, 2, 2), overworld_frame(sSecretPowerCave_Gfx, 2, 2, 3),
    overworld_frame(sSecretPowerCave_Gfx, 2, 2, 4),
};

static const struct SpriteFrameImage sPicTable_SecretPowerTree[] = {
    overworld_frame(sSecretPowerTree_Gfx, 2, 2, 0), overworld_frame(sSecretPowerTree_Gfx, 2, 2, 1),
    overworld_frame(sSecretPowerTree_Gfx, 2, 2, 2), overworld_frame(sSecretPowerTree_Gfx, 2, 2, 3),
...
static const struct SpriteFrameImage sPicTable_SecretPowerShrub[] = {
    overworld_frame(sSecretPowerShrub_Gfx, 2, 2, 0), overworld_frame(sSecretPowerShrub_Gfx, 2, 2, 1),
    overworld_frame(sSecretPowerShrub_Gfx, 2, 2, 2), overworld_frame(sSecretPowerShrub_Gfx, 2, 2, 3),
...
bool8 FldEff_SecretPowerCave(void) {
    ...
    CreateSprite(&sSpriteTemplate_SecretPowerCave, gSprites[gPlayerAvatar.spriteId].oam.x + gFieldEffectArguments[5],
                 gSprites[gPlayerAvatar.spriteId].oam.y + gFieldEffectArguments[6], 148);
    return FALSE;
}
...
bool8 FldEff_SecretPowerTree(void) {
    ...
    CreateSprite(&sSpriteTemplate_SecretPowerTree, gSprites[gPlayerAvatar.spriteId].oam.x + gFieldEffectArguments[5],
                 gSprites[gPlayerAvatar.spriteId].oam.y + gFieldEffectArguments[6], 148);
...
bool8 FldEff_SecretPowerShrub(void) {
    ...
    CreateSprite(&sSpriteTemplate_SecretPowerShrub, gSprites[gPlayerAvatar.spriteId].oam.x + gFieldEffectArguments[5],
                 gSprites[gPlayerAvatar.spriteId].oam.y + gFieldEffectArguments[6], 148);
...
bool8 FldEff_SandPillar(void) {
    ...
    switch (GetPlayerFacingDirection()) {
        case DIR_SOUTH:
            CreateSprite(&sSpriteTemplate_SandPillar, gSprites[gPlayerAvatar.spriteId].oam.x + 8,
                         gSprites[gPlayerAvatar.spriteId].oam.y + 32, 0);

            break;

        case DIR_NORTH:
            CreateSprite(&sSpriteTemplate_SandPillar, gSprites[gPlayerAvatar.spriteId].oam.x + 8,
                         gSprites[gPlayerAvatar.spriteId].oam.y, 148);

            break;

        case DIR_WEST:
            CreateSprite(&sSpriteTemplate_SandPillar, gSprites[gPlayerAvatar.spriteId].oam.x - 8,
                         gSprites[gPlayerAvatar.spriteId].oam.y + 16, 148);

            break;

        case DIR_EAST:
            CreateSprite(&sSpriteTemplate_SandPillar, gSprites[gPlayerAvatar.spriteId].oam.x + 24,
                         gSprites[gPlayerAvatar.spriteId].oam.y + 16, 148);
...
static void SpriteCB_SandPillar_BreakTop(struct Sprite* sprite) {
    ...
    if (MapGridGetMetatileIdAt(gFieldEffectArguments[5], gFieldEffectArguments[6] - 1) ==
        ...
        MapGridSetMetatileIdAt(gFieldEffectArguments[5], gFieldEffectArguments[6] - 1,
...
static void SpriteCB_SandPillar_BreakBase(struct Sprite* sprite) {
    if (sprite->data[0] < 18) {
        ...
        MapGridSetMetatileIdAt(gFieldEffectArguments[5], gFieldEffectArguments[6],
