...
static const union AnimCmd sAnim_Pokeball_Moving[] = {
    ...
    ANIMCMD_FRAME(32, 8), ANIMCMD_FRAME(0, 8),  ANIMCMD_JUMP(0),
};
...
void CB2_ChooseStarter(void) {
    ...
    SetGpuReg(REG_OFFSET_BLDCNT, BLDCNT_TGT1_BG1 | BLDCNT_TGT1_BG2 | BLDCNT_TGT1_BG3 | BLDCNT_TGT1_OBJ |
...
static void Task_HandleStarterChooseInput(u8 taskId) {
    ...
    if (JOY_NEW(A_BUTTON)) {
        ...
        spriteId = CreateSprite(&sSpriteTemplate_StarterCircle, sPokeballCoords[selection][0],
                                sPokeballCoords[selection][1], 1);
