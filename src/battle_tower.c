        ...
        case SPECIAL_BATTLE_TOWER:
            ...
            switch (VarGet(VAR_FRONTIER_BATTLE_MODE))
            {
                ...
                case FRONTIER_MODE_LINK_MULTIS:
                    gBattleTypeFlags |= BATTLE_TYPE_DOUBLE | BATTLE_TYPE_LINK | BATTLE_TYPE_MULTI
                                        | BATTLE_TYPE_x800000;
                    FillFrontierTrainersParties(FRONTIER_MULTI_PARTY_SIZE);
                    break;
            }
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        for (j = 0; j < 2; j++)
        {
            while (1)
            {
                ...
                if (j % 2 != 0
                    && gFacilityTrainerMons[gSaveBlock2Ptr->frontier.trainerIds[r10 - 1]]
                               .itemTableId
    ...
    switch (gSpecialVar_Result)
    {
        case 0:
            if (battleMode == FRONTIER_MODE_LINK_MULTIS)
            {
                ...
                {
                    SendBlock(
                        bitmask_all_link_players_but_self(), &challengeNum, sizeof(challengeNum));
