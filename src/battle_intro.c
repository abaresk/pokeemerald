    ...
    switch (gTasks[taskId].data[0]) {
        ...
        case 3:
            ...
            if (!gTasks[taskId].data[2]) {
                ...
                SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) | BGCNT_16COLOR |
                                                 BGCNT_SCREENBASE(28) | BGCNT_TXT256x512);
                SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) | BGCNT_16COLOR |
                                                 BGCNT_SCREENBASE(30) | BGCNT_TXT512x256);
            }
            break;
        case 4:
            sub_811828C(taskId);
    ...
    switch (gTasks[taskId].data[0]) {
        ...
        case 1:
            if (--gTasks[taskId].data[2] == 0) {
                ...
                SetGpuReg(REG_OFFSET_WININ, WININ_WIN0_BG_ALL | WININ_WIN0_OBJ | WININ_WIN0_CLR);
                SetGpuReg(REG_OFFSET_WINOUT, WINOUT_WINOBJ_BG_ALL | WINOUT_WINOBJ_OBJ | WINOUT_WINOBJ_CLR |
                                                 WINOUT_WIN01_BG1 | WINOUT_WIN01_BG2);
            }
            break;
        case 2:
            gBattle_WIN0V -= 0xFF;
...
static void BattleIntroSlidePartner(u8 taskId) {
    switch (gTasks[taskId].data[0]) {
        ...
        case 1:
            if (--gTasks[taskId].data[2] == 0) {
                gTasks[taskId].data[0]++;
                SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(2) | BGCNT_CHARBASE(2) | BGCNT_16COLOR |
                                                 BGCNT_SCREENBASE(28) | BGCNT_TXT512x256);
                SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(2) | BGCNT_CHARBASE(2) | BGCNT_16COLOR |
                                                 BGCNT_SCREENBASE(30) | BGCNT_TXT512x256);
...
void sub_8118FBC(int bgId, u8 arg1, u8 arg2, u8 battlerPosition, u8 arg4, u8* arg5, u16* arg6, u16 tilesOffset) {
    ...
    CpuCopy16(gMonSpritesGfxPtr->sprites[battlerPosition] + BG_SCREEN_SIZE * gBattleMonForms[battler], arg5,
              BG_SCREEN_SIZE);
...
void unref_sub_8119094(u8 arg0, u8 arg1, u8 battlerPosition, u8 arg3, u8 arg4, u16 arg5, u8 arg6, u8 arg7) {
    ...
    DmaCopy16(3, gMonSpritesGfxPtr->sprites[battlerPosition] + BG_SCREEN_SIZE * arg3, (void*)BG_SCREEN_ADDR(0) + arg5,
              BG_SCREEN_SIZE);
