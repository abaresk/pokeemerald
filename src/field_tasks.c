...
static const u16 sSootopolisGymIceRowVars[] = { 0,          0,          0,          0,          0, 0,
                                                VAR_TEMP_1, VAR_TEMP_2, VAR_TEMP_3, VAR_TEMP_4, 0, 0,
                                                VAR_TEMP_5, VAR_TEMP_6, VAR_TEMP_7, 0,          0, VAR_TEMP_8,
                                                VAR_TEMP_9, VAR_TEMP_A, 0,          0,          0, 0,
                                                0,          0 };

static const u16 sMuddySlopeMetatiles[] = { METATILE_General_MuddySlope_Frame0, METATILE_General_MuddySlope_Frame3,
                                            METATILE_General_MuddySlope_Frame2, METATILE_General_MuddySlope_Frame1 };
...
GetPacifidlogBridgeMetatileOffsets(const struct PacifidlogMetatileOffsets* offsets, u16 metatileBehavior) {
...
static void SetPacifidlogBridgeMetatiles(const struct PacifidlogMetatileOffsets* offsets, s16 x, s16 y,
                                         bool32 redrawMap) {
...
static void SetCrackedFloorHoleMetatile(s16 x, s16 y) {
    MapGridSetMetatileIdAt(x, y,
                           MapGridGetMetatileIdAt(x, y) == 0x22f ? 0x206 : 0x237); // unsure what these are referring to
    CurrentMapDrawMetatileAt(x, y);
}
