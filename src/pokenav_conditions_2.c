...
const struct WindowTemplate gUnknown_08623364 = {
    .bg = 1, .tilemapLeft = 13, .tilemapTop = 1, .width = 13, .height = 4, .paletteNum = 15, .baseBlock = 2
};

const struct WindowTemplate gUnknown_0862336C = {
    .bg = 1, .tilemapLeft = 1, .tilemapTop = 6, .width = 7, .height = 2, .paletteNum = 15, .baseBlock = 0x36
};

const struct WindowTemplate gUnknown_08623374 = {
    .bg = 1, .tilemapLeft = 1, .tilemapTop = 0x1C, .width = 5, .height = 2, .paletteNum = 15, .baseBlock = 0x44
};

const struct WindowTemplate gUnknown_0862337C = {
    .bg = 1, .tilemapLeft = 13, .tilemapTop = 0x1C, .width = 3, .height = 2, .paletteNum = 15, .baseBlock = 0x44
};

const LoopedTask gUnknown_08623384[] = { NULL,        sub_81CE37C, sub_81CE2D0, sub_81CE4D8,
                                         sub_81CE5E4, sub_81CE6BC, sub_81CE700 };
...
extern s8
sub_81CDC84(void); // This function's declaration here is different than its definition in pokenav_unk_6. u8/s8
