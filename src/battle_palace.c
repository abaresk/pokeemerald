...
static const u16 sBattlePalaceEarlyPrizes[] = { ITEM_HP_UP,   ITEM_PROTEIN, ITEM_IRON,
                                                ITEM_CALCIUM, ITEM_CARBOS,  ITEM_ZINC };

static const u16 sBattlePalaceLatePrizes[] = { ITEM_BRIGHT_POWDER, ITEM_WHITE_HERB,  ITEM_QUICK_CLAW,
...
static void IncrementPalaceStreak(void) {
    ...
    if (gSaveBlock2Ptr->frontier.palaceWinStreaks[battleMode][lvlMode] < MAX_STREAK) {
        ...
        if (gSaveBlock2Ptr->frontier.palaceWinStreaks
                [battleMode][(lvlMode > gSaveBlock2Ptr->frontier.palaceRecordWinStreaks[battleMode][lvlMode]) ? 1 : 0])
...
static void SetRandomPalacePrize(void) {
    ...
    if (gSaveBlock2Ptr->frontier.palaceWinStreaks[battleMode][lvlMode] > 41)
        ...
        gSaveBlock2Ptr->frontier.palacePrize =
            sBattlePalaceEarlyPrizes[Random() % ARRAY_COUNT(sBattlePalaceEarlyPrizes)];
}
