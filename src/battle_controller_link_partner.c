...
static void (*const sLinkPartnerBufferCommands[CONTROLLER_CMDS_COUNT])(
    void) = { LinkPartnerHandleGetMonData,
...
static void LinkPartnerHandleDrawTrainerPic(void)
{
    ...
    {
        trainerPicId =
            gLinkPlayers[GetBattlerMultiplayerId(gActiveBattler)].gender + TRAINER_BACK_PIC_RED;
    }
