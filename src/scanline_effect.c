...
void ScanlineEffect_InitHBlankDmaTransfer(void) {
    if (gScanlineEffect.state == 0) {
        ...
        DmaSet(0, gScanlineEffect.dmaSrcBuffers[gScanlineEffect.srcBuffer], gScanlineEffect.dmaDest,
...
// 'delayInterval' controls how fast the wave travels up the screen. The wave will shift upwards one scanline every
// 'delayInterval'+1 frames. 'regOffset' is the offset of the video register to modify.
