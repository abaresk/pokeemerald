...
#define NOCASHGBAPRINTADDR2                                                                        \
    0x4FFFA14 // does not automatically add the newline. by default, NOCASHGBAPRINTADDR2 is used.
              // this is used to keep strings consistent between no$gba and VBA-RR, but a user can
              // choose to forgo this.
