...
// const rom data
static const union AnimCmd sSpriteAnim_853EDE4[] = { ANIMCMD_FRAME(0, 3),
    ANIMCMD_FRAME(4, 3),
    ANIMCMD_FRAME(8, 3),
    ANIMCMD_FRAME(12, 3),
    ANIMCMD_JUMP(0) };
...
static const union AnimCmd sSpriteAnim_853EE68[] = { ANIMCMD_FRAME(0, 3),
    ANIMCMD_FRAME(16, 3),
    ANIMCMD_FRAME(32, 3),
    ANIMCMD_FRAME(48, 3),
    ANIMCMD_FRAME(64, 3),
...
static const union AnimCmd *const sSpriteAnimTable_853EECC[] = {
    sSpriteAnim_853EEB4, sSpriteAnim_853EEBC, sSpriteAnim_853EEC4
};
...
u8 sub_80A9C70(u8 battlerId, bool8 b)
{
    ...
    LoadCompressedSpriteSheetUsingHeap(
        &gBattleAnimPicTable[GET_TRUE_SPRITE_INDEX(ANIM_TAG_CIRCLE_IMPACT)]);
    LoadCompressedSpritePaletteUsingHeap(
        &gBattleAnimPaletteTable[GET_TRUE_SPRITE_INDEX(ANIM_TAG_CIRCLE_IMPACT)]);
    ...
    if (b)
    {
        ...
        for (i = 0; i < 10; i++)
        {
            spriteId2 = CreateSprite(&gUnknown_0853EF60,
                gSprites[battlerSpriteId].pos1.x,
                gSprites[battlerSpriteId].pos1.y + 32,
                0);
...
static void sub_80A9DB4(u8 taskId)
{
    if (gTasks[taskId].data[2] == 2)
    {
        ...
        BlendPalette(0x100 + gTasks[taskId].data[0] * 16,
            16,
...
static void AnimTask_FrozenIceCube_Step2(u8 taskId)
{
    ...
    if (gTasks[taskId].data[1]++ > 13)
    {
        ...
        if (gTasks[taskId].data[2] == 3)
        {
            ...
            gPlttBufferFaded[0x100 + palIndex * 16 + 13] =
                gPlttBufferFaded[0x100 + palIndex * 16 + 14];
            gPlttBufferFaded[0x100 + palIndex * 16 + 14] =
                gPlttBufferFaded[0x100 + palIndex * 16 + 15];
