...
enum { WIN_BERRY_NAME, WIN_SIZE_FIRM, WIN_DESC, WIN_BERRY_TAG };
...
static const u8* const sBerryFirmnessStrings[] = { gBerryFirmnessString_VerySoft, gBerryFirmnessString_Soft,
                                                   gBerryFirmnessString_Hard, gBerryFirmnessString_VeryHard,
...
static void AddBerryTagTextToBg0(void) {
    ...
    PrintTextInBerryTagScreen(WIN_BERRY_TAG, gText_BerryTag, GetStringCenterAlignXOffset(1, gText_BerryTag, 0x40), 1, 0,
                              1);
