...
bool32 sub_81C91AC(struct PokenavSub17Substruct* a0, const struct BgTemplate* a1, struct PokenavListTemplate* a2,
                   s32 a3);
...
u32 LoopedTask_sub_81C83F0(s32 state) {
    ...
    switch (state) {
        case 0:
            ...
            AddTextPrinterParameterized(structPtr->unk0.windowId, structPtr->unk0.fontId, structPtr->unkTextBuffer, 8,
                                        (v1 << 4) + 1, 255, NULL);
...
void sub_81C8838(void) {
    struct PokenavSub17* structPtr = GetSubstructPtr(17);
    struct MatchCallWindowState* subPtr = &structPtr->unk888;
    structPtr->unk0.unk38(structPtr->unk0.unk0.windowId, subPtr->windowTopIndex + subPtr->selectedIndexOffset,
...
u32 LoopedTask_sub_81C8A28(s32 state) {
    ...
    switch (state) {
        ...
        case 3:
            ...
            return 2;
        case 4:
            sub_81C83AC(subPtr888->unk10, subPtr888->windowTopIndex + structPtr->unk89C, 1, subPtr888->unkC,
                        structPtr->unk89C, &structPtr->unk0);
            return LT_INC_AND_PAUSE;
        case 5:
            if (sub_81C83E0())
                return LT_PAUSE;
...
void sub_81C8CB4(struct MatchCallWindowState* a0, struct PokenavSub17Substruct* a1) {
    ...
    AddTextPrinterParameterized3(a1->unk0.windowId, a1->unk0.fontId, 8, (a1->unk0.unkA * 16) + 1, colors, TEXT_SPEED_FF,
                                 a1->unkTextBuffer);
...
void sub_81C8D4C(struct MatchCallWindowState* a0, struct PokenavSub17Substruct* a1) {
    ...
    AddTextPrinterParameterized(a1->unk0.windowId, a1->unk0.fontId, a1->unkTextBuffer, 8, a1->unk0.unkA * 16 + 1,
                                TEXT_SPEED_FF, NULL);
...
void PrintMatchCallFieldNames(struct PokenavSub17Substruct* a0, u32 fieldId) {
    const u8* fieldNames[] = { gText_PokenavMatchCall_Strategy, gText_PokenavMatchCall_TrainerPokemon,
...
static void PrintMatchCallFlavorText(struct MatchCallWindowState* a0, struct PokenavSub17Substruct* a1,
                                     u32 checkPageEntry) {
    ...
    static const u8 lineOffsets[CHECK_PAGE_ENTRY_COUNT] = {
        [CHECK_PAGE_STRATEGY] = 2, [CHECK_PAGE_POKEMON] = 4, [CHECK_PAGE_INTRO_1] = 6, [CHECK_PAGE_INTRO_2] = 7
    };
...
static const struct SpritePalette sMatchcallArrowPalettes[] = { { .data = sMatchcallArrowPaletteData, .tag = 0x14 },
                                                                {} };
