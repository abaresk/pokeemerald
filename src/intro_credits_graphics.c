...
static const union AnimCmd* const gUnknown_085F5094[] = { gUnknown_085F5074, gUnknown_085F507C, gUnknown_085F5084,
                                                          gUnknown_085F508C };
...
static const union AnimCmd* const gUnknown_085F5114[] = { gUnknown_085F50FC, gUnknown_085F5104, gUnknown_085F510C };
...
static const union AnimCmd gUnknown_085F51D4[] = { ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(64, 8), ANIMCMD_FRAME(128, 8),
                                                   ANIMCMD_FRAME(192, 8), ANIMCMD_JUMP(0) };
...
static const union AnimCmd gUnknown_085F5224[] = { ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(32, 8), ANIMCMD_FRAME(64, 8),
                                                   ANIMCMD_FRAME(96, 8), ANIMCMD_JUMP(0) };
...
const struct SpritePalette gIntroBikeAndFlygonPalette[] = { { .data = gIntro2BrendanNoTurnPal, .tag = 1002 },
                                                            { .data = gIntro2BrendanNoTurnPal, .tag = 1003 },
                                                            { .data = gIntro2FlygonPal, .tag = 1004 },
                                                            { .data = gIntro2FlygonPal, .tag = 1005 },
                                                            {} };

const struct CompressedSpriteSheet gUnknown_085F5334[] = { { .data = gIntro2BrendanTiles, .size = 0x3800, .tag = 1002 },
                                                           {} };

const struct CompressedSpriteSheet gUnknown_085F5344[] = { { .data = gIntro2MayTiles, .size = 0x3800, .tag = 1003 },
                                                           {} };

const struct CompressedSpriteSheet gUnknown_085F5354[] = { { .data = gIntro2BicycleTiles, .size = 0x1000, .tag = 1001 },
                                                           {} };
...
const struct CompressedSpriteSheet gUnknown_085F53AC[] = { { .data = gIntro2BrendanTiles, .size = 0x2000, .tag = 1002 },
                                                           {} };

const struct CompressedSpriteSheet gUnknown_085F53BC[] = { { .data = gIntro2MayTiles, .size = 0x2000, .tag = 1003 },
                                                           {} };
    ...
    switch (a) {
        ...
        case 0:
            SetGpuReg(REG_OFFSET_BG3CNT,
                      BGCNT_PRIORITY(3) | BGCNT_CHARBASE(0) | BGCNT_16COLOR | BGCNT_SCREENBASE(6) | BGCNT_TXT256x256);
            SetGpuReg(REG_OFFSET_BG2CNT,
                      BGCNT_PRIORITY(2) | BGCNT_CHARBASE(0) | BGCNT_16COLOR | BGCNT_SCREENBASE(7) | BGCNT_TXT256x256);
            SetGpuReg(REG_OFFSET_BG1CNT,
                      BGCNT_PRIORITY(1) | BGCNT_CHARBASE(1) | BGCNT_16COLOR | BGCNT_SCREENBASE(15) | BGCNT_TXT256x256);
            SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_0 | DISPCNT_OBJ_1D_MAP | DISPCNT_BG1_ON | DISPCNT_BG2_ON |
