...
static const union AnimCmd *const sBagSpriteAnimTable[] = { sSpriteAnim_Bag_Closed,
...
static const union AnimCmd sSpriteAffineAnim_RotatingBallStationary[] = { ANIMCMD_FRAME(0, 0),
    ANIMCMD_END };
...
static const union AffineAnimCmd sSpriteAffineAnim_RotatingBallRotation1[] = {
    AFFINEANIMCMD_FRAME(0, 0, 8, 16), AFFINEANIMCMD_END
};

static const union AffineAnimCmd sSpriteAffineAnim_RotatingBallRotation2[] = {
    AFFINEANIMCMD_FRAME(0, 0, 248, 16), AFFINEANIMCMD_END
};
...
static const struct SpritePalette gRotatingBallPaletteTable = { gRotatingBall_Pal,
...
static const union AffineAnimCmd sSpriteAffineAnim_BerryPicRotation1[] = { AFFINEANIMCMD_FRAME(
                                                                               -1, -1, 253, 96),
...
static const union AffineAnimCmd *const sBerryPicRotatingAnimCmds[] = {
    sSpriteAffineAnim_BerryPicRotation1, sSpriteAffineAnim_BerryPicRotation2
};
...
const struct CompressedSpritePalette gBerryCheckCirclePaletteTable = { gBerryCheck_Pal,
