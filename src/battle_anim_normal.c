...
static const union AnimCmd sAnim_ConfusionDuck_0[] = {
    ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(4, 8), ANIMCMD_FRAME(0, 8, .hFlip = TRUE), ANIMCMD_FRAME(8, 8), ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_ConfusionDuck_1[] = {
    ANIMCMD_FRAME(0, 8, .hFlip = TRUE), ANIMCMD_FRAME(4, 8), ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(8, 8), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd gUnknown_085972A4[] = {
    ...
    ANIMCMD_FRAME(48, 3), ANIMCMD_FRAME(64, 3), ANIMCMD_JUMP(0),
};
...
static void AnimSimplePaletteBlend(struct Sprite* sprite) {
    ...
    BeginNormalPaletteFade(selectedPalettes, gBattleAnimArgs[1], gBattleAnimArgs[2], gBattleAnimArgs[3],
                           gBattleAnimArgs[4]);
...
static void BlendColorCycle(u8 taskId, u8 startBlendAmount, u8 targetBlendAmount) {
    ...
    BeginNormalPaletteFade(selectedPalettes, gTasks[taskId].tDelay, startBlendAmount, targetBlendAmount,
...
static void BlendColorCycleByTag(u8 taskId, u8 startBlendAmount, u8 targetBlendAmount) {
    ...
    BeginNormalPaletteFade(1 << (paletteIndex + 16), gTasks[taskId].tDelay, startBlendAmount, targetBlendAmount,
                           gTasks[taskId].tBlendColor);
...
void AnimTask_FlashAnimTagWithColor(u8 taskId) {
    ...
    BeginNormalPaletteFade(1 << (paletteIndex + 16), 0, gBattleAnimArgs[4], gBattleAnimArgs[4], gBattleAnimArgs[3]);
...
static void AnimTask_FlashAnimTagWithColor_Step1(u8 taskId) {
    ...
    if (gTasks[taskId].data[1] & 0x100) {
        BeginNormalPaletteFade(selectedPalettes, 0, gTasks[taskId].data[4], gTasks[taskId].data[4],
                               gTasks[taskId].data[3]);
    } else {
        BeginNormalPaletteFade(selectedPalettes, 0, gTasks[taskId].data[6], gTasks[taskId].data[6],
