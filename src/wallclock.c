...
static const struct WindowTemplate gUnknown_085B21DC[] = { { .bg = 0,
                                                               .tilemapLeft = 3,
                                                               .tilemapTop = 17,
                                                               .width = 24,
                                                               .height = 2,
...
static const struct WindowTemplate gUnknown_085B21F4 = { .bg = 0,
    .tilemapLeft = 24,
    .tilemapTop = 9,
    .width = 5,
    .height = 4,
...
static const struct SpritePalette gUnknown_085B2218[] = { { .data = gWallclockMale_Pal,
                                                              .tag = TAG_PAL_WALL_CLOCK_HAND },
    { .data = gWallclockFemale_Pal, .tag = 0x1001 },
    {} };
...
static const s8 sClockHandCoords[][2] = { { 0x00, -0x18 },
    { 0x01, -0x19 },
    { 0x01, -0x19 },
    { 0x02, -0x19 },
    { 0x02, -0x19 },
...
static void Task_SetClock2(u8 taskId)
{
    ...
    else
    {
        ...
        gTasks[taskId].tHourHandAngle =
            (gTasks[taskId].tHours % 12) * 30 + (gTasks[taskId].tMinutes / 10) * 5;
        ...
        else
        {
            ...
            if (gTasks[taskId].tMvmtDir != 0)
            {
                ...
                gTasks[taskId].tMinuteHandAngle =
                    CalcNewMinHandAngle(gTasks[taskId].tMinuteHandAngle,
