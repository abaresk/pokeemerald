...
const u8 sTextColorTable[][3] = { { TEXT_COLOR_TRANSPARENT, TEXT_COLOR_DARK_GREY, TEXT_COLOR_LIGHT_GREY },
...
const struct SpritePalette gUnknown_082F1D08[] = {
    { gWonderCardShadowPal1, 0x8000 }, { gWonderCardShadowPal2, 0x8000 }, { gWonderCardShadowPal3, 0x8000 },
    { gWonderCardShadowPal4, 0x8000 }, { gWonderCardShadowPal5, 0x8000 }, { gWonderCardShadowPal6, 0x8000 },
    { gWonderCardShadowPal7, 0x8000 }, { gWonderCardShadowPal8, 0x8000 }
};
...
void sub_801BEF8(void) {
    ...
    ConvertIntToDecimalStringN(sWonderCardData->unk_01DD, sWonderCardData->unk_0000.unk_04, STR_CONV_MODE_LEFT_ALIGN,
                               6);
    for (i = 0; i < 4; i++) {
            ...
            for (i = 0, r6 = 0; i < 40; i++) {
                if (sWonderCardData->unk_0000.unk_122[i] != 0xF7) {
                    ...
                    if (r3 > 2) {
                        ...
                        ConvertIntToDecimalStringN(sWonderCardData->unk_02DC[sWonderCardData->unk_0175].unk_42, sp0[r3],
...
void sub_801C178(u8 whichWindow) {
    ...
    switch (whichWindow) {
        case 0: {
            s32 x;
            AddTextPrinterParameterized3(windowId, 3, 0, 1, sTextColorTable[sWonderCardData->unk_0170->textPal1], 0,
                                         sWonderCardData->unk_018B);
            x = 160 - GetStringWidth(3, sWonderCardData->unk_01B4, GetFontAttribute(3, 2));
            if (x < 0)
                x = 0;
            AddTextPrinterParameterized3(windowId, 3, x, 17, sTextColorTable[sWonderCardData->unk_0170->textPal1], 0,
                                         sWonderCardData->unk_01B4);
            if (sWonderCardData->unk_0000.unk_04 != 0) {
                AddTextPrinterParameterized3(windowId, 1, 166, 17, sTextColorTable[sWonderCardData->unk_0170->textPal1],
                                             0, sWonderCardData->unk_01DD);
            }
            break;
        }
        case 1:
            for (; sp0C < 4; sp0C++) {
                AddTextPrinterParameterized3(windowId, 3, 0, 16 * sp0C + 2,
                                             sTextColorTable[sWonderCardData->unk_0170->textPal2], 0,
                                             sWonderCardData->unk_01E4[sp0C]);
            }
            break;
        case 2:
            AddTextPrinterParameterized3(windowId, 3, 0, gUnknown_082F0E18[sWonderCardData->unk_0000.unk_08_0],
                                         sTextColorTable[sWonderCardData->unk_0170->textPal3], 0,
                                         sWonderCardData->unk_0288);
            if (sWonderCardData->unk_0000.unk_08_0 != 2) {
                AddTextPrinterParameterized3(windowId, 3, 0, 16 + gUnknown_082F0E18[sWonderCardData->unk_0000.unk_08_0],
                                             sTextColorTable[sWonderCardData->unk_0170->textPal3], 0,
...
void sub_801C4C0(void) {
    ...
    if (sWonderCardData->unk_014C.unk_06 != SPECIES_NONE) {
        sWonderCardData->unk_017C =
            sub_80D2D78(sub_80D2E84(sWonderCardData->unk_014C.unk_06), SpriteCallbackDummy, 0xDC, 0x14, 0, FALSE);
    ...
    if (sWonderCardData->unk_0000.unk_09 != 0 && sWonderCardData->unk_0000.unk_08_0 == 1) {
        ...
        for (; r7 < sWonderCardData->unk_0000.unk_09; r7++) {
            ...
            if (sWonderCardData->unk_014C.unk_08[0][r7] != 0) {
                sWonderCardData->unk_017D[r7][1] = sub_80D2D78(sub_80D2E84(sWonderCardData->unk_014C.unk_08[0][r7]),
                                                               SpriteCallbackDummy, 0xd8 - 32 * r7, 0x88, 0, 0);
            }
        }
    }
}
...
const struct WindowTemplate gUnknown_082F1DE8[] = {
    { .bg = 0, .tilemapLeft = 1, .tilemapTop = 0, .width = 28, .height = 3, .paletteNum = 2, .baseBlock = 0x2AC },
    { .bg = 2, .tilemapLeft = 1, .tilemapTop = 3, .width = 28, .height = 20, .paletteNum = 2, .baseBlock = 0x07C }
};
const struct ScrollArrowsTemplate gUnknown_082F1DF8 = { 0x02,   0xe8,   0x18,   0x03,   0xe8, 0x98,
...
void sub_801CE7C(void) {
    ...
    if (x < 0)
        x = 0;
    AddTextPrinterParameterized3(sWonderNewsData->unk_01C8[0], 3, x, 6,
                                 gUnknown_082F1DE0[sWonderNewsData->unk_01BC->textPal1], 0, sWonderNewsData->unk_01CE);
    for (; i < 10; ++i) {
        AddTextPrinterParameterized3(sWonderNewsData->unk_01C8[1], 3, 0, 16 * i + 2,
                                     gUnknown_082F1DE0[sWonderNewsData->unk_01BC->textPal2], 0,
