...
const struct WindowTemplate gUnknown_082F0E1C[] = { { .bg = 1,
                                                        .tilemapLeft = 1,
                                                        .tilemapTop = 1,
                                                        .width = 25,
                                                        .height = 4,
...
const u16 gWonderCardShadowPal1[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_1.gbapal");
const u16 gWonderCardShadowPal2[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_2.gbapal");
const u16 gWonderCardShadowPal3[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_3.gbapal");
const u16 gWonderCardShadowPal4[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_4.gbapal");
const u16 gWonderCardShadowPal5[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_5.gbapal");
const u16 gWonderCardShadowPal6[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_6.gbapal");
const u16 gWonderCardShadowPal7[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_7.gbapal");
const u16 gWonderCardShadowPal8[] =
    INCBIN_U16("graphics/wonder_transfers/wonder_card_shadow_8.gbapal");
const u32 gWonderCardShadowGfx[] =
    INCBIN_U32("graphics/wonder_transfers/wonder_card_shadow.4bpp.lz");

const struct CompressedSpriteSheet gUnknown_082F1D00 = { gWonderCardShadowGfx, 0x100, 0x8000 };
const struct SpritePalette gUnknown_082F1D08[] = { { gWonderCardShadowPal1, 0x8000 },
...
const struct SpriteTemplate gUnknown_082F1D48 = { 0x8000,
    0x8000,
    ...
    switch (sWonderCardData->unk_0174)
    {
        ...
        case 3:
            ...
            CopyRectToBgTilemapBufferRect(
                2, sWonderCardData->buffer_045C, 0, 0, 30, 20, 0, 0, 30, 20, 1, 0x008, 0);
            CopyBgTilemapBufferToVram(2);
            break;
        case 4:
            sub_801BEF8();
...
void sub_801BEF8(void)
{
    ...
    ConvertIntToDecimalStringN(
        sWonderCardData->unk_01DD, sWonderCardData->unk_0000.unk_04, STR_CONV_MODE_LEFT_ALIGN, 6);
    for (i = 0; i < 4; i++)
    {
    ...
    switch (sWonderCardData->unk_0000.unk_08_0)
    {
        ...
        case 2:
            sWonderCardData->unk_02B1[00] = EOS;
            sp0[0] =
                sWonderCardData->unk_014C.unk_00 < 999 ? sWonderCardData->unk_014C.unk_00 : 999;
            sp0[1] =
                sWonderCardData->unk_014C.unk_02 < 999 ? sWonderCardData->unk_014C.unk_02 : 999;
            sp0[2] =
                sWonderCardData->unk_014C.unk_04 < 999 ? sWonderCardData->unk_014C.unk_04 : 999;
            for (i = 0; i < 8; i++)
            {
            ...
            for (i = 0, r6 = 0; i < 40; i++)
            {
                ...
                {
                    sWonderCardData->unk_02DC[sWonderCardData->unk_0175].unk_01[r6] =
                        sWonderCardData->unk_0000.unk_122[i];
                    r6++;
                }
                else
                {
                    ...
                    {
                        ConvertIntToDecimalStringN(
                            sWonderCardData->unk_02DC[sWonderCardData->unk_0175].unk_42,
                            sp0[r3],
                            STR_CONV_MODE_LEADING_ZEROS,
                            3);
                        sWonderCardData->unk_02DC[sWonderCardData->unk_0175].unk_00 =
                            sWonderCardData->unk_0000.unk_122[i + 2];
    ...
    switch (whichWindow)
    {
        case 0:
        {
            ...
            AddTextPrinterParameterized3(windowId,
                ...
                0,
                1,
                sTextColorTable[sWonderCardData->unk_0170->textPal1],
                0,
                sWonderCardData->unk_018B);
        ...
        case 1:
            for (; sp0C < 4; sp0C++)
            {
                AddTextPrinterParameterized3(windowId,
                    ...
                    0,
                    16 * sp0C + 2,
                    sTextColorTable[sWonderCardData->unk_0170->textPal2],
                    0,
                    sWonderCardData->unk_01E4[sp0C]);
            }
            break;
        case 2:
            AddTextPrinterParameterized3(windowId,
                3,
                0,
                gUnknown_082F0E18[sWonderCardData->unk_0000.unk_08_0],
                sTextColorTable[sWonderCardData->unk_0170->textPal3],
                0,
                sWonderCardData->unk_0288);
            if (sWonderCardData->unk_0000.unk_08_0 != 2)
            {
                AddTextPrinterParameterized3(windowId,
                    3,
                    0,
                    16 + gUnknown_082F0E18[sWonderCardData->unk_0000.unk_08_0],
                    sTextColorTable[sWonderCardData->unk_0170->textPal3],
                    0,
                    sWonderCardData->unk_02B1);
            }
            else
            {
                s32 x = 0;
                ...
                for (; sp0C < sWonderCardData->unk_0175; sp0C++)
                {
                    AddTextPrinterParameterized3(windowId,
                        ...
                        sTextColorTable[sWonderCardData->unk_0170->textPal3],
                        0,
                        sWonderCardData->unk_02DC[sp0C].unk_01);
                    if (sWonderCardData->unk_02DC[sp0C].unk_42[0] != EOS)
                    {
                        ...
                        AddTextPrinterParameterized3(windowId,
                            ...
                            sTextColorTable[sWonderCardData->unk_0170->textPal3],
                            0,
                            sWonderCardData->unk_02DC[sp0C].unk_42);
                        x += GetStringWidth(3, sWonderCardData->unk_02DC[sp0C].unk_42, spacing)
                             + sWonderCardData->unk_02DC[sp0C].unk_00;
                    }
                }
            }
            break;
...
void sub_801C4C0(void)
{
    ...
    {
        sWonderCardData->unk_017C = sub_80D2D78(sub_80D2E84(sWonderCardData->unk_014C.unk_06),
            SpriteCallbackDummy,
            0xDC,
            0x14,
            0,
    ...
    if (sWonderCardData->unk_0000.unk_09 != 0 && sWonderCardData->unk_0000.unk_08_0 == 1)
    {
        ...
        for (; r7 < sWonderCardData->unk_0000.unk_09; r7++)
        {
            ...
            sWonderCardData->unk_017D[r7][0] =
                CreateSprite(&gUnknown_082F1D48, 0xd8 - 32 * r7, 0x90, 8);
            if (sWonderCardData->unk_014C.unk_08[0][r7] != 0)
            {
                sWonderCardData->unk_017D[r7][1] =
                    sub_80D2D78(sub_80D2E84(sWonderCardData->unk_014C.unk_08[0][r7]),
                        SpriteCallbackDummy,
                        0xd8 - 32 * r7,
                        0x88,
                        0,
...
const u8 gUnknown_082F1DE0[][3] = { { 0, 2, 3 }, { 0, 1, 2 } };
const struct WindowTemplate gUnknown_082F1DE8[] = { { .bg = 0,
                                                        .tilemapLeft = 1,
                                                        .tilemapTop = 0,
                                                        .width = 28,
                                                        .height = 3,
...
s32 FadeToWonderNewsMenu(void)
{
    ...
    switch (sWonderNewsData->unk_01C0_1)
    {
        ...
        case 3:
            ...
            CopyRectToBgTilemapBufferRect(
                1, sWonderNewsData->buffer_03A4, 0, 0, 30, 3, 0, 0, 30, 3, 1, 8, 0);
            CopyRectToBgTilemapBufferRect(
                3, sWonderNewsData->buffer_03A4, 0, 3, 30, 23, 0, 3, 30, 23, 1, 8, 0);
            CopyBgTilemapBufferToVram(1);
            CopyBgTilemapBufferToVram(3);
            break;
        case 4:
        ...
        case 6:
            ...
            ShowBg(3);
            gPaletteFade.bufferTransferDisabled = FALSE;
            sWonderNewsData->unk_01C1 =
                AddScrollIndicatorArrowPair(&sWonderNewsData->unk_0394, &sWonderNewsData->unk_01C6);
            BeginNormalPaletteFade(0xFFFFFFFF, 0, 16, 0, RGB_BLACK);
            UpdatePaletteFade();
            break;
        default:
...
void sub_801CE7C(void)
{
    ...
    if (x < 0)
        x = 0;
    AddTextPrinterParameterized3(sWonderNewsData->unk_01C8[0],
        3,
        x,
        6,
        gUnknown_082F1DE0[sWonderNewsData->unk_01BC->textPal1],
        0,
        sWonderNewsData->unk_01CE);
    for (; i < 10; ++i)
    {
        AddTextPrinterParameterized3(sWonderNewsData->unk_01C8[1],
            3,
            0,
            16 * i + 2,
            gUnknown_082F1DE0[sWonderNewsData->unk_01BC->textPal2],
            0,
            sWonderNewsData->unk_01F7[i]);
    }
