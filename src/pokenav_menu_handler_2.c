...
static const struct UnkStruct_08620240 gUnknown_08620240[POKENAV_MENU_TYPE_COUNT] = {
    [POKENAV_MENU_TYPE_DEFAULT] = { 0x2A, 0x14, { gUnknown_0862020C, gUnknown_08620210, gUnknown_0862021C } },
    ...
    [POKENAV_MENU_TYPE_UNLOCK_MC_RIBBONS] = { 0x2A,
                                              0x14,
                                              { gUnknown_0862020C, gUnknown_08620210, gUnknown_08620214,
                                                gUnknown_08620218, gUnknown_0862021C } },
    [POKENAV_MENU_TYPE_CONDITION] = { 0x38, 0x14, { gUnknown_08620220, gUnknown_08620224, gUnknown_0862023C } },
    [POKENAV_MENU_TYPE_CONDITION_SEARCH] = { 0x28,
                                             0x10,
                                             { gUnknown_08620228, gUnknown_0862022C, gUnknown_08620230,
                                               gUnknown_08620234, gUnknown_08620238, gUnknown_0862023C } },
};

static const struct WindowTemplate sOptionDescWindowTemplate = {
    .bg = 1, .tilemapLeft = 3, .tilemapTop = 17, .width = 0x18, .height = 0x2, .paletteNum = 1, .baseBlock = 8
};
...
static const union AffineAnimCmd* const sSpriteAnims_MenuOption[] = { gUnknown_0862031C, gUnknown_0862032C };
...
static const struct ScanlineEffectParams gUnknown_08620384 = {
    (void*)REG_ADDR_WIN0H, ((DMA_ENABLE | DMA_START_HBLANK | DMA_REPEAT | DMA_DEST_RELOAD) << 16) | 1, 1, 0
};
