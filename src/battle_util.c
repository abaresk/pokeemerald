            ...
            switch (gBattleStruct->turnEffectsTracker)
            {
                ...
                case ENDTURN_LEECH_SEED: // leech seed
                        ...
                        && gBattleMons[gActiveBattler].hp != 0)
                    {
                        gBattlerTarget = gStatuses3[gActiveBattler]
                                         & STATUS3_LEECHSEED_BATTLER; // Notice gBattlerTarget is
                                                                      // actually the HP receiver.
                ...
                case ENDTURN_NIGHTMARES: // spooky nightmares
                    if ((gBattleMons[gActiveBattler].status2 & STATUS2_NIGHTMARE)
                        && gBattleMons[gActiveBattler].hp != 0)
                    {
                        // R/S does not perform this sleep check, which causes the nightmare effect
                        // to persist even after the affected Pokemon has been awakened by Shed
                        // Skin.
                ...
                case ENDTURN_WRAP: // wrap
                        ...
                        && gBattleMons[gActiveBattler].hp != 0)
                    {
                        ...
                        if (gBattleMons[gActiveBattler].status2
                            & STATUS2_WRAPPED) // damaged by wrap
                        {
                                   ...
                                   .encoredMove) // pokemon does not have the encored move anymore
                        {
                            ...
                            gDisableStructs[gActiveBattler].encoreTimer = 0;
                                 ...
                                 || gBattleMons[gActiveBattler]
                                            .pp[gDisableStructs[gActiveBattler].encoredMovePos]
                                        == 0)
                        {
                            gDisableStructs[gActiveBattler].encoredMove = 0;
                            gDisableStructs[gActiveBattler].encoreTimer = 0;
                        ...
                        case ABILITY_SHED_SKIN:
                            if ((gBattleMons[battler].status1 & STATUS1_ANY) && (Random() % 3) == 0)
                            {
                                ...
                                if (gBattleMons[battler].status1 & STATUS1_PARALYSIS)
                                    StringCopy(
                                        gBattleTextBuff1, gStatusConditionString_ParalysisJpn);
                ...
                switch (gLastUsedAbility)
                {
                    ...
                    case ABILITY_FLAME_BODY:
                        if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
                            ...
                            && !gProtectStructs[gBattlerAttacker].confusionSelfDmg
                            && (gBattleMoves[move].flags & FLAG_MAKES_CONTACT)
                            && TARGET_TURN_DAMAGED && (Random() % 3) == 0)
                        {
                            gBattleCommunication[MOVE_EFFECT_BYTE] =
                    ...
                    case ABILITY_CUTE_CHARM:
                        if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
                            ...
                            && !gProtectStructs[gBattlerAttacker].confusionSelfDmg
                            && (gBattleMoves[move].flags & FLAG_MAKES_CONTACT)
                            && TARGET_TURN_DAMAGED && gBattleMons[gBattlerTarget].hp != 0
                            && (Random() % 3) == 0
            ...
            if (gBattleMons[battlerId].hp)
            {
                switch (battlerHoldEffect)
                {
                    ...
                    case HOLD_EFFECT_LEFTOVERS:
                        ...
                        break;
                    // nice copy/paste there gamefreak, making a function for confuse berries was
                    // too much eh?
                    case HOLD_EFFECT_CONFUSE_SPICY:
                            ...
                            && !moveTurn)
                        {
                            ...
                            if (GetFlavorRelationByPersonality(
                                    gBattleMons[battlerId].personality, FLAVOR_SPICY)
                                < 0)
                    ...
                    case HOLD_EFFECT_CONFUSE_DRY:
                            ...
                            && !moveTurn)
                        {
                            ...
                            gBattleMoveDamage *= -1;
                            if (GetFlavorRelationByPersonality(
                                    gBattleMons[battlerId].personality, FLAVOR_DRY)
                                < 0)
                                BattleScriptExecute(BattleScript_BerryConfuseHealEnd2);
                            else
                                BattleScriptExecute(BattleScript_ItemHealHP_RemoveItem);
                    ...
                    case HOLD_EFFECT_CONFUSE_SWEET:
                            ...
                            && !moveTurn)
                        {
                            ...
                            gBattleMoveDamage *= -1;
                            if (GetFlavorRelationByPersonality(
                                    gBattleMons[battlerId].personality, FLAVOR_SWEET)
                                < 0)
                                BattleScriptExecute(BattleScript_BerryConfuseHealEnd2);
                            else
                                BattleScriptExecute(BattleScript_ItemHealHP_RemoveItem);
                    ...
                    case HOLD_EFFECT_CONFUSE_BITTER:
                            ...
                            && !moveTurn)
                        {
                            ...
                            gBattleMoveDamage *= -1;
                            if (GetFlavorRelationByPersonality(
                                    gBattleMons[battlerId].personality, FLAVOR_BITTER)
                                < 0)
                                BattleScriptExecute(BattleScript_BerryConfuseHealEnd2);
                            else
                                BattleScriptExecute(BattleScript_ItemHealHP_RemoveItem);
                    ...
                    case HOLD_EFFECT_CONFUSE_SOUR:
                            ...
                            && !moveTurn)
                        {
                            ...
                            gBattleMoveDamage *= -1;
                            if (GetFlavorRelationByPersonality(
                                    gBattleMons[battlerId].personality, FLAVOR_SOUR)
                                < 0)
                                BattleScriptExecute(BattleScript_BerryConfuseHealEnd2);
                            else
                                BattleScriptExecute(BattleScript_ItemHealHP_RemoveItem);
                    ...
                    case HOLD_EFFECT_RANDOM_STAT_UP:
                                   ...
                                   <= gBattleMons[battlerId].maxHP / battlerHoldEffectParam)
                        {
                            for (i = 0; i < 5; i++)
                            {
                                if (gBattleMons[battlerId].statStages[STAT_ATK + i]
                                    < MAX_STAT_STAGE)
                                    break;
                            }
                            if (i != 5)
                            {
                                ...
                                {
                                    i = Random() % 5;
                                } while (gBattleMons[battlerId].statStages[STAT_ATK + i]
                                         == MAX_STAT_STAGE);
        ...
        case MOVE_TARGET_RANDOM:
            ...
            else if (gBattleTypeFlags & BATTLE_TYPE_DOUBLE && moveTarget & MOVE_TARGET_RANDOM)
            {
                ...
                targetBattler = GetBattlerAtPosition(
                    (GetBattlerPosition(gBattlerAttacker) & BIT_SIDE) ^ BIT_SIDE);
            break;
