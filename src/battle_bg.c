...
static const struct CompressedSpriteSheet sVsLettersSpriteSheet = { gVsLettersGfx, 0x1000, TAG_VS_LETTERS };
...
void DrawMainBattleBackground(void) {
    if (gBattleTypeFlags &
        (BATTLE_TYPE_LINK | BATTLE_TYPE_FRONTIER | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_x2000000)) {
...
void DrawBattleEntryBackground(void) {
    if (gBattleTypeFlags & BATTLE_TYPE_LINK) {
        ...
        LoadCompressedSpriteSheetUsingHeap(&sVsLettersSpriteSheet);
               ...
               (BATTLE_TYPE_FRONTIER | BATTLE_TYPE_LINK | BATTLE_TYPE_x2000000 | BATTLE_TYPE_EREADER_TRAINER)) {
