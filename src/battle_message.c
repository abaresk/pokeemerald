...
void BufferStringBattle(u16 stringID)
{
    ...
    *(&gBattleStruct->stringMoveType) = gBattleMsgDataPtr->moveType;
        ...
        else
        {
            if (gBattleTypeFlags & BATTLE_TYPE_LEGENDARY)
                stringPtr = sText_WildPkmnAppeared2;
                     ...
                     BATTLE_TYPE_DOUBLE) // interesting, looks like they had something planned for
                                         // wild double battles
    ...
    case STRINGID_USEDMOVE:                       // pokemon used a move msg
        ChooseMoveUsedParticle(gBattleTextBuff1); // buff1 doesn't appear in the string, leftover
                                                  // from japanese move names
        ...
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_TRAINER1_CLASS: // trainer class name
                if (gBattleTypeFlags & BATTLE_TYPE_SECRET_BASE)
                    ...
                    toCpy =
                        gTrainerClassNames[GetTrainerHillOpponentClass(gTrainerBattleOpponent_A)];
            ...
            case B_TXT_TRAINER2_CLASS:
                if (gBattleTypeFlags & BATTLE_TYPE_FRONTIER)
                    ...
                    toCpy =
                        gTrainerClassNames[GetTrainerHillOpponentClass(gTrainerBattleOpponent_B)];
                else
