...
static const u8* const sOptionMenuItemsNames[MENUITEM_COUNT] = {
    ...
    [MENUITEM_BATTLESTYLE] = gText_BattleStyle, [MENUITEM_SOUND] = gText_Sound,
    [MENUITEM_BUTTONMODE] = gText_ButtonMode,   [MENUITEM_FRAMETYPE] = gText_Frame,
    [MENUITEM_CANCEL] = gText_OptionMenuCancel,
};

static const struct WindowTemplate sOptionMenuWinTemplates[] = {
    { .bg = 1, .tilemapLeft = 2, .tilemapTop = 1, .width = 26, .height = 2, .paletteNum = 1, .baseBlock = 2 },
    { .bg = 0, .tilemapLeft = 2, .tilemapTop = 5, .width = 26, .height = 14, .paletteNum = 1, .baseBlock = 0x36 },
    DUMMY_WIN_TEMPLATE
};
...
static void TextSpeed_DrawChoices(u8 selection) {
    ...
    DrawOptionMenuChoice(gText_TextSpeedFast, GetStringRightAlignXOffset(1, gText_TextSpeedFast, 198), YPOS_TEXTSPEED,
                         styles[2]);
}
...
static void BattleScene_DrawChoices(u8 selection) {
    ...
    DrawOptionMenuChoice(gText_BattleSceneOff, GetStringRightAlignXOffset(1, gText_BattleSceneOff, 198),
                         YPOS_BATTLESCENE, styles[1]);
}
...
static void BattleStyle_DrawChoices(u8 selection) {
    ...
    DrawOptionMenuChoice(gText_BattleStyleSet, GetStringRightAlignXOffset(1, gText_BattleStyleSet, 198),
                         YPOS_BATTLESTYLE, styles[1]);
}
...
static void Sound_DrawChoices(u8 selection) {
    ...
    DrawOptionMenuChoice(gText_SoundStereo, GetStringRightAlignXOffset(1, gText_SoundStereo, 198), YPOS_SOUND,
                         styles[1]);
}
...
static void ButtonMode_DrawChoices(u8 selection) {
    ...
    DrawOptionMenuChoice(gText_ButtonTypeLEqualsA, GetStringRightAlignXOffset(1, gText_ButtonTypeLEqualsA, 198),
                         YPOS_BUTTONMODE, styles[2]);
}
