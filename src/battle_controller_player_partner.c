...
static const u8 sUnknown_08617254[] = {
    0x83, 0x4d, 0xf3, 0x5f, 0x6f, 0x4f, 0xeb, 0x3e, 0x67, 0x2e, 0x10, 0x46, 0x8c, 0x3d, 0x28, 0x35,
    0xc5, 0x2c, 0x15, 0x7f, 0xb5, 0x56, 0x9d, 0x53, 0x3b, 0x43, 0xda, 0x36, 0x79, 0x2a, 0x0e, 0x53,
};
    ...
    if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].ballAnimActive &&
        ...
        if (IsDoubleBattle() && !(gBattleTypeFlags & BATTLE_TYPE_MULTI)) {
            ...
            UpdateHealthboxAttribute(gHealthboxSpriteIds[gActiveBattler ^ BIT_FLANK],
                                     &gPlayerParty[gBattlerPartyIndexes[gActiveBattler ^ BIT_FLANK]], HEALTHBOX_ALL);
...
// with Steven) that use the back pic as well as animate it
static void PlayerPartnerHandleDrawTrainerPic(void) {
    s16 xPos, yPos;
    u32 trainerPicId;
