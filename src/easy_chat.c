...
static const union AnimCmd* const sUnknown_08597DBC[] = {
    sUnknown_08597D88, sUnknown_08597D90, sUnknown_08597D9C, sUnknown_08597DA8, sUnknown_08597DB4,
};
...
static const u16 sDefaultBattleStartWords[] = {
    EC_WORD_ARE, EC_WORD_YOU, EC_WORD_READY, EC_WORD_QUES, EC_WORD_HERE_I_COME, EC_WORD_EXCL,
};
...
static void DoQuizAnswerEasyChatScreen(void) {
    DoEasyChatScreen(EASY_CHAT_TYPE_QUIZ_ANSWER, &gSaveBlock1Ptr->lilycoveLady.quiz.playerAnswer,
                     CB2_ReturnToFieldContinueScript, EASY_CHAT_PERSON_DISPLAY_NONE);
}

static void DoQuizQuestionEasyChatScreen(void) {
    DoEasyChatScreen(EASY_CHAT_TYPE_QUIZ_QUESTION, gSaveBlock1Ptr->lilycoveLady.quiz.question,
                     CB2_ReturnToFieldContinueScript, EASY_CHAT_PERSON_DISPLAY_NONE);
}
...
static void DoQuizSetQuestionEasyChatScreen(void) {
    DoEasyChatScreen(EASY_CHAT_TYPE_QUIZ_SET_QUESTION, gSaveBlock1Ptr->lilycoveLady.quiz.question,
                     CB2_ReturnToFieldContinueScript, EASY_CHAT_PERSON_DISPLAY_NONE);
}
...
static void sub_811BDF0(u8* arg0) {
    ...
    if (StringLength(saveBlock1->lilycoveLady.quiz.playerName) != 0) {
        TVShowConvertInternationalString(name, saveBlock1->lilycoveLady.quiz.playerName,
                                         saveBlock1->lilycoveLady.quiz.language);
        ...
        case 5:
            if (IsDma3ManagerBusyWithBgCopy()) {
                ...
                SetGpuReg(REG_OFFSET_WINOUT,
                          WINOUT_WIN01_BG0 | WINOUT_WIN01_BG1 | WINOUT_WIN01_BG3 | WINOUT_WIN01_OBJ | WINOUT_WIN01_CLR);
                ShowBg(3);
                ShowBg(1);
                ShowBg(2);
                ShowBg(0);
...
void sub_811D028(u8 windowId, u8 fontId, const u8* str, u8 x, u8 y, u8 speed,
        ...
        for (j = 0; j < 2; j++) {
            ...
            if (easyChatWord != 0xFFFF) {
                ...
                if (!sub_811BF88(easyChatWord))
                    ...
                    sub_811D058(2, 1, sUnknown_0203A11C->unkCC, (j * 13 + 3) * 8, y, 0xFF, TEXT_COLOR_WHITE,
                                TEXT_COLOR_LIGHT_RED, TEXT_COLOR_LIGHT_GREY);
            }
        }
...
static void sub_811E828(void) {
    ...
    spriteId = AddPseudoObjectEvent(gSaveBlock2Ptr->playerGender == MALE ? OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL
                                                                         : OBJ_EVENT_GFX_RIVAL_MAY_NORMAL,
                                    SpriteCallbackDummy, 52, 40, 0);
