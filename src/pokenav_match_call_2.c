...
static const struct WindowTemplate sMatchCallInfoBoxWindowTemplate = {
    .bg = 2, .tilemapLeft = 0, .tilemapTop = 9, .width = 11, .height = 8, .paletteNum = 2, .baseBlock = 38
};

static const u8* const sMatchCallOptionTexts[MATCH_CALL_OPTION_COUNT] = { [MATCH_CALL_OPTION_CALL] = gText_Call,
...
static const struct WindowTemplate sCallMsgBoxWindowTemplate = {
    .bg = 1, .tilemapLeft = 1, .tilemapTop = 12, .width = 0x1C, .height = 0x04, .paletteNum = 1, .baseBlock = 10
};
...
static void PrintMatchCallSelectionOptions(struct Pokenav4Struct* state) {
    ...
    for (i = 0; i < MATCH_CALL_OPTION_COUNT; i++) {
        ...
        AddTextPrinterParameterized(state->infoBoxWindowId, 7, sMatchCallOptionTexts[optionText], 16, i * 16 + 1,
                                    TEXT_SPEED_FF, NULL);
    }
