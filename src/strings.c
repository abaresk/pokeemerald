...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX "
                                  "rating!\pPROF. BIRCH: Let's see…\p");
...
const u8* const gReturnToXStringsTable[] = { gText_TheField, gText_TheBattle, gText_ThePokemonList, gText_TheShop,
                                             gText_TheField, gText_TheField,  gText_ThePC,          gText_TheField,
                                             gText_TheField, gText_TheField,  gText_TheBattle,      gText_ThePC };

const u8* const gReturnToXStringsTable2[] = { gText_TheField, gText_TheBattle, gText_ThePokemonList, gText_TheField };
...
const u8* const gPocketNamesStringsTable[] = { gText_ItemsPocket, gText_PokeBallsPocket, gText_TMHMPocket,
                                               gText_BerriesPocket, gText_KeyItemsPocket };
...
const u8 gText_12PoofForgotMove[] =
    _("1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} "
...
const u8 gText_XNatureProbablyMetAt[] =
    _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nprobably met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC "
      "1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_XNatureHatchedSomewhereAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nhatched "
                                               "somewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_PokemonMaleLv[] = _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW "
                                   "DARK_GREY WHITE LIGHT_GREY}/{LV}{DYNAMIC 1}"); // Unused
const u8 gText_PokemonFemaleLv[] =
    _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GREY WHITE "
      "LIGHT_GREY}/{LV}{DYNAMIC 1}");                                  // Unused
...
const u8 gText_PokemonMaleLv2[] = _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW "
                                    "DARK_GREY WHITE LIGHT_GREY}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); // Unused
const u8 gText_PokemonFemaleLv2[] =
    _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GREY WHITE "
      "LIGHT_GREY}/{LV}{DYNAMIC 1}{DYNAMIC 2}");                                   // Unused
...
const u8 gText_WinsLosses[] = _("W:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}  "
                                "L:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}");
...
const u8 gText_WinsStraight[] = _("W/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}  "
                                  "STRAIGHT/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}");
...
const u8 gText_EndedWithXUnitsPowder[] =
    _("{PAUSE_MUSIC}{PLAY_BGM MUS_LEVEL_UP}You ended up with {STR_VAR_1} units of\nsilky-smooth BERRY "
      "POWDER.{RESUME_MUSIC}\pYour total amount of BERRY POWDER\nis {STR_VAR_2}.\p");
...
const u8 gText_PokedexDiploma[] =
    _("PLAYER: {CLEAR 0x10}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}\n\nThis document "
      "certifies\nthat you have successfully\ncompleted your\n{STR_VAR_1} POKéDEX.\n\n{CLEAR_TO 0x42}{COLOR "
      "RED}{SHADOW LIGHT_RED}GAME FREAK");
...
const u8* const gTextTable_Players[] = { gText_F700Players, gText_F701Players, gText_F702Players, gText_F703Players };
