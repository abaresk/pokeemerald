...
const struct BattleAnimBackground gBattleAnimBackgroundTable[] = {
    ...
    [BG_IMPACT_OPPONENT] = { gBattleAnimBgImage_Impact, gBattleAnimBgPalette_Impact,
    ...
    [BG_IMPACT_CONTESTS] = { gBattleAnimBgImage_Impact, gBattleAnimBgPalette_Impact,
    ...
    [BG_HIGHSPEED_OPPONENT] = { gBattleAnimBgImage_Highspeed, gBattleAnimBgPalette_Highspeed,
                                gBattleAnimBgTilemap_HighspeedOpponent },
    [BG_HIGHSPEED_PLAYER] = { gBattleAnimBgImage_Highspeed, gBattleAnimBgPalette_Highspeed,
    ...
    [BG_GUILLOTINE_OPPONENT] = { gBattleAnimBgImage_Guillotine, gBattleAnimBgPalette_Guillotine,
                                 gBattleAnimBgTilemap_GuillotineOpponent },
    [BG_GUILLOTINE_PLAYER] = { gBattleAnimBgImage_Guillotine, gBattleAnimBgPalette_Guillotine,
                               gBattleAnimBgTilemap_GuillotinePlayer },
    [BG_GUILLOTINE_CONTESTS] = { gBattleAnimBgImage_Guillotine, gBattleAnimBgPalette_Guillotine,
    ...
    [BG_SOLARBEAM_OPPONENT] = { gBattleAnimBgImage_Impact, gBattleAnimBgPalette_Solarbeam,
                                gBattleAnimBgTilemap_ImpactOpponent },
    [BG_SOLARBEAM_PLAYER] = { gBattleAnimBgImage_Impact, gBattleAnimBgPalette_Solarbeam,
...
static void ScriptCmd_createsprite(void) {
    ...
    CreateSpriteAndAnimate(template, GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2),
                           GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET), subpriority);
    gAnimVisualTaskCount++;
}
...
void MoveBattlerSpriteToBG(u8 battlerId, bool8 toBG_2, bool8 setSpriteInvisible) {
    ...
    if (!toBG_2) {
        ...
        sub_8118FBC(2, 0, 0, GetBattlerPosition(battlerId), animBg.paletteId, animBg.bgTiles + 0x1000,
...
// Uses of this function that rely on a TRUE return are expecting inBattle to not be ticked as defined in contest
// behavior. As a result, if misused, this function cannot reliably discern between field and contest status and could
