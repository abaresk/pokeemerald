...
void Task_LinkContest_CommunicateFinalStandings(u8 taskId) {
    switch (gTasks[taskId].tState) {
        ...
        case 1:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(gContestMonTotalPoints, gBlockRecvBuffer[gContestLinkLeaderIndex],
        ...
        case 4:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(gContestMonAppealPointTotals, gBlockRecvBuffer[gContestLinkLeaderIndex],
        ...
        case 7:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(gContestMonRound2Points, gBlockRecvBuffer[gContestLinkLeaderIndex],
        ...
        case 10:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(gContestFinalStandings, gBlockRecvBuffer[gContestLinkLeaderIndex],
...
void Task_LinkContest_CommunicateAppealsState(u8 taskId) {
    switch (gTasks[taskId].tState) {
        ...
        case 1:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(eContestantStatus, gBlockRecvBuffer[gContestLinkLeaderIndex],
        ...
        case 3:
            if (IsLinkTaskFinished()) {
                if (LinkContest_SendBlock(gContestResources->appealResults, sizeof(struct ContestAppealMoveResults)) ==
                    1)
                    gTasks[taskId].tState++;
            }
            break;
        case 4:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(gContestResources->appealResults, gBlockRecvBuffer[gContestLinkLeaderIndex],
        ...
        case 7:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(gContestResources->excitement, gBlockRecvBuffer[gContestLinkLeaderIndex],
...
void Task_LinkContest_CommunicateRound1Points(u8 taskId) {
    ...
    switch (gTasks[taskId].tState) {
        ...
        case 1:
            if (LinkContest_GetBlockReceivedFromAllPlayers()) {
                memcpy(gContestMonRound1Points, gBlockRecvBuffer[gContestLinkLeaderIndex],
