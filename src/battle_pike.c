...
static const struct PikeWildMon sLvl50_Mons1[] = {
    ...
    { .species = SPECIES_MILOTIC, .levelDelta = 4, .moves = { MOVE_TOXIC, MOVE_HYPNOSIS, MOVE_BODY_SLAM, MOVE_SURF } },
...
static const struct PikeWildMon* const sLvl50Mons[] = { sLvl50_Mons1, sLvl50_Mons2, sLvl50_Mons3, sLvl50_Mons4 };
...
static const struct PikeWildMon* const sLvlOpenMons[] = { sLvlOpen_Mons1, sLvlOpen_Mons2, sLvlOpen_Mons3,
                                                          sLvlOpen_Mons4 };
...
static const struct PikeRoomNPC sNPCTable[] = {
    ...
    { .graphicsId = OBJ_EVENT_GFX_CYCLING_TRIATHLETE_M, .speechId1 = 30, .speechId2 = 20, .speechId3 = 36 },
    ...
    { .graphicsId = OBJ_EVENT_GFX_RUNNING_TRIATHLETE_M, .speechId1 = 37, .speechId2 = 12, .speechId3 = 32 },
    ...
    { .graphicsId = OBJ_EVENT_GFX_RUNNING_TRIATHLETE_F, .speechId1 = 18, .speechId2 = 13, .speechId3 = 21 },
...
static bool8 (*const sStatusInflictionScreenFlashFuncs[])(struct Task*) = { StatusInflictionFadeOut,
...
bool32 TryGenerateBattlePikeWildMon(bool8 checkKeenEyeIntimidate) {
    ...
    SetMonData(&gEnemyParty[0], MON_DATA_EXP,
...
static void StartStatusInflictionScreenFlash(s16 fadeOutDelay, s16 fadeInDelay, s16 numFades, s16 fadeOutSpeed,
                                             s16 fadeInSpped) {
...
static u8 GetPikeQueenFightType(u8 nextRoom) {
    ...
    switch (numPikeSymbols) {
        case 0:
        case 1:
            if (winStreak == sFrontierBrainStreakAppearances[facility][numPikeSymbols] -
        ...
        default:
            if (winStreak ==
                sFrontierBrainStreakAppearances[facility][0] - sFrontierBrainStreakAppearances[facility][3])
                ret = FRONTIER_BRAIN_STREAK;
            else if (winStreak ==
                         sFrontierBrainStreakAppearances[facility][1] - sFrontierBrainStreakAppearances[facility][3] ||
...
static void RestoreMonHeldItems(void) {
    ...
    for (i = 0; i < FRONTIER_PARTY_SIZE; i++) {
        SetMonData(&gPlayerParty[gSaveBlock2Ptr->frontier.selectedPartyMons[i] - 1], MON_DATA_HELD_ITEM,
