...
static const u8 sUnknownBytes[] = { 0x02, 0x03, 0x04, 0x05, 0x01, 0x01, 0x01, 0x06, 0x07, 0x08, 0x09, 0x0A,
                                    0x0B, 0x0C, 0x02, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15,
                                    0x16, 0x17, 0x18, 0x19, 0x02, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x1A,
                                    0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x02, 0x0D, 0x0E, 0x0F, 0x10,
...
static const union AnimCmd gUnknown_085E4A9C[] = {
    ANIMCMD_FRAME(0, 2),  ANIMCMD_FRAME(4, 2),  ANIMCMD_FRAME(8, 2),
    ANIMCMD_FRAME(12, 2), ANIMCMD_FRAME(16, 2), ANIMCMD_JUMP(0),
};
...
static const u8 gUnknown_085E4AD0[][2] = {
    { 0x7C, 0x28 }, { 0x66, 0x1E }, { 0x4D, 0x1E }, { 0x36, 0x0F }, { 0x94, 0x09 }, { 0x3F, 0x1C },
    { 0x5D, 0x28 }, { 0x94, 0x20 }, { 0xAD, 0x29 }, { 0x5E, 0x14 }, { 0xD0, 0x26 }, { 0x00, 0x00 },
};
...
static const union AnimCmd gUnknown_085E4B60[] = {
    ANIMCMD_FRAME(0, 5), ANIMCMD_FRAME(16, 5), ANIMCMD_FRAME(32, 5), ANIMCMD_FRAME(16, 5), ANIMCMD_JUMP(0),
};
static const union AnimCmd gUnknown_085E4B74[] = {
    ANIMCMD_FRAME(0, 3), ANIMCMD_FRAME(16, 3), ANIMCMD_FRAME(32, 3), ANIMCMD_FRAME(16, 3), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd gUnknown_085E4BC4[] = {
    ANIMCMD_FRAME(0, 4), ANIMCMD_FRAME(64, 4), ANIMCMD_FRAME(128, 4), ANIMCMD_FRAME(192, 4), ANIMCMD_JUMP(0),
};
...
static const s16 gIntroGroudonRockData[][3] = {
    { 0x68, 0x00, 0x0C0 }, { 0x8E, 0x03, 0x280 }, { 0x53, 0x01, 0x180 },
    { 0x9B, 0x00, 0x080 }, { 0x38, 0x02, 0x200 }, { 0xAE, 0x01, 0x100 },
};
...
static const s16 gIntroKyogreBubbleData[][3] = {
    { 0x42, 0x40, 0x1 }, { 0x60, 0x60, 0x8 }, { 0x80, 0x40, 0x1 }, { 0x90, 0x30, 0x8 },
    { 0xA0, 0x48, 0x1 }, { 0xB0, 0x60, 0x8 }, { 0x60, 0x60, 0x4 }, { 0x70, 0x68, 0x8 },
    { 0x80, 0x60, 0x4 }, { 0x58, 0x20, 0x4 }, { 0x68, 0x18, 0x8 }, { 0x78, 0x20, 0x4 },
};
...
static const union AnimCmd gUnknown_085E4CF8[] = {
    ANIMCMD_FRAME(0, 4),  ANIMCMD_FRAME(8, 4),  ANIMCMD_FRAME(16, 4),
    ANIMCMD_FRAME(24, 4), ANIMCMD_FRAME(32, 4), ANIMCMD_END,
};
...
static const union AnimCmd gUnknown_085E4D90[] = {
    ANIMCMD_FRAME(0, 8), ANIMCMD_FRAME(64, 8), ANIMCMD_FRAME(128, 8), ANIMCMD_FRAME(192, 8), ANIMCMD_JUMP(0),
};
...
static const union AnimCmd* const gUnknown_085E4E5C[] = {
    gUnknown_085E4DEC, gUnknown_085E4DF4, gUnknown_085E4DFC, gUnknown_085E4E04,
    gUnknown_085E4E0C, gUnknown_085E4E14, gUnknown_085E4E1C,
};
static const union AnimCmd* const gUnknown_085E4E78[] = {
    gUnknown_085E4E24, gUnknown_085E4E2C, gUnknown_085E4E34, gUnknown_085E4E3C, gUnknown_085E4E44, gUnknown_085E4E4C,
};
static const union AnimCmd* const gUnknown_085E4E90[] = {
    gUnknown_085E4E54,
};
static const s16 gUnknown_085E4E94[][2] = {
    { 0, -72 }, { 1, -56 }, { 2, -40 }, { 3, -24 }, { 4, 8 }, { 5, 24 }, { 3, 40 }, { 1, 56 }, { 6, 72 },
    { 0, -28 }, { 1, -20 }, { 2, -12 }, { 3, -4 },  { 2, 4 }, { 4, 12 }, { 5, 20 }, { 3, 28 },
};
...
static const u16 gUnknown_085E4F48[] = { 0x100, 0xC0, 0x80, 0x40, 0x00, 0x40, 0x80, 0xC0, 0x100 };
...
static const u8 gUnknown_085E4FA4[] = { 0x00, 0x17, 0x17, 0x31, 0x3E, 0x24, 0x24, 0x0A, 0x0A };
        ...
        case 141:
            ...
            if (gMultibootProgramStruct.gcmb_field_2 != 0) {
                if (gMultibootProgramStruct.gcmb_field_2 == 2) {
                    ...
                    {
                        CpuCopy16(&gMultiBootProgram_PokemonColosseum_Start, (void*)EWRAM_START,
                                  sizeof(gMultiBootProgram_PokemonColosseum_Start));
...
static void Task_IntroLoadPart3Graphics(u8 taskId) {
    ...
    BeginNormalPaletteFade(0xFFFFFFFF, 0, 0x10, 0, RGB_WHITEALPHA);
    SetGpuReg(REG_OFFSET_BG2CNT,
              BGCNT_PRIORITY(3) | BGCNT_CHARBASE(0) | BGCNT_SCREENBASE(8) | BGCNT_256COLOR | BGCNT_AFF256x256);
...
static void Task_IntroLoadPart3Graphics1(u8 taskId) {
    ...
    SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) | BGCNT_SCREENBASE(24) | BGCNT_256COLOR |
                                     BGCNT_WRAP | BGCNT_AFF512x512);
    SetGpuReg(REG_OFFSET_BG1CNT,
              BGCNT_PRIORITY(1) | BGCNT_CHARBASE(1) | BGCNT_SCREENBASE(28) | BGCNT_16COLOR | BGCNT_TXT256x256);
    SetGpuReg(REG_OFFSET_DISPCNT,
              DISPCNT_MODE_1 | DISPCNT_OBJ_1D_MAP | DISPCNT_BG1_ON | DISPCNT_BG2_ON | DISPCNT_OBJ_ON | DISPCNT_WIN0_ON);
    BeginNormalPaletteFade(0xFFFFFFFF, 0, 0x10, 0, RGB_WHITEALPHA);
    gTasks[taskId].data[0] = 0;
...
static void CreateKyogreBubbleSprites_1(void) {
    ...
    for (i = 0; i < 6; i++) {
        spriteId =
            CreateSprite(&gUnknown_085E4D14, gIntroKyogreBubbleData[i + 6][0], gIntroKyogreBubbleData[i + 6][1], i);
        gSprites[spriteId].invisible = TRUE;
        gSprites[spriteId].data[6] = gIntroKyogreBubbleData[i][2];
        gSprites[spriteId].data[7] = 0x40;
    }
...
static void Task_IntroLoadClouds1(u8 taskId) {
    SetGpuReg(REG_OFFSET_BLDCNT, BLDCNT_TGT1_BG0 | BLDCNT_TGT1_BG1 | BLDCNT_TGT1_BG2 | BLDCNT_EFFECT_LIGHTEN);
    SetGpuReg(REG_OFFSET_BLDALPHA, BLDALPHA_BLEND(31, 31));
    SetGpuReg(REG_OFFSET_BLDY, 31);
    SetGpuReg(REG_OFFSET_BG0CNT,
              BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) | BGCNT_SCREENBASE(24) | BGCNT_16COLOR | BGCNT_TXT512x256);
    SetGpuReg(REG_OFFSET_BG1CNT,
              BGCNT_PRIORITY(0) | BGCNT_CHARBASE(1) | BGCNT_SCREENBASE(26) | BGCNT_16COLOR | BGCNT_TXT512x256);
    SetGpuReg(REG_OFFSET_BG2CNT,
              BGCNT_PRIORITY(2) | BGCNT_CHARBASE(1) | BGCNT_SCREENBASE(28) | BGCNT_16COLOR | BGCNT_TXT256x256);
...
static void Task_IntroLoadRayquazaLightningScene(u8 taskId) {
    ...
    SetGpuReg(REG_OFFSET_DISPCNT,
              DISPCNT_MODE_0 | DISPCNT_OBJ_1D_MAP | DISPCNT_BG0_ON | DISPCNT_BG2_ON | DISPCNT_OBJ_ON | DISPCNT_WIN0_ON);
...
static void Task_IntroWaterDrops_1(u8 taskId) {
    switch (gTasks[taskId].data[0]) {
        case 0:
        default:
            SetGpuReg(REG_OFFSET_BLDCNT, BLDCNT_EFFECT_BLEND | BLDCNT_TGT2_BG0 | BLDCNT_TGT2_BG1 | BLDCNT_TGT2_BG2 |
