#ifndef GUARD_FLECS_PIECEMEAL_H
#define GUARD_FLECS_PIECEMEAL_H
...
extern "C"
{
    ...
    /* Memory management */
    typedef void *(*ecs_os_api_malloc_t)(
        ecs_size_t size);

    typedef void (*ecs_os_api_free_t)(
        void *ptr);

    typedef void *(*ecs_os_api_realloc_t)(
        void *ptr,
        ecs_size_t size);

    typedef void *(*ecs_os_api_calloc_t)(
        ecs_size_t size);

    typedef char *(*ecs_os_api_strdup_t)(
        const char *str);

    /* Threads */
    typedef void *(*ecs_os_thread_callback_t)(
        void *);

    typedef ecs_os_thread_t (*ecs_os_api_thread_new_t)(
        ecs_os_thread_callback_t callback,
        void *param);

    typedef void *(*ecs_os_api_thread_join_t)(
        ecs_os_thread_t thread);

    /* Atomic increment / decrement */
    typedef int (*ecs_os_api_ainc_t)(
        int32_t *value);

    /* Mutex */
    typedef ecs_os_mutex_t (*ecs_os_api_mutex_new_t)(
        void);

    typedef void (*ecs_os_api_mutex_lock_t)(
        ecs_os_mutex_t mutex);

    typedef void (*ecs_os_api_mutex_unlock_t)(
        ecs_os_mutex_t mutex);

    typedef void (*ecs_os_api_mutex_free_t)(
        ecs_os_mutex_t mutex);

    /* Condition variable */
    typedef ecs_os_cond_t (*ecs_os_api_cond_new_t)(
        void);

    typedef void (*ecs_os_api_cond_free_t)(
        ecs_os_cond_t cond);

    typedef void (*ecs_os_api_cond_signal_t)(
        ecs_os_cond_t cond);

    typedef void (*ecs_os_api_cond_broadcast_t)(
        ecs_os_cond_t cond);

    typedef void (*ecs_os_api_cond_wait_t)(
        ecs_os_cond_t cond,
        ecs_os_mutex_t mutex);

    typedef void (*ecs_os_api_sleep_t)(
        int32_t sec,
        int32_t nanosec);

    typedef void (*ecs_os_api_get_time_t)(
        ecs_time_t *time_out);

    /* Logging */
    typedef void (*ecs_os_api_log_t)(
        const char *fmt,
        va_list args);

    /* Application termination */
    typedef void (*ecs_os_api_abort_t)(
        void);

    /* Dynamic libraries */
    typedef ecs_os_dl_t (*ecs_os_api_dlopen_t)(
        const char *libname);

    typedef ecs_os_proc_t (*ecs_os_api_dlproc_t)(
        ecs_os_dl_t lib,
        const char *procname);

    typedef void (*ecs_os_api_dlclose_t)(
        ecs_os_dl_t lib);

    typedef char *(*ecs_os_api_module_to_path_t)(
...
#define ecs_abort(error_code, param)                   \
    _ecs_abort(error_code, param, __FILE__, __LINE__); \
    abort()
...
#define ECS_SET_COMPONENT(id)                     \
    if (handles)                                  \
        handles->ecs_typeid(id) = ecs_typeid(id); \
    if (handles)                                  \
    handles->ecs_type(id) = ecs_type(id)
...
#define ECS_IMPORT_COMPONENT(handles, id)                           \
    ECS_ENTITY_VAR(id) = (handles).ecs_typeid(id);                  \
    (void)ecs_typeid(id);                                           \
    ECS_VECTOR_STACK(FLECS__T##id, ecs_entity_t, &FLECS__E##id, 1); \
    (void)ecs_typeid(id);                                           \
    (void)ecs_type(id)
 ...
 */
    ...
    public:
        unsafe_column(void *array, std::size_t size, std::size_t count, bool is_shared = false)
            : m_array(array), m_size(size), m_count(count), m_is_shared(is_shared) {}
 ...
 */
     ...
     */
        column(T *array, std::size_t count, bool is_shared = false)
            : m_array(array), m_count(count), m_is_shared(is_shared) {}
 ...
 */
     ...
     */
        world()
            : m_world(ecs_init()), m_owned(true) { init_builtin_components(); }
     ...
     */
        world(int argc, char *argv[])
            : m_world(ecs_init_w_args(argc, argv)), m_owned(true) { init_builtin_components(); }

        /** Create world from C world.
     */
        explicit world(world_t *w)
            : m_world(w), m_owned(false) {}
 ...
 */
    ...
    public:
        ref()
            : m_world(nullptr), m_entity(0), m_ref()
        {
        }

        ref(world_t *world, entity_t entity)
            : m_world(world), m_entity(entity), m_ref()
        {
            ecs_assert(_::component_info<T>::size() != 0,
                       ECS_INVALID_PARAMETER, NULL);
 ...
 */
     ...
     */
        explicit entity(const world &world)
            : m_world(world.c_ptr()), m_id(ecs_new_w_type(m_world, 0)) {}
     ...
     */
        entity(const world &world, const char *name, bool is_component = false)
            : m_world(world.c_ptr()), m_id(ecs_lookup_path_w_sep(m_world, 0, name, "::", "::"))
        {
            if (!m_id)
            {
                if (is_component)
     ...
     */
        entity(const world &world, std::string name, bool is_component = false)
            : m_world(world.c_ptr()), m_id(ecs_lookup_path_w_sep(m_world, 0, name.c_str(), "::", "::"))
        {
            if (!m_id)
            {
                if (is_component)
     ...
     * @param world The world.
     */
        static flecs::entity null(const world &world)
        {
     ...
     */
        ...
        const T *get_trait() const
        {
            ...
            ecs_assert(_::component_info<T>::size() != 0,
                       ECS_INVALID_PARAMETER, NULL);
            return static_cast<const T *>(ecs_get_w_entity(m_world, m_id, ecs_trait(_::component_info<C>::id(m_world), _::component_info<T>::id(m_world))));
        }
     ...
     */
        ...
        const T *get_trait(flecs::entity component) const
        {
            ...
            ecs_assert(_::component_info<T>::size() != 0,
                       ECS_INVALID_PARAMETER, NULL);
            return static_cast<const T *>(ecs_get_w_entity(m_world, m_id, ecs_trait(component.id(), _::component_info<T>::id(m_world))));
        }
     ...
     */
        ...
        const C *get_trait_tag(flecs::entity trait) const
        {
            ...
            ecs_assert(_::component_info<C>::size() != 0,
                       ECS_INVALID_PARAMETER, NULL);
            return static_cast<const C *>(ecs_get_w_entity(m_world, m_id, ecs_trait(_::component_info<C>::id(m_world), trait.id())));
        }
     ...
     */
        const void *get_trait(flecs::entity trait, flecs::entity component) const
        {
            ecs_assert(m_world != NULL, ECS_INVALID_PARAMETER, NULL);
            ecs_assert(m_id != 0, ECS_INVALID_PARAMETER, NULL);
            return ecs_get_w_entity(m_world, m_id, ecs_trait(component.id(), trait.id()));
        }
     ...
     */
        ...
        T *get_trait_mut(bool *is_added = nullptr) const
        {
            ...
            return static_cast<T *>(
                ecs_get_mut_w_entity(
                    m_world, m_id, ecs_trait(_::component_info<C>::id(m_world), _::component_info<T>::id(m_world)),
                    is_added));
        }
     ...
     */
        ...
        T *get_trait_mut(flecs::entity component, bool *is_added = nullptr) const
        {
            ...
            return static_cast<T *>(
                ecs_get_mut_w_entity(
                    m_world, m_id, ecs_trait(_::component_info<T>::id(m_world), component.id()),
                    is_added));
        }
     ...
     */
        ...
        C *get_trait_tag_mut(flecs::entity trait, bool *is_added = nullptr) const
        {
            ...
            return static_cast<C *>(
                ecs_get_mut_w_entity(
                    m_world, m_id, ecs_trait(_::component_info<C>::id(m_world), trait.id()),
                    is_added));
        }
     ...
     */
        ...
        bool has_trait() const
        {
            ecs_assert(m_world != NULL, ECS_INVALID_PARAMETER, NULL);
            ecs_assert(m_id != 0, ECS_INVALID_PARAMETER, NULL);
            return ecs_has_entity(m_world, m_id, ecs_trait(_::component_info<C>::id(m_world), _::component_info<T>::id(m_world)));
        }
     ...
     */
        ...
        bool has_trait(flecs::entity component) const
        {
            ecs_assert(m_world != NULL, ECS_INVALID_PARAMETER, NULL);
            ecs_assert(m_id != 0, ECS_INVALID_PARAMETER, NULL);
            return ecs_has_entity(m_world, m_id, ecs_trait(component.id(), _::component_info<T>::id(m_world)));
        }
     ...
     */
        ...
        bool has_trait_tag(flecs::entity trait) const
        {
            ecs_assert(m_world != NULL, ECS_INVALID_PARAMETER, NULL);
            ecs_assert(m_id != 0, ECS_INVALID_PARAMETER, NULL);
            return ecs_has_entity(m_world, m_id, ecs_trait(_::component_info<C>::id(m_world), trait.id()));
        }
     ...
     */
        bool has_trait(flecs::entity trait, flecs::entity entity) const
        {
            ecs_assert(m_world != NULL, ECS_INVALID_PARAMETER, NULL);
            ecs_assert(m_id != 0, ECS_INVALID_PARAMETER, NULL);
            return ecs_has_entity(m_world, m_id, ecs_trait(entity.id(), trait.id()));
        }
    ...
    public:
        ...
        type(const flecs::world &world, type_t t)
            : entity(world), m_type(t), m_normalized(t) {}
    ...
    public:
        entity_range(const world &world, std::int32_t count)
            : m_world(world.c_ptr()), m_ids(ecs_bulk_new_w_type(m_world, nullptr, count)), m_count(count) {}

        entity_range(const world &world, std::int32_t count, flecs::type type)
            : m_world(world.c_ptr()), m_ids(ecs_bulk_new_w_type(m_world, type.c_ptr(), count)), m_count(count) {}
...
#error "implicit component registration not supported"
        ...
        template <typename T>
        entity_t component_info<T>::s_id(0);
        template <typename T>
        type_t component_info<T>::s_type(nullptr);
        template <typename T>
        std::string component_info<T>::s_name("");
        template <typename T>
        bool component_info<T>::s_allow_tag(true);
    ...
    public:
        filter()
            : m_world(nullptr), m_filter{} {}

        explicit filter(const world &world)
            : m_world(world.c_ptr()), m_filter{} {}
    ...
    public:
        explicit snapshot(const world &world)
            : m_world(world), m_snapshot(nullptr) {}
        ...
        snapshot(snapshot &&obj)
            : m_world(obj.m_world), m_snapshot(obj.m_snapshot)
        {
    ...
    public:
        system_runner_fluent(world_t *world, entity_t id, float delta_time, void *param)
            : m_world(world), m_id(id), m_delta_time(delta_time), m_param(param), m_filter(), m_offset(0), m_limit(0) {}
    ...
    public:
        explicit system(const flecs::world &world, const char *name = nullptr, const char *signature = nullptr)
            : entity(world, name), m_kind(static_cast<ecs_entity_t>(OnUpdate)), m_signature(signature), m_interval(0.0), m_on_demand(false), m_hidden(false), m_finalized(false)
        {
    ...
    public:
        filter_iterator(ecs_iter_next_action_t action)
            : m_world(nullptr), m_has_next(false), m_iter{}, m_action(action) {}

        filter_iterator(const world &world, const filter &filter, ecs_iter_next_action_t action)
            : m_world(world.c_ptr()), m_iter(ecs_filter_iter(m_world, filter.c_ptr())), m_action(action)
        {
        ...
        filter_iterator(const world &world, const snapshot &snapshot, const filter &filter, ecs_iter_next_action_t action)
            : m_world(world.c_ptr()), m_iter(ecs_snapshot_iter(snapshot.c_ptr(), filter.c_ptr())), m_action(action)
        {
            m_has_next = m_action(&m_iter);
        }
    ...
    public:
        snapshot_filter(const world &world, const snapshot &snapshot, const filter &filter)
            : m_world(world), m_snapshot(snapshot), m_filter(filter) {}
