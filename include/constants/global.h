...
// In Gen 4 and up, migrated Pokemon with HeartGold or SoulSilver's ID show the otherwise unused
// "Johto" string.
...
#define HALL_FACILITIES_COUNT \
    9 // 7 facilities for single mode + tower double mode + tower multi mode.
