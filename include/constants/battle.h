...
#define BATTLE_TYPE_FRONTIER                                                                                      \
    (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_DOME | BATTLE_TYPE_PALACE | BATTLE_TYPE_ARENA | BATTLE_TYPE_FACTORY | \
...
#define STATUS3_ALWAYS_HITS_TURN(num) \
    (((num) << 3) &                   \
     STATUS3_ALWAYS_HITS) // "Always Hits" is set as a 2 turn timer, i.e. next turn is the last turn when it's active
