...
// These macros can be used with either battler ID or positions to get the partner or the opposite
// mon
...
#define BATTLE_TYPE_FRONTIER                                                                       \
    (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_DOME | BATTLE_TYPE_PALACE | BATTLE_TYPE_ARENA |        \
        BATTLE_TYPE_FACTORY | BATTLE_TYPE_PIKE | BATTLE_TYPE_PYRAMID)
#define BATTLE_TYPE_FRONTIER_NO_PYRAMID                                                            \
    (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_DOME | BATTLE_TYPE_PALACE | BATTLE_TYPE_ARENA |        \
        BATTLE_TYPE_FACTORY | BATTLE_TYPE_PIKE)
...
#define STATUS3_ALWAYS_HITS_TURN(num)                                                              \
    (((num) << 3) & STATUS3_ALWAYS_HITS) // "Always Hits" is set as a 2 turn timer, i.e. next turn
                                         // is the last turn when it's active
