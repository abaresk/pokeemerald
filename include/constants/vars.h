...
#define VAR_DISTRIBUTE_EON_TICKET                                                                  \
    0x403F // This var is read and written, but is always zero. The only way to obtain the Eon
           // Ticket in Emerald is via Record Mixing
...
#define VAR_CURRENT_SECRET_BASE                                                                    \
    0x4054 // was probably allocated for VAR_FALLARBOR_TOWN_STATE at one point
...
#define VAR_PETALBURG_GYM_STATE                                                                    \
    0x4085 // 0-1: Wally tutorial, 2-6: 0-4 badges, 7: Defeated Norman, 8: Rematch Norman
...
#define VAR_SAFARI_ZONE_STATE                                                                      \
    0x40A4 // 0: In or out of SZ, 1: Player exiting SZ, 2: Player entering SZ
