...
#define FRIENDSHIP_EVENT_FAINT_LARGE                                                               \
    8 // If opponent was >= 30 levels higher. See AdjustFriendshipOnBattleFaint
...
#define EVO_LEVEL_SILCOON                                                                          \
    0x000b // Pokémon reaches the specified level with a Silcoon personality value
#define EVO_LEVEL_CASCOON                                                                          \
    0x000c // Pokémon reaches the specified level with a Cascoon personality value
#define EVO_LEVEL_NINJASK 0x000d // Pokémon reaches the specified level (special value for Ninjask)
#define EVO_LEVEL_SHEDINJA                                                                         \
    0x000e                // Pokémon reaches the specified level (special value for Shedinja)
