...
#define CARD_ALTERNATE_SLOT \
    (1 << 0) // When set, uses an alternate slot to store the incoming card sprites
...
// Move point indexes for sBattleStyleMovePoints[][], to determine Battle Dome trainers battle
// styles
