...
#define INGAME_TRADE_SCIZOR_GOLD_SODACAP 4
#define INGAME_TRADE_STEELIX_GOLD_SODACAP 5
#define INGAME_TRADE_MISDREAVUS_SILVER_SODACAP 6
#define INGAME_TRADE_MURKROW_SILVER_SODACAP 7
