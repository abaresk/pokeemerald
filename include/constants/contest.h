...
#define CONTEST_AI_COMMON                                                                   \
    (CONTEST_AI_CHECK_BAD_MOVE | CONTEST_AI_CHECK_COMBO | CONTEST_AI_CHECK_BORING           \
        | CONTEST_AI_CHECK_EXCITEMENT | CONTEST_AI_CHECK_ORDER | CONTEST_AI_CHECK_GOOD_MOVE \
        | CONTEST_AI_ERRATIC | CONTEST_AI_DUMMY_1 | CONTEST_AI_DUMMY_2 | CONTEST_AI_DUMMY_3 \
        | CONTEST_AI_DUMMY_4 | CONTEST_AI_DUMMY_5)
