...
#define FLAG_HIDE_CONTEST_POKE_BALL \
    0x56 // Always set after new game, object it hides is added directly
...
#define FLAG_GOOD_LUCK_SAFARI_ZONE \
    0x5D // Set after talking to NPC blocking Safari Zone entrance/exit once.
...
#define FLAG_MOSSDEEP_GYM_SWITCH_1 \
    0x64 // Leftover from the RS version of Mossdeep Gym, functionally unused
...
#define FLAG_WHITEOUT_TO_LAVARIDGE \
...
#define FLAG_UNUSED_RS_LEGENDARY_BATTLE_DONE \
    0x71 // Unused Flag. Used in R/S to indicate whether player defeated or caught Groudon/Kyogre in
         // Cave of Origin.
#define FLAG_SCOTT_CALL_BATTLE_FRONTIER \
    0x72 // Used in order to activate a phone call from Scott, inviting the player to the SS Tidal.
#define FLAG_RECEIVED_METEORITE 0x73
#define FLAG_ADVENTURE_STARTED  0x74 // RECEIVED Pokédex.
#define FLAG_DEFEATED_MAGMA_SPACE_CENTER \
    0x75 // Set when Team Magma is defeated at Mossdeep's Space Center.
...
#define FLAG_ENABLE_ROXANNE_FIRST_CALL \
    0x80 // Set after defeating Brawly. This will activate a call with Roxanne in order to register
         // her.
...
#define FLAG_ENABLE_FIRST_WALLY_POKENAV_CALL \
    0x88 // Set after defeating Wally outside Mauville Gym. Will activate a call later to register
         // Wally.
...
#define FLAG_TRICK_HOUSE_PUZZLE_7_SWITCH_1 \
    0xC2 // Leftover from the RS version of Puzzle Room 7, functionally unused
...
#define FLAG_FAN_CLUB_STRENGTH_SHARED \
    0xD2 // Set when you rate the strength of another trainer in Lilycove's Trainer Fan Club.
...
#define FLAG_STEVEN_GUIDES_TO_CAVE_OF_ORIGIN \
    0x133 // Set after you follow Steven to the entrance of the Cave of Origin.
#define FLAG_MET_ARCHIE_SOOTOPOLIS 0x134
#define FLAG_MET_MAXIE_SOOTOPOLIS  0x135
#define FLAG_MET_SCOTT_RUSTBORO    0x136
#define FLAG_WALLACE_GOES_TO_SKY_PILLAR \
    0x137 // Set after speaking to Wallace within the Cave of Origin.
...
#define FLAG_ITEM_ROUTE_123_RARE_CANDY \
    0x409 // Unused Flag, leftover from R/S. In Emerald this is a hidden item and uses a different
          // flag
...
#define FLAG_ITEM_OLD_MAGMA_HIDEOUT_B1F_MASTER_BALL \
    0x465 // Unused Flag, leftover from the Ruby Magma hideout
#define FLAG_ITEM_OLD_MAGMA_HIDEOUT_B1F_MAX_ELIXIR \
    0x466 // Unused Flag, leftover from the Ruby Magma hideout
#define FLAG_ITEM_OLD_MAGMA_HIDEOUT_B2F_NEST_BALL \
    0x467 // Unused Flag, leftover from the Ruby Magma hideout
#define FLAG_UNUSED_0x468                           0x468 // Unused Flag
#define FLAG_ITEM_MT_PYRE_2F_ULTRA_BALL             0x469
#define FLAG_ITEM_MT_PYRE_4F_SEA_INCENSE            0x46A
#define FLAG_ITEM_SAFARI_ZONE_SOUTH_WEST_MAX_REVIVE 0x46B
#define FLAG_ITEM_AQUA_HIDEOUT_B1F_NUGGET           0x46C
#define FLAG_ITEM_MOSSDEEP_STEVENS_HOUSE_HM08 \
    0x46D // Unused Flag, leftover from R/S. HM08 is given to the player directly in Emerald
...
#define FLAG_SYS_CAVE_SHIP \
    (SYSTEM_FLAGS          \
        + 0x37) // Unused Flag, leftover from R/S debug, presumably used by Emerald's debug too
