...
#define FLAG_WHITEOUT_TO_LAVARIDGE \
    0x6C // Set after defeating Flannery, so the player cant white out from poison before receiving Go Goggles
...
#define FLAG_UNUSED_RS_LEGENDARY_BATTLE_DONE \
    0x71 // Unused Flag. Used in R/S to indicate whether player defeated or caught Groudon/Kyogre in Cave of Origin.
...
#define FLAG_ENABLE_ROXANNE_FIRST_CALL \
    0x80 // Set after defeating Brawly. This will activate a call with Roxanne in order to register her.
...
#define FLAG_ENABLE_FIRST_WALLY_POKENAV_CALL \
    0x88 // Set after defeating Wally outside Mauville Gym. Will activate a call later to register Wally.
...
#define FLAG_ITEM_ROUTE_123_RARE_CANDY \
    0x409 // Unused Flag, leftover from R/S. In Emerald this is a hidden item and uses a different flag
...
#define FLAG_SYS_CAVE_SHIP \
    (SYSTEM_FLAGS + 0x37) // Unused Flag, leftover from R/S debug, presumably used by Emerald's debug too
