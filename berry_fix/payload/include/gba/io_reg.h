...
#define BGCNT_PRIORITY(n)                                                                          \
    (n) // Values 0 - 3. Lower priority BGs will be drawn on top of higher priority BGs.
...
#define WINOUT_WINOBJ_BG_ALL                                                                       \
    (WINOUT_WINOBJ_BG0 | WINOUT_WINOBJ_BG1 | WINOUT_WINOBJ_BG2 | WINOUT_WINOBJ_BG3)
...
#define BLDCNT_TGT2_ALL                                                                            \
    (BLDCNT_TGT2_BG0 | BLDCNT_TGT2_BG1 | BLDCNT_TGT2_BG2 | BLDCNT_TGT2_BG3 | BLDCNT_TGT2_OBJ |     \
        BLDCNT_TGT2_BD)
