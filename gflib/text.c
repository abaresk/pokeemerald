...
const u8 gFontHalfRowOffsets[] = {
    
};
...
const struct GlyphWidthFunc gGlyphWidthFuncs[] = { { 0x0, GetGlyphWidthFont0 }, { 0x1, GetGlyphWidthFont1 },
                                                   { 0x2, GetGlyphWidthFont2 }, { 0x3, GetGlyphWidthFont2 },
                                                   { 0x4, GetGlyphWidthFont2 }, { 0x5, GetGlyphWidthFont2 },
                                                   { 0x6, GetGlyphWidthFont6 }, { 0x7, GetGlyphWidthFont7 },
                                                   { 0x8, GetGlyphWidthFont8 } };

const struct KeypadIcon gKeypadIcons[] = {
    [CHAR_A_BUTTON] = { 0x0, 0x8, 0xC },      [CHAR_B_BUTTON] = { 0x1, 0x8, 0xC },
    [CHAR_L_BUTTON] = { 0x2, 0x10, 0xC },     [CHAR_R_BUTTON] = { 0x4, 0x10, 0xC },
    [CHAR_START_BUTTON] = { 0x6, 0x18, 0xC }, [CHAR_SELECT_BUTTON] = { 0x9, 0x18, 0xC },
    [CHAR_DPAD_UP] = { 0xC, 0x8, 0xC },       [CHAR_DPAD_DOWN] = { 0xD, 0x8, 0xC },
    [CHAR_DPAD_LEFT] = { 0xE, 0x8, 0xC },     [CHAR_DPAD_RIGHT] = { 0xF, 0x8, 0xC },
    [CHAR_DPAD_UPDOWN] = { 0x20, 0x8, 0xC },  [CHAR_DPAD_LEFTRIGHT] = { 0x21, 0x8, 0xC },
...
const struct FontInfo gFontInfos[] = {
    { Font0Func, 0x5, 0xC, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },  { Font1Func, 0x6, 0x10, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },
    { Font2Func, 0x6, 0xE, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },  { Font3Func, 0x6, 0xE, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },
    { Font4Func, 0x6, 0xE, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },  { Font5Func, 0x6, 0xE, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },
    { Font6Func, 0x8, 0x10, 0x0, 0x8, 0x0, 0x2, 0x1, 0x3 }, { Font7Func, 0x5, 0x10, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },
    { Font8Func, 0x5, 0x8, 0x0, 0x0, 0x0, 0x2, 0x1, 0x3 },  { NULL, 0x8, 0x8, 0x0, 0x0, 0x0, 0x1, 0x2, 0xF }
};

const u8 gMenuCursorDimensions[][2] = { { 0x8, 0xC }, { 0x8, 0xF },  { 0x8, 0xE }, { 0x8, 0xE }, { 0x8, 0xE },
                                        { 0x8, 0xE }, { 0x8, 0x10 }, { 0x8, 0xF }, { 0x8, 0x8 }, { 0x0, 0x0 } };
...
u16 AddTextPrinterParameterized(u8 windowId, u8 fontId, const u8* str, u8 x, u8 y, u8 speed,
...
bool16 AddTextPrinter(struct TextPrinterTemplate* printerTemplate, u8 speed,
                      void (*callback)(struct TextPrinterTemplate*, u16)) {
    int i;
    u16 j;
    u8* ptr;
...
void ClearTextSpan(struct TextPrinter* textPrinter, u32 width) {
    ...
    if (gLastTextBgColor != 0) {
        ...
        FillBitmapRect4Bit(&pixels_data, textPrinter->printerTemplate.currentX, textPrinter->printerTemplate.currentY,
                           width, *glyphHeight, gLastTextBgColor);
    }
}
    ...
    if (!gTextFlags.autoScroll) {
        if (subStruct->downArrowDelay != 0) {
            ...
            FillWindowPixelRect(textPrinter->printerTemplate.windowId,
                                ...
                                textPrinter->printerTemplate.currentX, textPrinter->printerTemplate.currentY, 8, 16);
            ...
            BlitBitmapRectToWindow(textPrinter->printerTemplate.windowId, arrowTiles, 0,
                                   gDownArrowYCoords[subStruct->downArrowYPosIdx], 8, 16,
                                   textPrinter->printerTemplate.currentX, textPrinter->printerTemplate.currentY, 8, 16);
...
void DrawDownArrow(u8 windowId, u16 x, u16 y, u8 bgColor, bool8 drawArrow, u8* counter, u8* yCoordIndex) {
    ...
    if (*counter != 0) {
        ...
        if (!drawArrow) {
            ...
            BlitBitmapRectToWindow(windowId, arrowTiles, 0, gDownArrowYCoords[*yCoordIndex & 3], 0x8, 0x10, x, y - 2,
                                   0x8, 0x10);
        ...
        case 0:
            ...
            switch (currChar) {
                ...
                case EXT_CTRL_CODE_BEGIN:
                    ...
                    switch (currChar) {
                        ...
                        case EXT_CTRL_CODE_SKIP:
                            textPrinter->printerTemplate.currentX =
                                *textPrinter->printerTemplate.currentChar + textPrinter->printerTemplate.x;
                            textPrinter->printerTemplate.currentChar++;
                            return 2;
                ...
                case CHAR_KEYPAD_ICON:
                    currChar = *textPrinter->printerTemplate.currentChar++;
                    gUnknown_03002F90.unk80 =
                        DrawKeypadIcon(textPrinter->printerTemplate.windowId, currChar,
        ...
        case 4:
            if (textPrinter->scrollDistance) {
                ...
                if (textPrinter->scrollDistance < speed) {
                    ...
                    ScrollWindow(textPrinter->printerTemplate.windowId, 0, speed,
                                 PIXEL_FILL(textPrinter->printerTemplate.bgColor));
...
u8 DrawKeypadIcon(u8 windowId, u8 keypadIconId, u16 x, u16 y) {
    BlitBitmapRectToWindow(windowId, gKeypadIconTiles + (gKeypadIcons[keypadIconId].tileOffset * 0x20), 0, 0, 0x80,
                           0x80, x, y, gKeypadIcons[keypadIconId].width, gKeypadIcons[keypadIconId].height);
